    ...
    const styleFromPropValue = (propValue) => {
      ...
      const breakpoint =
        ...
        (_props$theme = _props$theme.values) == null
          ? void 0
          : _props$theme[propValue]) || _breakpoints.values[propValue];
      if (!breakpoint) {
        return {
      ...
      if (
        ((_props$theme2 = props.theme) == null ||
        (_props$theme2 = _props$theme2.breakpoints) == null
          ? void 0
          : _props$theme2.unit) !== 'px'
      ) {
        return {
...
const sizing = (0, _compose.default)(
  width,
  maxWidth,
  minWidth,
  height,
