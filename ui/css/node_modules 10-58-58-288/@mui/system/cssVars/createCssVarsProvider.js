...
const DISABLE_CSS_TRANSITION = (exports.DISABLE_CSS_TRANSITION =
...
function createCssVarsProvider(options) {
  const {
    ...
    colorSchemeStorageKey:
      defaultColorSchemeStorageKey = _getInitColorSchemeScript.DEFAULT_COLOR_SCHEME_STORAGE_KEY,
    ...
    if (!value) {
      throw new Error(
        process.env.NODE_ENV !== 'production'
          ...
          : (0, _formatMuiErrorMessage2.default)(19),
      );
    }
    return value;
  };
  ...
  process.env.NODE_ENV !== 'production'
    ? (CssVarsProvider.propTypes = {
         ...
         */
        defaultColorScheme: _propTypes.default.oneOfType([
  ...
  const getInitColorSchemeScript = (params) =>
    (0, _getInitColorSchemeScript.default)(
      (0, _extends2.default)(
        {
          attribute: defaultAttribute,
          colorSchemeStorageKey: defaultColorSchemeStorageKey,
