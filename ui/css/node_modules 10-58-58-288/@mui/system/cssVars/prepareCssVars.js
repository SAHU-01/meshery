...
function prepareCssVars(theme, parserConfig) {
  ...
  const { [defaultColorScheme]: light } = colorSchemes,
    otherColorSchemes = (0, _objectWithoutPropertiesLoose2.default)(
      colorSchemes,
      [defaultColorScheme].map(_toPropertyKey2.default),
    );
  ...
  if (light) {
    ...
    const { css, vars, varsWithDefaults } = (0, _cssVarsParser.default)(light, parserConfig);
    themeVars = (0, _deepmerge.default)(themeVars, varsWithDefaults);
  ...
  const generateCssVars = (colorScheme) => {
    ...
    if (!colorScheme) {
      ...
      return {
        ...
        vars: rootVars,
        selector:
          (parserConfig == null || (_parserConfig$getSele = parserConfig.getSelector) == null
            ? void 0
            : _parserConfig$getSele.call(parserConfig, colorScheme, css)) || ':root',
      };
    }
    ...
    return {
      ...
      selector:
        (parserConfig == null || (_parserConfig$getSele2 = parserConfig.getSelector) == null
          ? void 0
          : _parserConfig$getSele2.call(parserConfig, colorScheme, css)) || ':root',
    };
  };
  return {
    vars: themeVars,
