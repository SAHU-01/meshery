...
export function getStyleValue(themeMapping, transform, propValueFinal) {
  var userValue =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : propValueFinal;
  var value;
...
function style(options) {
    ...
    var styleFromPropValue = function styleFromPropValue(propValueFinal) {
      ...
      if (propValueFinal === value && typeof propValueFinal === 'string') {
        ...
        value = getStyleValue(
          themeMapping,
          transform,
          ''.concat(prop).concat(propValueFinal === 'default' ? '' : capitalize(propValueFinal)),
          propValueFinal,
        );
      }
  ...
  fn.propTypes =
    process.env.NODE_ENV !== 'production' ? _defineProperty({}, prop, responsivePropType) : {};
  fn.filterProps = [prop];
  return fn;
}
