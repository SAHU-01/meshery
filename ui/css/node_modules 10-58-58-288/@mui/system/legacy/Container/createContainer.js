...
var defaultCreateStyledComponent = systemStyled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.root,
      styles['maxWidth'.concat(capitalize(String(ownerState.maxWidth)))],
...
var useUtilityClasses = function useUtilityClasses(ownerState, componentName) {
  ...
  var slots = {
    root: [
      'root',
      maxWidth && 'maxWidth'.concat(capitalize(String(maxWidth))),
      fixed && 'fixed',
...
export default function createContainer() {
  ...
  var ContainerRoot = createStyledComponent(
    function (_ref) {
    ...
    function (_ref3) {
      ...
      return (
        ownerState.fixed &&
        Object.keys(theme.breakpoints.values).reduce(function (acc, breakpointValueKey) {
    ...
    function (_ref4) {
      ...
      return _extends(
        ...
        ownerState.maxWidth === 'xs' &&
          _defineProperty({}, theme.breakpoints.up('xs'), {
        ...
        ownerState.maxWidth &&
          // @ts-ignore module augmentation fails if custom breakpoints are used
          ownerState.maxWidth !== 'xs' &&
          _defineProperty({}, theme.breakpoints.up(ownerState.maxWidth), {
            // @ts-ignore module augmentation fails if custom breakpoints are used
            maxWidth: ''
              .concat(theme.breakpoints.values[ownerState.maxWidth])
              .concat(theme.breakpoints.unit),
          }),
      );
    },
  );
