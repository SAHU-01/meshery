...
function processStyleArg(callableStyle, _ref2) {
  ...
  if (
    !!resolvedStylesArg &&
    _typeof(resolvedStylesArg) === 'object' &&
    ...
    variants.forEach(function (variant) {
      ...
      if (typeof variant.props === 'function') {
        ...
        Object.keys(variant.props).forEach(function (key) {
          if (
            (ownerState == null ? void 0 : ownerState[key]) !== variant.props[key] &&
...
export default function createStyled() {
  ...
  var themeId = input.themeId,
    ...
    rootShouldForwardProp =
      _input$rootShouldForw === void 0 ? shouldForwardProp : _input$rootShouldForw,
    _input$slotShouldForw = input.slotShouldForwardProp,
    slotShouldForwardProp =
      _input$slotShouldForw === void 0 ? shouldForwardProp : _input$slotShouldForw;
  ...
  return function (tag) {
    ...
    var muiStyledResolver = function muiStyledResolver(styleArg) {
      ...
      for (
        var _len = arguments.length, expressions = new Array(_len > 1 ? _len - 1 : 0), _key = 1;
        _key < _len;
        _key++
      ) {
      ...
      if (componentName && !skipVariantsResolver) {
        expressionsWithDefaultTheme.push(function (props) {
          ...
          var themeVariants =
            ...
            (_theme$components = _theme$components[componentName]) == null
              ? void 0
      ...
      var Component = defaultStyledResolver.apply(
        void 0,
        [transformedStyleArg].concat(_toConsumableArray(expressionsWithDefaultTheme)),
      );
      if (process.env.NODE_ENV !== 'production') {
        var displayName;
        if (componentName) {
