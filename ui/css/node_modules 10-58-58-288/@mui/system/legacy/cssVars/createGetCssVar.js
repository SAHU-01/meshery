...
export default function createGetCssVar() {
  ...
  function appendVar() {
    ...
    if (
      ...
      return ', var(--'
        ...
        .concat(value)
        .concat(appendVar.apply(void 0, _toConsumableArray(vars.slice(1))), ')');
    }
    return ', '.concat(value);
  }
  ...
  var getCssVar = function getCssVar(field) {
    for (
      var _len2 = arguments.length, fallbacks = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1;
      _key2 < _len2;
      _key2++
    ) {
    ...
    return 'var(--'
      .concat(prefix ? ''.concat(prefix, '-') : '')
      .concat(field)
      .concat(appendVar.apply(void 0, fallbacks), ')');
  };
  return getCssVar;
}
