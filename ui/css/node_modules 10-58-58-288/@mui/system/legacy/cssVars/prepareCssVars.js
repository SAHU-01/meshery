...
function prepareCssVars(theme, parserConfig) {
  ...
  var _theme$colorSchemes = theme.colorSchemes,
    ...
    otherTheme = _objectWithoutProperties(theme, [
      'colorSchemes',
      'components',
      'defaultColorScheme',
    ]);
  ...
  var light = colorSchemes[defaultColorScheme],
    otherColorSchemes = _objectWithoutProperties(
      colorSchemes,
      [defaultColorScheme].map(_toPropertyKey),
    );
      ...
      return {
        ...
        selector:
          (parserConfig == null || (_parserConfig$getSele = parserConfig.getSelector) == null
            ? void 0
            : _parserConfig$getSele.call(parserConfig, colorScheme, _css2)) || ':root',
      };
    }
