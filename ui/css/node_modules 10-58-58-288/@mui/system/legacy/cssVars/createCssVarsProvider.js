...
export var DISABLE_CSS_TRANSITION =
...
export default function createCssVarsProvider(options) {
  var themeId = options.themeId,
    ...
    defaultModeStorageKey =
      _options$modeStorageK === void 0 ? DEFAULT_MODE_STORAGE_KEY : _options$modeStorageK,
    _options$colorSchemeS = options.colorSchemeStorageKey,
    defaultColorSchemeStorageKey =
      _options$colorSchemeS === void 0 ? DEFAULT_COLOR_SCHEME_STORAGE_KEY : _options$colorSchemeS,
    ...
    designSystemTransitionOnChange =
      _options$disableTrans === void 0 ? false : _options$disableTrans,
  ...
  if (
    ...
    (_typeof(designSystemColorScheme) === 'object' &&
      !defaultTheme.colorSchemes[
    ...
    console.error(
      'MUI: `'.concat(designSystemColorScheme, '` does not exist in `theme.colorSchemes`.'),
    );
  }
  ...
  function CssVarsProvider(props) {
    var children = props.children,
      ...
      modeStorageKey =
        _props$modeStorageKey === void 0 ? defaultModeStorageKey : _props$modeStorageKey,
      _props$colorSchemeSto = props.colorSchemeStorageKey,
      colorSchemeStorageKey =
        _props$colorSchemeSto === void 0 ? defaultColorSchemeStorageKey : _props$colorSchemeSto,
      ...
      defaultColorScheme =
        _props$defaultColorSc === void 0 ? designSystemColorScheme : _props$defaultColorSc,
      _props$disableTransit = props.disableTransitionOnChange,
      disableTransitionOnChange =
        _props$disableTransit === void 0 ? designSystemTransitionOnChange : _props$disableTransit,
      _props$storageWindow = props.storageWindow,
      storageWindow =
        _props$storageWindow === void 0
          ? typeof window === 'undefined'
            ? undefined
            : window
          : _props$storageWindow,
      _props$documentNode = props.documentNode,
      documentNode =
        _props$documentNode === void 0
      ...
      colorSchemeNode =
        _props$colorSchemeNod === void 0
          ? typeof document === 'undefined'
            ? undefined
            : document.documentElement
          : _props$colorSchemeNod,
      ...
      disableStyleSheetGeneration =
        _props$disableStyleSh === void 0 ? false : _props$disableStyleSh;
    ...
    var _ref = scopedTheme || themeProp,
      ...
      restThemeProp = _objectWithoutProperties(_ref, [
        'colorSchemes',
        'components',
        'generateCssVars',
        'cssVarPrefix',
    ...
    Object.entries(colorSchemes).forEach(function (_ref2) {
      ...
      if (key === resolvedDefaultColorScheme) {
        if (excludeVariablesFromRoot) {
          ...
          defaultColorSchemeStyleSheet['['.concat(attribute, '="').concat(key, '"]')] =
            excludedVariables;
        }
        defaultColorSchemeStyleSheet[
          ''.concat(colorSchemeSelector, ', [').concat(attribute, '="').concat(key, '"]')
        ] = css;
      } else {
        otherColorSchemesStyleSheet[
          ''
            .concat(colorSchemeSelector === ':root' ? '' : colorSchemeSelector, '[')
            .concat(attribute, '="')
            .concat(key, '"]')
        ] = css;
      }
    ...
    if (
      disableStyleSheetGeneration ||
      (nested && (upperTheme == null ? void 0 : upperTheme.cssVarPrefix) === cssVarPrefix)
    ) {
