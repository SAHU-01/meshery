...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce(function (output, child, index) {
    ...
    if (index < childrenArray.length - 1) {
      output.push(
        /*#__PURE__*/ React.cloneElement(separator, {
...
export var style = function style(_ref) {
  ...
  if (ownerState.spacing) {
    ...
    var base = Object.keys(theme.breakpoints.values).reduce(function (acc, breakpoint) {
      if (
        (_typeof(ownerState.spacing) === 'object' && ownerState.spacing[breakpoint] != null) ||
        (_typeof(ownerState.direction) === 'object' && ownerState.direction[breakpoint] != null)
      ) {
        acc[breakpoint] = true;
      }
      return acc;
    ...
    var styleFromPropValue = function styleFromPropValue(propValue, breakpoint) {
      ...
      return {
        ...
        '& > :not(style) ~ :not(style)': _defineProperty(
          {},
          'margin'.concat(
            getSideFromDirection(breakpoint ? directionValues[breakpoint] : ownerState.direction),
          ),
