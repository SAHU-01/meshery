...
function createGetSelfSpacing(ownerState) {
  return function getSelfSpacing(axis) {
    return 'var(--Grid-'
      .concat(axis, 'Spacing')
      .concat(appendLevel(ownerState.unstable_level), ')');
  };
}
function createGetParentSpacing(ownerState) {
  return function getParentSpacing(axis) {
    ...
    return 'var(--Grid-'
      .concat(axis, 'Spacing')
      .concat(appendLevel(ownerState.unstable_level - 1), ')');
  };
}
  ...
  traverseBreakpoints(theme.breakpoints, ownerState.gridSize, function (appendStyle, value) {
    ...
    if (typeof value === 'number') {
      style = {
        ...
        width: 'calc(100% * '
          .concat(value, ' / ')
          .concat(getParentColumns(ownerState))
          .concat(isNestedContainer(ownerState) ? ' + '.concat(getSelfSpacing('column')) : '', ')'),
      };
    }
    ...
    if (typeof value === 'number') {
      style = {
        marginLeft:
          value === 0
            ? '0px'
            : 'calc(100% * '.concat(value, ' / ').concat(getParentColumns(ownerState), ')'),
      };
    }
    appendStyle(styles, style);
  });
...
export var generateGridColumnsStyles = function generateGridColumnsStyles(_ref3) {
  ...
  var styles = isNestedContainer(ownerState)
    ? _defineProperty(
        {},
        '--Grid-columns'.concat(appendLevel(ownerState.unstable_level)),
        getParentColumns(ownerState),
      )
    : {
        '--Grid-columns': 12,
      };
  traverseBreakpoints(theme.breakpoints, ownerState.columns, function (appendStyle, value) {
    appendStyle(
      styles,
      _defineProperty({}, '--Grid-columns'.concat(appendLevel(ownerState.unstable_level)), value),
    );
  });
  return styles;
};
export var generateGridRowSpacingStyles = function generateGridRowSpacingStyles(_ref5) {
  ...
  var styles = isNestedContainer(ownerState)
    ? _defineProperty(
        {},
        '--Grid-rowSpacing'.concat(appendLevel(ownerState.unstable_level)),
        getParentSpacing('row'),
      )
    : {};
  traverseBreakpoints(theme.breakpoints, ownerState.rowSpacing, function (appendStyle, value) {
    ...
    appendStyle(
      ...
      _defineProperty(
        ...
        typeof value === 'string'
          ? value
          : (_theme$spacing = theme.spacing) == null
            ? void 0
            : _theme$spacing.call(theme, value),
      ),
    );
  });
  return styles;
...
export var generateGridColumnSpacingStyles = function generateGridColumnSpacingStyles(_ref7) {
  ...
  var styles = isNestedContainer(ownerState)
    ? _defineProperty(
        {},
        '--Grid-columnSpacing'.concat(appendLevel(ownerState.unstable_level)),
  ...
  traverseBreakpoints(theme.breakpoints, ownerState.columnSpacing, function (appendStyle, value) {
    ...
    appendStyle(
      ...
      _defineProperty(
        ...
        typeof value === 'string'
          ? value
          : (_theme$spacing2 = theme.spacing) == null
            ? void 0
            : _theme$spacing2.call(theme, value),
      ),
    );
  });
  return styles;
  ...
  return _extends(
    ...
    ownerState.container &&
      _extends(
        ...
        {
          margin: 'calc('
            .concat(getSelfSpacing('row'), ' / -2) calc(')
            .concat(getSelfSpacing('column'), ' / -2)'),
        },
        ownerState.disableEqualOverflow && {
          margin: 'calc('
            .concat(getSelfSpacing('row'), ' * -1) 0px 0px calc(')
            .concat(getSelfSpacing('column'), ' * -1)'),
        },
      ),
    (!ownerState.container || isNestedContainer(ownerState)) &&
      _extends(
        {
          padding: 'calc('
            .concat(getParentSpacing('row'), ' / 2) calc(')
            .concat(getParentSpacing('column'), ' / 2)'),
        },
        (ownerState.disableEqualOverflow || ownerState.parentDisableEqualOverflow) && {
          padding: ''
            .concat(getParentSpacing('row'), ' 0px 0px ')
            .concat(getParentSpacing('column')),
        },
      ),
  );
};
