 ...
 */
export declare function toggleSelection<ItemValue>(
  item: ItemValue,
 ...
 */
export declare function handleItemSelection<ItemValue, State extends ListState<ItemValue>>(
  item: ItemValue,
  state: State,
  context: ListActionContext<ItemValue>,
): State;
export declare function listReducer<ItemValue, State extends ListState<ItemValue>>(
  state: State,
