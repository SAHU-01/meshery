...
export function useNumberInput(parameters) {
  ...
  var handleStateChange = React.useCallback(
    function (event, field, fieldValue, reason) {
  ...
  var numberInputActionContext = React.useMemo(
    function () {
      return {
        min: min,
        max: max,
  ...
  var initialValue =
    (_ref = valueProp != null ? valueProp : defaultValueProp) != null ? _ref : null;
  var initialState = {
    value: initialValue,
      ...
      if (!isControlled && event.target === null) {
        throw new Error(
          process.env.NODE_ENV !== 'production'
            ...
            : _formatMuiErrorMessage(17),
        );
      }
      formControlContext == null ||
        (_formControlContext$o2 = formControlContext.onChange) == null ||
        _formControlContext$o2.call(formControlContext, event);
      (_otherHandlers$onInpu = otherHandlers.onInputChange) == null ||
        _otherHandlers$onInpu.call(otherHandlers, event);
      if (event.defaultMuiPrevented || event.defaultPrevented) {
        return;
      }
      dispatch({
  ...
  var isIncrementDisabled =
    disabledProp ||
    (isNumber(value) ? value >= (max != null ? max : Number.MAX_SAFE_INTEGER) : false);
  ...
  var isDecrementDisabled =
    disabledProp ||
    (isNumber(value) ? value <= (min != null ? min : Number.MIN_SAFE_INTEGER) : false);
