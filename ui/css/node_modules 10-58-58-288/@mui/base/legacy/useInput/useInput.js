...
export function useInput() {
  ...
  if (formControlContext) {
    ...
    disabled =
      (_formControlContext$d = formControlContext.disabled) != null ? _formControlContext$d : false;
    error =
      (_formControlContext$e = formControlContext.error) != null ? _formControlContext$e : false;
    required =
      (_formControlContext$r = formControlContext.required) != null ? _formControlContext$r : false;
    value = formControlContext.value;
    if (process.env.NODE_ENV !== 'production') {
      var definedLocalProps = ['defaultValue', 'disabled', 'error', 'required', 'value'].filter(
        function (prop) {
  ...
  var handleChange = function handleChange(otherHandlers) {
    return function (event) {
      ...
      (_otherHandlers$onChan = otherHandlers.onChange) == null ||
        _otherHandlers$onChan.call.apply(
          _otherHandlers$onChan,
          [otherHandlers, event].concat(args),
        );
    };
  };
