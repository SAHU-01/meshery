...
export function useMenu() {
  ...
  var _ref =
      (_React$useContext = React.useContext(DropdownContext)) != null
        ? _React$useContext
  ...
  var getItemAsString = React.useCallback(
    function (id) {
  ...
  var reducerActionContext = React.useMemo(
    function () {
      return {
        listboxRef: rootRef,
      };
