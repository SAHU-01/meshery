...
function useTabsList(parameters) {
  ...
  var tabIdLookup = React.useCallback(
    function (tabValue) {
      var _subitems$get;
  ...
  var getTabElement = React.useCallback(
    function (tabValue) {
      ...
      return (_subitems$get$ref$cur =
        (_subitems$get2 = subitems.get(tabValue)) == null ? void 0 : _subitems$get2.ref.current) !=
        null
  ...
  var controlledProps = React.useMemo(
    function () {
      if (value === undefined) {
        return {};
      }
  ...
  var isItemDisabled = React.useCallback(
    function (item) {
      ...
      return (_subitems$get$disable =
        (_subitems$get3 = subitems.get(item)) == null ? void 0 : _subitems$get3.disabled) != null
        ? _subitems$get$disable
        : false;
    },
    [subitems],
  );
