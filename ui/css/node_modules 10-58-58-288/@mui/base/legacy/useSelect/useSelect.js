...
function useSelect(props) {
  var areOptionsEqual = props.areOptionsEqual,
    ...
    getOptionAsString =
      _props$getOptionAsStr === void 0 ? defaultOptionStringifier : _props$getOptionAsStr,
    _props$getSerializedV = props.getSerializedValue,
    getSerializedValue =
      _props$getSerializedV === void 0 ? defaultFormValueProvider : _props$getSerializedV,
  ...
  var options = React.useMemo(
    function () {
      if (optionsParam != null) {
        return new Map(
          optionsParam.map(function (option, index) {
            return [
              option.value,
              {
                value: option.value,
  ...
  var optionValues = React.useMemo(
    function () {
      return Array.from(options.keys());
    },
    [options],
  );
  var getOptionByValue = React.useCallback(
    function (valueToGet) {
  ...
  var isItemDisabled = React.useCallback(
    function (valueToCheck) {
      var _option$disabled;
      var option = getOptionByValue(valueToCheck);
      return (_option$disabled = option == null ? void 0 : option.disabled) != null
        ? _option$disabled
        : false;
    },
    [getOptionByValue],
  );
  var stringifyOption = React.useCallback(
    function (valueToCheck) {
      var option = getOptionByValue(valueToCheck);
      if (!option) {
        return '';
  ...
  var controlledState = React.useMemo(
    function () {
      return {
  ...
  var getItemId = React.useCallback(
    function (itemValue) {
      var _options$get;
  ...
  var handleSelectionChange = React.useCallback(
    function (event, newValues) {
      if (multiple) {
        onChange == null || onChange(event, newValues);
      } else {
        var _newValues$;
        onChange == null ||
          onChange(event, (_newValues$ = newValues[0]) != null ? _newValues$ : null);
      }
    },
    [multiple, onChange],
  );
  var handleHighlightChange = React.useCallback(
    function (event, newValue) {
      onHighlightChange == null || onHighlightChange(event, newValue != null ? newValue : null);
    },
    [onHighlightChange],
  );
  var handleStateChange = React.useCallback(
    function (event, field, fieldValue) {
      if (field === 'open') {
  ...
  var getItemDomElement = React.useCallback(
    function (itemId) {
      var _subitems$get$ref$cur, _subitems$get;
      if (itemId == null) {
        return null;
      }
      return (_subitems$get$ref$cur =
        (_subitems$get = subitems.get(itemId)) == null ? void 0 : _subitems$get.ref.current) != null
        ? _subitems$get$ref$cur
        : null;
    },
    [subitems],
  );
  ...
  useEnhancedEffect(
    function () {
      if (open && highlightedOption !== null) {
        ...
        var optionRef =
          (_getOptionByValue = getOptionByValue(highlightedOption)) == null
            ? void 0
            : _getOptionByValue.ref;
  ...
  var getOptionMetadata = React.useCallback(
  ...
  var createHandleButtonClick = function createHandleButtonClick(externalEventHandlers) {
    return function (event) {
      ...
      externalEventHandlers == null ||
        (_externalEventHandler = externalEventHandlers.onClick) == null ||
        _externalEventHandler.call(externalEventHandlers, event);
    ...
    return function (event) {
      ...
      if (
        ((_listboxRef$current = listboxRef.current) != null &&
          _listboxRef$current.contains(event.relatedTarget)) ||
  ...
  if (multiple) {
    selectedOptionsMetadata = selectValue
      .map(function (v) {
    ...
    selectedOptionsMetadata =
      (_getOptionMetadata = getOptionMetadata(selectValue)) != null ? _getOptionMetadata : null;
  }
  var createHandleHiddenInputChange = function createHandleHiddenInputChange(
    externalEventHandlers,
  ) {
    return function (event) {
      var _externalEventHandler2;
      externalEventHandlers == null ||
        (_externalEventHandler2 = externalEventHandlers.onChange) == null ||
        _externalEventHandler2.call(externalEventHandlers, event);
      if (event.defaultMuiPrevented) {
        return;
      }
