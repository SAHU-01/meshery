...
export function useListItem(parameters) {
  ...
  var createHandleClick = React.useCallback(
    function (externalHandlers) {
      return function (event) {
        var _externalHandlers$onC;
        (_externalHandlers$onC = externalHandlers.onClick) == null ||
          _externalHandlers$onC.call(externalHandlers, event);
  ...
  var createHandlePointerOver = React.useCallback(
    function (externalHandlers) {
      return function (event) {
        var _externalHandlers$onM;
        (_externalHandlers$onM = externalHandlers.onMouseOver) == null ||
          _externalHandlers$onM.call(externalHandlers, event);
        if (event.defaultPrevented) {
          return;
        }
        if (process.env.NODE_ENV !== 'production') {
