...
function useList(params) {
  var _params$controlledPro = params.controlledProps,
    ...
    getInitialState =
      _params$getInitialSta === void 0 ? defaultGetInitialState : _params$getInitialSta,
    getItemDomElement = params.getItemDomElement,
    getItemId = params.getItemId,
    _params$isItemDisable = params.isItemDisabled,
    isItemDisabled =
      _params$isItemDisable === void 0 ? defaultIsItemDisabled : _params$isItemDisable,
    ...
    getItemAsString =
      _params$getItemAsStri === void 0 ? defaultItemStringifier : _params$getItemAsStri,
    ...
    function (event, value, reason) {
      ...
      if (
        ...
        getItemDomElement == null ||
          (_getItemDomElement = getItemDomElement(value)) == null ||
          _getItemDomElement.focus();
      }
    },
    [getItemDomElement, onHighlightChange, focusManagement],
  );
  var stateComparers = React.useMemo(
    function () {
      return {
  ...
  var handleStateChange = React.useCallback(
    function (event, field, value, reason, state) {
  ...
  var listActionContext = React.useMemo(
    function () {
      return {
  ...
  var actionContext = React.useMemo(
    function () {
  ...
  var createHandleKeyDown = function createHandleKeyDown(externalHandlers) {
    return function (event) {
      ...
      (_externalHandlers$onK = externalHandlers.onKeyDown) == null ||
        _externalHandlers$onK.call(externalHandlers, event);
  ...
  var createHandleBlur = function createHandleBlur(externalHandlers) {
    return function (event) {
      ...
      (_externalHandlers$onB = externalHandlers.onBlur) == null ||
        _externalHandlers$onB.call(externalHandlers, event);
      if (event.defaultMuiPrevented) {
        return;
      }
      if (
        (_listRef$current = listRef.current) != null &&
        _listRef$current.contains(event.relatedTarget)
      ) {
  ...
  var getItemState = React.useCallback(
    function (item) {
