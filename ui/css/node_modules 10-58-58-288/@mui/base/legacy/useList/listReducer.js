...
function findValidItemToHighlight(
  ...
  if (
    items.length === 0 ||
    (!includeDisabledItems &&
      items.every(function (item, itemIndex) {
  ...
  for (;;) {
    ...
    var nextFocusDisabled = includeDisabledItems
      ? false
...
export function moveHighlight(previouslyHighlightedValue, offset, context) {
  ...
  var previouslyHighlightedIndex =
  ...
  var nextIndex = findValidItemToHighlight(
    nextIndexCandidate,
    lookupDirection,
    items,
...
function textCriteriaMatches(nextFocus, searchString, stringifyItem) {
  var _stringifyItem;
  var text =
    (_stringifyItem = stringifyItem(nextFocus)) == null
      ? void 0
      : _stringifyItem.trim().toLowerCase();
...
function handleTextNavigation(state, searchString, context) {
  ...
  var nextItem = startWithCurrentItem
...
function handleItemsChange(items, previousItems, state, context) {
  ...
  if (state.highlightedValue != null) {
    var _items$find;
    newHighlightedValue =
      (_items$find = items.find(function (item) {
  ...
  var selectedValues =
    (_state$selectedValues = state.selectedValues) != null ? _state$selectedValues : [];
