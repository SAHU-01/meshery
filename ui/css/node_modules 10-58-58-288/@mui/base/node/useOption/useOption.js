...
function useOption(params) {
  ...
  const { getRootProps: getButtonProps, rootRef: buttonRefHandler } = (0, _useButton.useButton)({
    disabled,
  ...
  const { index } = (0, _useCompound.useCompoundItem)(value, selectOption);
  ...
  return {
    getRootProps: (externalProps = {}) => {
      ...
      const getCombinedRootProps = (0, _combineHooksSlotProps.combineHooksSlotProps)(
        getListItemProps,
        (0, _combineHooksSlotProps.combineHooksSlotProps)(getButtonProps, getOwnHandlers),
      );
