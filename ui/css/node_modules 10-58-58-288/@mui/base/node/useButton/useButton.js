...
function useButton(parameters = {}) {
  ...
  const [rootElementName, updateRootElementName] = (0, _useRootElementName.useRootElementName)({
    rootElementName:
      rootElementNameProp != null ? rootElementNameProp : href || to ? 'a' : undefined,
  ...
  const isNativeButton = () => {
    ...
    return (
      ...
      (rootElementName === 'INPUT' &&
        ['button', 'submit', 'reset'].includes(button == null ? void 0 : button.type)) ||
      (rootElementName === 'A' && (button == null ? void 0 : button.href))
    );
  };
