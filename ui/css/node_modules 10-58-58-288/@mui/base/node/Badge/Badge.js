...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_badgeClasses.getBadgeUtilityClass),
  );
};
/**
 *
...
const Badge = (exports.Badge = /*#__PURE__*/ React.forwardRef(function Badge(props, forwardedRef) {
  ...
  const { children, max: maxProp = 99, slotProps = {}, slots = {}, showZero = false } = props,
    other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded);
  const { badgeContent, max, displayValue, invisible } = (0, _useBadge.useBadge)(
