...
function useMenuItem(params) {
  ...
  const { getRootProps: getListRootProps, highlighted } = (0, _useList.useListItem)({
    item: id,
    handlePointerOverEvents: !disableFocusOnHover,
  });
  const { index, totalItemCount } = (0, _useCompound.useCompoundItem)(
    id != null ? id : idGenerator,
    itemMetadata,
  );
  const {
  ...
  const getOwnHandlers = (otherHandlers = {}) =>
    (0, _extends2.default)({}, otherHandlers, {
  ...
  function getRootProps(externalProps = {}) {
    ...
    const getCombinedRootProps = (0, _combineHooksSlotProps.combineHooksSlotProps)(
      getOwnHandlers,
      (0, _combineHooksSlotProps.combineHooksSlotProps)(getButtonProps, getListRootProps),
    );
