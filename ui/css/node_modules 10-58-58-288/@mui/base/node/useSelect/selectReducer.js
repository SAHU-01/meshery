...
function selectReducer(state, action) {
  ...
  if (action.type === _useSelect.SelectActionTypes.buttonClick) {
    ...
    const itemToHighlight =
      (_state$selectedValues = state.selectedValues[0]) != null
        ? _state$selectedValues
        : (0, _useList.moveHighlight)(null, 'start', action.context);
      ...
      if (state.open) {
        ...
        if (action.event.key === 'ArrowDown') {
          ...
          return (0, _extends2.default)({}, state, {
            open: true,
            highlightedValue:
              (_state$selectedValues2 = state.selectedValues[0]) != null
                ? _state$selectedValues2
                : (0, _useList.moveHighlight)(null, 'start', action.context),
          });
        }
        if (action.event.key === 'ArrowUp') {
          ...
          return (0, _extends2.default)({}, state, {
            open: true,
            highlightedValue:
              (_state$selectedValues3 = state.selectedValues[0]) != null
                ? _state$selectedValues3
                : (0, _useList.moveHighlight)(null, 'end', action.context),
          });
        }
      }
      break;
