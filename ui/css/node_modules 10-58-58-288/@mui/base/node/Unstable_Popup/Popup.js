...
function useUtilityClasses(ownerState) {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_popupClasses.getPopupUtilityClass),
  );
}
...
const Popup = (exports.Popup = /*#__PURE__*/ React.forwardRef(function Popup(props, forwardedRef) {
  ...
  const {
    ...
    middleware:
      middleware != null
        ? middleware
        : [
            (0, _reactDom.offset)(offsetProp != null ? offsetProp : 0),
            (0, _reactDom.flip)(),
            (0, _reactDom.shift)(),
          ],
    placement,
  ...
  const { contextValue, hasExited: hasTransitionExited } = (0, _useTransition.useTransitionTrigger)(
    open,
  );
...
process.env.NODE_ENV !== 'production'
  ? (Popup.propTypes /* remove-proptypes */ = {
       ...
       */
      anchor: _propTypes.default /* @typescript-to-proptypes-ignore */
       ...
       */
      middleware: _propTypes.default.arrayOf(
