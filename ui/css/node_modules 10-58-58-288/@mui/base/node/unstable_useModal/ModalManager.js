...
function getPaddingRight(element) {
  return (
    parseInt(
      (0, _utils.unstable_ownerWindow)(element).getComputedStyle(element).paddingRight,
      10,
    ) || 0
  );
}
...
function handleContainer(containerInfo, props) {
  ...
  if (!props.disableScrollLock) {
    if (isOverflowing(container)) {
      ...
      const fixedElements = (0, _utils.unstable_ownerDocument)(container).querySelectorAll(
        '.mui-fixed',
      );
