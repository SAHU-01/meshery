...
const useUtilityClasses = () => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_popperClasses.getPopperUtilityClass),
  );
};
...
const PopperTooltip = /*#__PURE__*/ React.forwardRef(function PopperTooltip(props, forwardedRef) {
  ...
  (0, _utils.unstable_useEnhancedEffect)(() => {
    ...
    const popper = (0, _core.createPopper)(
      resolvedAnchorElement,
      tooltipRef.current,
      (0, _extends2.default)(
        {
 ...
 */
const Popper = (exports.Popper = /*#__PURE__*/ React.forwardRef(
  function Popper(props, forwardedRef) {
    const {
        anchorEl,
        children,
    ...
    if (containerProp) {
      ...
      container =
        resolvedAnchorEl && isHTMLElement(resolvedAnchorEl)
          ? (0, _utils.unstable_ownerDocument)(resolvedAnchorEl).body
          : (0, _utils.unstable_ownerDocument)(null).body;
    }
...
process.env.NODE_ENV !== 'production'
  ? (Popper.propTypes /* remove-proptypes */ = {
       ...
       */
      children: _propTypes.default /* @typescript-to-proptypes-ignore */
       ...
       */
      modifiers: _propTypes.default.arrayOf(
