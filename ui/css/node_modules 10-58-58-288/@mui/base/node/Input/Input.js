...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_inputClasses.getInputUtilityClass),
  );
};
...
const Input = (exports.Input = /*#__PURE__*/ React.forwardRef(function Input(props, forwardedRef) {
  ...
  const InputComponent = multiline
    ? (_slots$textarea = slots.textarea) != null
      ? _slots$textarea
      : 'textarea'
    : (_slots$input = slots.input) != null
      ? _slots$input
      : 'input';
  const inputProps = (0, _utils.useSlotProps)({
    ...
    additionalProps: (0, _extends2.default)(
      ...
      multiline &&
        !(0, _isHostComponent.isHostComponent)(InputComponent) && {
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    ...
    (0, _extends2.default)({}, rootProps, {
      children: [
        startAdornment,
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(InputComponent, (0, _extends2.default)({}, inputProps)),
        endAdornment,
      ],
    }),
  );
...
process.env.NODE_ENV !== 'production'
  ? (Input.propTypes /* remove-proptypes */ = {
       ...
       * @default 'text'
       */
      type: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOf([
          'button',
          'checkbox',
          'color',
