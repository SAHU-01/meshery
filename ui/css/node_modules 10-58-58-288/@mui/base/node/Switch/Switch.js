...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_switchClasses.getSwitchUtilityClass),
  );
};
 ...
 */
const Switch = (exports.Switch = /*#__PURE__*/ React.forwardRef(
  function Switch(props, forwardedRef) {
    ...
    const { getInputProps, checked, disabled, focusVisible, readOnly } = (0, _useSwitch.useSwitch)(
      props,
    );
  ...
  ? (Switch.propTypes /* remove-proptypes */ = {
      ...
      slots: _propTypes.default /* @typescript-to-proptypes-ignore */
        .shape({
          ...
          track: _propTypes.default.oneOfType([
