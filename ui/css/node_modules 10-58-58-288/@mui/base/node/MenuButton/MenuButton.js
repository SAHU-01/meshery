...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_menuButtonClasses.getMenuButtonUtilityClass),
  );
};
 ...
 */
const MenuButton = (exports.MenuButton = /*#__PURE__*/ React.forwardRef(
  function MenuButton(props, forwardedRef) {
    ...
    const { getRootProps, open, active } = (0, _useMenuButton.useMenuButton)({
      disabled,
