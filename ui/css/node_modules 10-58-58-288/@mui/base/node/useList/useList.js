...
function useList(params) {
  ...
  const handleHighlightChange = React.useCallback(
    (event, value, reason) => {
      ...
      if (
        focusManagement === 'DOM' &&
        value != null &&
        (reason === _listActions.ListActionTypes.itemClick ||
          reason === _listActions.ListActionTypes.keyDown ||
          reason === _listActions.ListActionTypes.textNavigation)
      ) {
  ...
  const stateComparers = React.useMemo(
    () => ({
      ...
      selectedValues: (valuesArray1, valuesArray2) =>
        (0, _areArraysEqual.areArraysEqual)(valuesArray1, valuesArray2, itemComparer),
    }),
    [itemComparer],
  );
  ...
  const actionContext = React.useMemo(
    () => (0, _extends2.default)({}, reducerActionContext, listActionContext),
  ...
  const handleTextNavigation = (0, _useTextNavigation.useTextNavigation)((searchString, event) =>
    dispatch({
