...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_buttonClasses.getButtonUtilityClass),
  );
};
/**
...
const Button = (exports.Button = /*#__PURE__*/ React.forwardRef(
  function Button(props, forwardedRef) {
    ...
    const { active, focusVisible, setFocusVisible, getRootProps } = (0, _useButton.useButton)(
