...
const selectClasses = (exports.selectClasses = (0, _generateUtilityClasses.generateUtilityClasses)(
  COMPONENT_NAME,
  ['root', 'button', 'listbox', 'popup', 'active', 'expanded', 'disabled', 'focusVisible'],
));
