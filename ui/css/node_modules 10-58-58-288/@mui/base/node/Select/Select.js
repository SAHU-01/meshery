...
function defaultRenderValue(selectedOptions) {
  ...
  return (_selectedOptions$labe = selectedOptions == null ? void 0 : selectedOptions.label) != null
    ? _selectedOptions$labe
    : null;
}
function useUtilityClasses(ownerState) {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_selectClasses.getSelectUtilityClass),
  );
}
 ...
 */
const Select = (exports.Select = /*#__PURE__*/ React.forwardRef(
  function Select(props, forwardedRef) {
    ...
    const handleButtonRef = (0, _utils.unstable_useForkRef)(
      forwardedRef,
      buttonRef,
    ...
    if (multiple) {
      ...
      selectedOptionsMetadata =
        (_getOptionMetadata = getOptionMetadata(value)) != null ? _getOptionMetadata : null;
    }
    return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(React.Fragment, {
      children: [
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          Button,
          (0, _extends2.default)({}, buttonProps, {
            children:
              (_ref =
                (_renderValue = renderValue(selectedOptionsMetadata)) != null
                  ? _renderValue
                  : placeholder) != null
                ? _ref // fall back to a zero-width space to prevent layout shift
            ...
            (0, _extends2.default)(
              ...
              popupProps,
              {
                children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                  ListboxRoot,
                  (0, _extends2.default)({}, listboxProps, {
        ...
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          'input',
          (0, _extends2.default)({}, getHiddenInputProps(), {
...
process.env.NODE_ENV !== 'production'
  ? (Select.propTypes /* remove-proptypes */ = {
      ...
      slotProps: _propTypes.default /* @typescript-to-proptypes-ignore */
        .shape({
          listbox: _propTypes.default.oneOfType([
       ...
       * @default {}
       */
      slots: _propTypes.default /* @typescript-to-proptypes-ignore */
        .shape({
