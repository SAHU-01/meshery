...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    ...
    (0, _ClassNameConfigurator.useClassNamesOverride)(
      _numberInputClasses.getNumberInputUtilityClass,
    ),
  );
};
 ...
 */
const NumberInput = (exports.NumberInput = /*#__PURE__*/ React.forwardRef(
  function NumberInput(props, forwardedRef) {
    ...
    const inputProps = (0, _utils.useSlotProps)({
      ...
      getSlotProps: (otherHandlers) =>
        getInputProps((0, _extends2.default)({}, propsForwardedToInputSlot, otherHandlers)),
      externalSlotProps: slotProps.input,
      ownerState,
      className: classes.input,
    });
    const IncrementButton =
      (_slots$incrementButto = slots.incrementButton) != null ? _slots$incrementButto : 'button';
    ...
    const DecrementButton =
      (_slots$decrementButto = slots.decrementButton) != null ? _slots$decrementButto : 'button';
      ...
      (0, _extends2.default)({}, rootProps, {
        children: [
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(
            DecrementButton,
            (0, _extends2.default)({}, decrementButtonProps),
          ),
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(
            IncrementButton,
            (0, _extends2.default)({}, incrementButtonProps),
          ),
          startAdornment,
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(Input, (0, _extends2.default)({}, inputProps)),
          endAdornment,
        ],
      }),
    );
...
process.env.NODE_ENV !== 'production'
  ? (NumberInput.propTypes /* remove-proptypes */ = {
      ...
      slotProps: _propTypes.default.shape({
        decrementButton: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
        incrementButton: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
