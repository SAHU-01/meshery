...
function useNumberInput(parameters) {
  ...
  const handleInputRef = (0, _utils.unstable_useForkRef)(
    inputRef,
    inputRefProp,
    ...
    if (!isControlled && event.target === null) {
      throw new Error(
        process.env.NODE_ENV !== 'production'
          ...
          : (0, _formatMuiErrorMessage2.default)(17),
      );
    }
    formControlContext == null ||
  ...
  const getInputProps = (externalProps = {}) => {
    ...
    const mergedEventHandlers = (0, _extends2.default)({}, externalEventHandlers, {
      ...
      onChange: createHandleInputChange(
        (0, _extends2.default)({}, externalEventHandlers, {
  ...
  const isIncrementDisabled =
    disabledProp ||
    ((0, _utils2.isNumber)(value) ? value >= (max != null ? max : Number.MAX_SAFE_INTEGER) : false);
  ...
  const isDecrementDisabled =
    disabledProp ||
    ((0, _utils2.isNumber)(value) ? value <= (min != null ? min : Number.MIN_SAFE_INTEGER) : false);
