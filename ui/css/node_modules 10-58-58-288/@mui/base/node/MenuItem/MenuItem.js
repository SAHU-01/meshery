...
function useUtilityClasses(ownerState) {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_menuItemClasses.getMenuItemUtilityClass),
  );
}
const InnerMenuItem = /*#__PURE__*/ React.memo(
  /*#__PURE__*/ React.forwardRef(function MenuItem(props, forwardedRef) {
    var _slots$root;
    const {
        children,
    ...
    const { getRootProps, disabled, focusVisible, highlighted } = (0, _useMenuItem.useMenuItem)({
      id,
...
const MenuItem = (exports.MenuItem = /*#__PURE__*/ React.forwardRef(function MenuItem(props, ref) {
  ...
  const { contextValue, id } = (0, _useMenuItem.useMenuItemContextStabilizer)(idProp);
