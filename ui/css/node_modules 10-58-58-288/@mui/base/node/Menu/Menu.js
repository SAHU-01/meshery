...
function useUtilityClasses(ownerState) {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_menuClasses.getMenuUtilityClass),
  );
}
...
const Menu = (exports.Menu = /*#__PURE__*/ React.forwardRef(function Menu(props, forwardedRef) {
  ...
  const { contextValue, getListboxProps, dispatch, open, triggerElement } = (0, _useMenu.useMenu)({
    onItemsChange,
    componentName: 'Menu',
  });
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
    _Unstable_Popup.Unstable_Popup,
    (0, _extends2.default)(
      {
        keepMounted: true,
      },
