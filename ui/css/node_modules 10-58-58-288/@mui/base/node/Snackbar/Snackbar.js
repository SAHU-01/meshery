...
const useUtilityClasses = () => {
  ...
  return (0, _composeClasses.unstable_composeClasses)(
    slots,
    (0, _ClassNameConfigurator.useClassNamesOverride)(_snackbarClasses.getSnackbarUtilityClass),
  );
};
/**
 *
 ...
 */
const Snackbar = (exports.Snackbar = /*#__PURE__*/ React.forwardRef(
  function Snackbar(props, forwardedRef) {
    ...
    const { getRootProps, onClickAway } = (0, _useSnackbar.useSnackbar)(
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsx)(
      _ClickAwayListener.ClickAwayListener,
      (0, _extends2.default)({}, clickAwayListenerProps, {
...
process.env.NODE_ENV !== 'production'
  ? (Snackbar.propTypes /* remove-proptypes */ = {
      ...
      slotProps: _propTypes.default.shape({
        clickAwayListener: _propTypes.default.oneOfType([
