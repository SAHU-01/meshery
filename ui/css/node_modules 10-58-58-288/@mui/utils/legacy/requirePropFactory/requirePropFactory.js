  ...
  var requireProp = function requireProp(requiredProp) {
    return function (props, propName, componentName, location, propFullName) {
      ...
      if (defaultTypeChecker) {
        ...
        var typeCheckerResult = defaultTypeChecker.apply(
          void 0,
      ...
      if (typeof props[propName] !== 'undefined' && !props[requiredProp]) {
        return new Error(
          'The prop `'.concat(propFullNameSafe, '` of ') +
            '`'
              .concat(componentNameInError, '` can only be used together with the `')
              .concat(requiredProp, '` prop.'),
        );
      }
      return null;
    };
