...
const Tooltip = /*#__PURE__*/ React.forwardRef(function Tooltip(inProps, ref) {
  ...
  const popperProps = appendOwnerState(
    PopperComponent,
    _extends({}, PopperProps, slotProps.popper ?? componentsProps.popper, {
      className: clsx(
        classes.popper,
  ...
  const transitionProps = appendOwnerState(
    TransitionComponent,
    _extends({}, TransitionProps, slotProps.transition ?? componentsProps.transition),
    ownerState,
  );
  const tooltipProps = appendOwnerState(
    TooltipComponent,
    _extends({}, slotProps.tooltip ?? componentsProps.tooltip, {
  ...
  const tooltipArrowProps = appendOwnerState(
    ArrowComponent,
    _extends({}, slotProps.arrow ?? componentsProps.arrow, {
