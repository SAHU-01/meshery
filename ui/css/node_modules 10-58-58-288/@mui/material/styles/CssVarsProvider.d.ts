...
declare const CssVarsProvider: (
    props: React.PropsWithChildren<
      Partial<import('@mui/system').CssVarsProviderConfig<SupportedColorScheme>> & {
        theme?:
          | {
  ...
  useColorScheme: () => import('@mui/system').ColorSchemeContextValue<SupportedColorScheme>,
  getInitColorSchemeScript: typeof import('@mui/system').getInitColorSchemeScript;
export {
  useColorScheme,
