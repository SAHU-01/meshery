...
var _outlinedInputClasses = _interopRequireDefault(
  require('../OutlinedInput/outlinedInputClasses'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _autocompleteClasses.getAutocompleteUtilityClass,
    classes,
  );
};
    ...
    return [
      ...
      },
      {
        [`& .${_autocompleteClasses.default.tag}`]:
          styles[`tagSize${(0, _capitalize.default)(size)}`],
      },
      {
...
const Autocomplete = /*#__PURE__*/ React.forwardRef(function Autocomplete(inProps, ref) {
  ...
  const {
      ...
      clearIcon = _ClearIcon ||
        (_ClearIcon = /*#__PURE__*/ (0, _jsxRuntime.jsx)(_Close.default, {
          fontSize: 'small',
        })),
      ...
      popupIcon = _ArrowDropDownIcon ||
        (_ArrowDropDownIcon = /*#__PURE__*/ (0, _jsxRuntime.jsx)(_ArrowDropDown.default, {})),
      readOnly = false,
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => {
        const _getCustomizedTagProp = getCustomizedTagProps({
          ...
          { key } = _getCustomizedTagProp,
          customTagProps = (0, _objectWithoutPropertiesLoose2.default)(
  ...
  const renderListOption = (option, index) => {
    ...
    return renderOption(
      (0, _extends2.default)({}, optionProps, {
  ...
  if (groupedOptions.length > 0) {
    ...
    autocompletePopper = renderAutocompletePopperChildren(
      /*#__PURE__*/ (0, _jsxRuntime.jsx)(AutocompleteLoading, {
    ...
    autocompletePopper = renderAutocompletePopperChildren(
      /*#__PURE__*/ (0, _jsxRuntime.jsx)(AutocompleteNoOptions, {
...
process.env.NODE_ENV !== 'production'
  ? (Autocomplete.propTypes /* remove-proptypes */ = {
       ...
       * @default false
       */
      blurOnSelect: _propTypes.default.oneOfType([
        _propTypes.default.oneOf(['mouse', 'touch']),
       ...
       * @default 'auto'
       */
      forcePopupIcon: _propTypes.default.oneOfType([
