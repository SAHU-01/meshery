...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    bar1: [
      'bar',
      `barColor${(0, _capitalize.default)(color)}`,
    ...
    bar2: [
      'bar',
      variant !== 'buffer' && `barColor${(0, _capitalize.default)(color)}`,
      variant === 'buffer' && `color${(0, _capitalize.default)(color)}`,
  ...
  return (0, _composeClasses.default)(
    slots,
    _linearProgressClasses.getLinearProgressUtilityClass,
    classes,
  );
};
const getColorShade = (theme, color) => {
  ...
  return theme.palette.mode === 'light'
    ? (0, _colorManipulator.lighten)(theme.palette[color].main, 0.62)
    : (0, _colorManipulator.darken)(theme.palette[color].main, 0.5);
};
...
const LinearProgressBar1 = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.bar,
      styles[`barColor${(0, _capitalize.default)(ownerState.color)}`],
...
const LinearProgress = /*#__PURE__*/ React.forwardRef(function LinearProgress(inProps, ref) {
  ...
  const { className, color = 'primary', value, valueBuffer, variant = 'indeterminate' } = props,
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        children: [
          variant === 'buffer'
            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(LinearProgressDashed, {
                className: classes.dashed,
                ownerState: ownerState,
              })
            : null,
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(LinearProgressBar1, {
          ...
          variant === 'determinate'
            ? null
            : /*#__PURE__*/ (0, _jsxRuntime.jsx)(LinearProgressBar2, {
...
process.env.NODE_ENV !== 'production'
  ? (LinearProgress.propTypes /* remove-proptypes */ = {
      ...
      color: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['inherit', 'primary', 'secondary']),
