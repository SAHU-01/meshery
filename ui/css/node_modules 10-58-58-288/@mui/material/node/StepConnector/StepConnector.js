...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _stepConnectorClasses.getStepConnectorUtilityClass,
    classes,
  );
};
...
const StepConnector = /*#__PURE__*/ React.forwardRef(function StepConnector(inProps, ref) {
  ...
  const { alternativeLabel, orientation = 'horizontal' } = React.useContext(
    _StepperContext.default,
  );
  const { active, disabled, completed } = React.useContext(_StepContext.default);
