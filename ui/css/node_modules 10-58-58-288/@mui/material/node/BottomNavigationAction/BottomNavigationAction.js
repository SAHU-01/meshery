...
var _bottomNavigationActionClasses = _interopRequireWildcard(
  require('./bottomNavigationActionClasses'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _bottomNavigationActionClasses.getBottomNavigationActionUtilityClass,
    classes,
  );
};
...
const BottomNavigationAction = /*#__PURE__*/ React.forwardRef(
  function BottomNavigationAction(inProps, ref) {
    ...
    return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
      ...
      (0, _extends2.default)(
        ...
        other,
        {
          children: [
            icon,
            /*#__PURE__*/ (0, _jsxRuntime.jsx)(BottomNavigationActionLabel, {
