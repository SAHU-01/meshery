...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _breadcrumbsClasses.getBreadcrumbsUtilityClass,
    classes,
  );
};
...
const Breadcrumbs = /*#__PURE__*/ React.forwardRef(function Breadcrumbs(inProps, ref) {
  ...
  const collapsedIconSlotProps = (0, _utils.useSlotProps)({
...
process.env.NODE_ENV !== 'production'
  ? (Breadcrumbs.propTypes /* remove-proptypes */ = {
      ...
      slotProps: _propTypes.default.shape({
        collapsedIcon: _propTypes.default.oneOfType([
