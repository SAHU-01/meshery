...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      shrink && 'shrink',
      size && size !== 'normal' && `size${(0, _capitalize.default)(size)}`,
      variant,
    ],
  ...
  const composedClasses = (0, _composeClasses.default)(
    slots,
    _inputLabelClasses.getInputLabelUtilityClasses,
    classes,
  );
...
process.env.NODE_ENV !== 'production'
  ? (InputLabel.propTypes /* remove-proptypes */ = {
      ...
      color: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['error', 'info', 'primary', 'secondary', 'success', 'warning']),
      ...
      size: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([_propTypes.default.oneOf(['normal', 'small']), _propTypes.default.string]),
      /**
