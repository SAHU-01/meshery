...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      'root',
      `underline${(0, _capitalize.default)(underline)}`,
...
const LinkRoot = (0, _styled.default)(_Typography.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.root,
      styles[`underline${(0, _capitalize.default)(ownerState.underline)}`],
    ...
    (0, _extends2.default)(
      {
        ...
        variant: variant,
        sx: [
          ...(!Object.keys(_getTextDecoration.colorTransformations).includes(color)
            ? [
                {
                  color,
                },
