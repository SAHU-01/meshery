...
const SpeedDial = /*#__PURE__*/ React.forwardRef(function SpeedDial(inProps, ref) {
  ...
  const {
      ariaLabel,
      FabProps: { ref: origDialButtonRef } = {},
  ...
  const handleKeyDown = (event) => {
    ...
    if (
      ...
      const nextAction = (0, _clamp.default)(
        focusedAction.current + actionStep,
        0,
  ...
  const children = allItems.map((child, index) => {
    const _child$props = child.props,
      { FabProps: { ref: origButtonRef } = {}, tooltipPlacement: tooltipPlacementProp } =
        _child$props,
      ChildFabProps = (0, _objectWithoutPropertiesLoose2.default)(
        _child$props.FabProps,
        _excluded3,
      );
                  ...
                  (0, _extends2.default)(
                    ...
                    FabProps,
                    {
                      ...
                      children:
                        ...
                        (0, _isMuiElement.default)(icon, ['SpeedDialIcon'])
