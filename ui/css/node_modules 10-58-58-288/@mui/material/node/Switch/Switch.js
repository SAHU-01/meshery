...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      'root',
      edge && `edge${(0, _capitalize.default)(edge)}`,
  ...
  const composedClasses = (0, _composeClasses.default)(
    slots,
    _switchClasses.getSwitchUtilityClass,
    classes,
  );
...
const SwitchRoot = (0, _zeroStyled.styled)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.root,
      ownerState.edge && styles[`edge${(0, _capitalize.default)(ownerState.edge)}`],
            ...
            [`&.${_switchClasses.default.checked}`]: {
              ...
              [`&.${_switchClasses.default.disabled}`]: {
                color: theme.vars
                  ...
                  : `${theme.palette.mode === 'light' ? (0, _colorManipulator.lighten)(theme.palette[color].main, 0.62) : (0, _colorManipulator.darken)(theme.palette[color].main, 0.55)}`,
              },
            },
            [`&.${_switchClasses.default.checked} + .${_switchClasses.default.track}`]: {
...
const Switch = /*#__PURE__*/ React.forwardRef(function Switch(inProps, ref) {
  ...
  const { className, color = 'primary', edge = false, size = 'medium', sx } = props,
