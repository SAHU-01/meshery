...
function createPalette(palette) {
  ...
  function getContrastText(background) {
    const contrastText =
      (0, _colorManipulator.getContrastRatio)(background, dark.text.primary) >= contrastThreshold
        ? dark.text.primary
        : light.text.primary;
...
The color object needs to have a \`main\` property or a \`${mainShade}\` property.`
          : (0, _formatMuiErrorMessage2.default)(11, name ? ` (${name})` : '', mainShade),
      );
    }
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
          ...
          : (0, _formatMuiErrorMessage2.default)(
              12,
              name ? ` (${name})` : '',
