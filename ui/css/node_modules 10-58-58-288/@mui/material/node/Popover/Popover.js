...
var _elementTypeAcceptingRef = _interopRequireDefault(
  require('@mui/utils/elementTypeAcceptingRef'),
);
...
const Popover = /*#__PURE__*/ React.forwardRef(function Popover(inProps, ref) {
  ...
  const container =
    containerProp ||
    (anchorEl ? (0, _ownerDocument.default)(resolveAnchorEl(anchorEl)).body : undefined);
  const RootSlot =
    (_slots$root = slots == null ? void 0 : slots.root) != null ? _slots$root : PopoverRoot;
  const PaperSlot =
    (_slots$paper = slots == null ? void 0 : slots.paper) != null ? _slots$paper : PopoverPaper;
  const paperProps = (0, _utils.useSlotProps)({
    elementType: PaperSlot,
    externalSlotProps: (0, _extends2.default)({}, externalPaperSlotProps, {
      style: isPositioned
        ? externalPaperSlotProps.style
        : (0, _extends2.default)({}, externalPaperSlotProps.style, {
            opacity: 0,
          }),
    }),
    additionalProps: {
    ...
    className: (0, _clsx.default)(
      classes.paper,
      externalPaperSlotProps == null ? void 0 : externalPaperSlotProps.className,
    ),
  });
        ...
        children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          ...
          (0, _extends2.default)(
            ...
            TransitionProps,
            {
              children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                PaperSlot,
                (0, _extends2.default)({}, paperProps, {
                  children: children,
                }),
              ),
            },
...
process.env.NODE_ENV !== 'production'
  ? (Popover.propTypes /* remove-proptypes */ = {
       ...
       */
      anchorEl: (0, _chainPropTypes.default)(
        _propTypes.default.oneOfType([_HTMLElementType.default, _propTypes.default.func]),
        (props) => {
       ...
       */
      container: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([_HTMLElementType.default, _propTypes.default.func]),
      /**
       ...
       * @default {}
       */
      PaperProps: _propTypes.default /* @typescript-to-proptypes-ignore */
        .shape({
