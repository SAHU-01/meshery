...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _avatarGroupClasses.getAvatarGroupUtilityClass,
    classes,
  );
};
...
const AvatarGroup = /*#__PURE__*/ React.forwardRef(function AvatarGroup(inProps, ref) {
  ...
  const additionalAvatarSlotProps =
    (_slotProps$additional = slotProps.additionalAvatar) != null
      ? _slotProps$additional
                ...
                (0, _extends2.default)(
                  ...
                  additionalAvatarSlotProps,
                  {
                    className: (0, _clsx.default)(
                      classes.avatar,
                      additionalAvatarSlotProps == null
                        ? void 0
                        : additionalAvatarSlotProps.className,
                    ),
...
process.env.NODE_ENV !== 'production'
  ? (AvatarGroup.propTypes /* remove-proptypes */ = {
      ...
      spacing: _propTypes.default.oneOfType([
        _propTypes.default.oneOf(['medium', 'small']),
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['circular', 'rounded', 'square']),
