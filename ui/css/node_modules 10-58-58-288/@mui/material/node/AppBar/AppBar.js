...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      `position${(0, _capitalize.default)(position)}`,
    ],
  };
...
const joinVars = (var1, var2) =>
  var1 ? `${var1 == null ? void 0 : var1.replace(')', '')}, ${var2})` : var2;
...
const AppBar = /*#__PURE__*/ React.forwardRef(function AppBar(inProps, ref) {
  ...
  const { className, color = 'primary', enableColorOnDark = false, position = 'fixed' } = props,
