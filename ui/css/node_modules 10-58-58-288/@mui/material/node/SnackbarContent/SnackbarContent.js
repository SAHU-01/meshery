...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _snackbarContentClasses.getSnackbarContentUtilityClass,
    classes,
  );
};
const SnackbarContentRoot = (0, _styled.default)(_Paper.default, {
  ...
  const backgroundColor = (0, _colorManipulator.emphasize)(
...
const SnackbarContent = /*#__PURE__*/ React.forwardRef(function SnackbarContent(inProps, ref) {
  ...
  const { action, className, message, role = 'alert' } = props,
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        children: [
          ...
          action
            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(SnackbarContentAction, {
