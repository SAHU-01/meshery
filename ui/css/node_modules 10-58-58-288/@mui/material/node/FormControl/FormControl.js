...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      'root',
      margin !== 'none' && `margin${(0, _capitalize.default)(margin)}`,
      fullWidth && 'fullWidth',
    ],
  };
  return (0, _composeClasses.default)(
    slots,
    _formControlClasses.getFormControlUtilityClasses,
    classes,
  );
};
  ...
  const [filled, setFilled] = React.useState(() => {
    ...
    if (children) {
      React.Children.forEach(children, (child) => {
        ...
        if (
          (0, _utils.isFilled)(child.props, true) ||
          (0, _utils.isFilled)(child.props.inputProps, true)
        ) {
          initialFilled = true;
        }
      });
