...
const Tabs = /*#__PURE__*/ React.forwardRef(function Tabs(inProps, ref) {
  ...
  const getTabsMeta = () => {
    ...
    if (tabsNode) {
      ...
      tabsMeta = {
        ...
        scrollLeftNormalized: (0, _scrollLeft.getNormalizedScrollLeft)(
          tabsNode,
          isRtl ? 'rtl' : 'ltr',
        ),
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements.scrollbarSizeListener = scrollable
      ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(TabsScrollbarSize, {
  ...
  const indicator = /*#__PURE__*/ (0, _jsxRuntime.jsx)(
    TabsIndicator,
    (0, _extends2.default)({}, TabIndicatorProps, {
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        children: [
          ...
          /*#__PURE__*/ (0, _jsxRuntime.jsxs)(TabsScroller, {
            ...
            ref: tabsRef,
            children: [
              /*#__PURE__*/ (0, _jsxRuntime.jsx)(FlexContainer, {
                'aria-label': ariaLabel,
                'aria-labelledby': ariaLabelledBy,
...
process.env.NODE_ENV !== 'production'
  ? (Tabs.propTypes /* remove-proptypes */ = {
       ...
       * @default 'primary'
       */
      indicatorColor: _propTypes.default /* @typescript-to-proptypes-ignore */
       ...
       * @default 'auto'
       */
      scrollButtons: _propTypes.default /* @typescript-to-proptypes-ignore */
      ...
      slotProps: _propTypes.default.shape({
        endScrollButtonIcon: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
        startScrollButtonIcon: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
      }),
