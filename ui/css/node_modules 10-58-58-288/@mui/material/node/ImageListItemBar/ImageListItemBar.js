...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    titleWrap: [
      'titleWrap',
      `titleWrap${(0, _capitalize.default)(position)}`,
      actionIcon && `titleWrapActionPos${(0, _capitalize.default)(actionPosition)}`,
    ],
    title: ['title'],
    subtitle: ['subtitle'],
  ...
  return (0, _composeClasses.default)(
    slots,
    _imageListItemBarClasses.getImageListItemBarUtilityClass,
    classes,
  );
};
...
const ImageListItemBarTitleWrap = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.titleWrap,
      styles[`titleWrap${(0, _capitalize.default)(ownerState.position)}`],
      ownerState.actionIcon &&
        styles[`titleWrapActionPos${(0, _capitalize.default)(ownerState.actionPosition)}`],
    ];
  },
})(({ theme, ownerState }) => {
  return (0, _extends2.default)(
...
const ImageListItemBarActionIcon = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.actionIcon,
      styles[`actionIconActionPos${(0, _capitalize.default)(ownerState.actionPosition)}`],
    ];
  },
})(({ ownerState }) => {
  return (0, _extends2.default)(
...
const ImageListItemBar = /*#__PURE__*/ React.forwardRef(function ImageListItemBar(inProps, ref) {
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    ...
    (0, _extends2.default)(
      ...
      {
        children: [
          /*#__PURE__*/ (0, _jsxRuntime.jsxs)(ImageListItemBarTitleWrap, {
            ownerState: ownerState,
            className: classes.titleWrap,
            children: [
              /*#__PURE__*/ (0, _jsxRuntime.jsx)(ImageListItemBarTitle, {
                className: classes.title,
                children: title,
              }),
              subtitle
                ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(ImageListItemBarSubtitle, {
          ...
          actionIcon
            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(ImageListItemBarActionIcon, {
                ownerState: ownerState,
