...
const TooltipPopper = (0, _styled.default)(_Popper.default, {
  ...
  (0, _extends2.default)(
    ...
    ownerState.arrow && {
      ...
      [`&[data-popper-placement*="right"] .${_tooltipClasses.default.arrow}`]: (0,
      _extends2.default)(
        {},
        !ownerState.isRtl
          ? {
      ...
      [`&[data-popper-placement*="left"] .${_tooltipClasses.default.arrow}`]: (0,
      _extends2.default)(
        {},
        !ownerState.isRtl
          ? {
...
const TooltipTooltip = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[`tooltipPlacement${(0, _capitalize.default)(ownerState.placement.split('-')[0])}`],
    ];
  },
})(({ theme, ownerState }) =>
  (0, _extends2.default)(
    {
      backgroundColor: theme.vars
        ...
        : (0, _colorManipulator.alpha)(theme.palette.grey[700], 0.92),
    ...
    {
      [`.${_tooltipClasses.default.popper}[data-popper-placement*="left"] &`]: (0,
      _extends2.default)(
        {
      ...
      [`.${_tooltipClasses.default.popper}[data-popper-placement*="right"] &`]: (0,
      _extends2.default)(
        {
      ...
      [`.${_tooltipClasses.default.popper}[data-popper-placement*="top"] &`]: (0,
      _extends2.default)(
        {
      ...
      [`.${_tooltipClasses.default.popper}[data-popper-placement*="bottom"] &`]: (0,
      _extends2.default)(
        {
...
const TooltipArrow = (0, _styled.default)('span', {
  ...
  color: theme.vars
    ? theme.vars.palette.Tooltip.bg
    : (0, _colorManipulator.alpha)(theme.palette.grey[700], 0.9),
  '&::before': {
    content: '""',
    margin: 'auto',
    display: 'block',
...
const Tooltip = /*#__PURE__*/ React.forwardRef(function Tooltip(inProps, ref) {
  ...
  const children = /*#__PURE__*/ React.isValidElement(childrenProp)
    ? childrenProp
  ...
  const PopperComponent =
    (_ref = (_slots$popper = slots.popper) != null ? _slots$popper : components.Popper) != null
      ? _ref
      : TooltipPopper;
  const TransitionComponent =
    (_ref2 =
      (_ref3 =
        (_slots$transition = slots.transition) != null
          ? _slots$transition
          : components.Transition) != null
        ? _ref3
        : TransitionComponentProp) != null
      ? _ref2
      : _Grow.default;
  const TooltipComponent =
    (_ref4 = (_slots$tooltip = slots.tooltip) != null ? _slots$tooltip : components.Tooltip) != null
      ? _ref4
      : TooltipTooltip;
  const ArrowComponent =
    (_ref5 = (_slots$arrow = slots.arrow) != null ? _slots$arrow : components.Arrow) != null
      ? _ref5
      : TooltipArrow;
  const popperProps = (0, _utils.appendOwnerState)(
    PopperComponent,
    (0, _extends2.default)(
      {},
      PopperProps,
      (_slotProps$popper = slotProps.popper) != null ? _slotProps$popper : componentsProps.popper,
      {
        className: (0, _clsx.default)(
          ...
          (_ref6 =
            (_slotProps$popper2 = slotProps.popper) != null
              ? _slotProps$popper2
  ...
  const transitionProps = (0, _utils.appendOwnerState)(
    TransitionComponent,
    (0, _extends2.default)(
      {},
      TransitionProps,
  ...
  const tooltipProps = (0, _utils.appendOwnerState)(
    TooltipComponent,
    (0, _extends2.default)(
      {},
      (_slotProps$tooltip = slotProps.tooltip) != null
        ? _slotProps$tooltip
        : componentsProps.tooltip,
      {
        className: (0, _clsx.default)(
          classes.tooltip,
          (_ref7 =
            (_slotProps$tooltip2 = slotProps.tooltip) != null
              ? _slotProps$tooltip2
              : componentsProps.tooltip) == null
            ? void 0
            : _ref7.className,
        ),
      },
  ...
  const tooltipArrowProps = (0, _utils.appendOwnerState)(
    ArrowComponent,
    (0, _extends2.default)(
      {},
      (_slotProps$arrow = slotProps.arrow) != null ? _slotProps$arrow : componentsProps.arrow,
      {
        className: (0, _clsx.default)(
          classes.arrow,
          (_ref8 =
            (_slotProps$arrow2 = slotProps.arrow) != null
              ? _slotProps$arrow2
                      ...
                      (0, _extends2.default)({}, tooltipProps, {
                        children: [
                          ...
                          arrow
                            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                                ArrowComponent,
                                (0, _extends2.default)({}, tooltipArrowProps, {
                                  ref: setArrowRef,
                                }),
                              )
                            : null,
