...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _cardActionAreaClasses.getCardActionAreaUtilityClass,
    classes,
  );
};
...
const CardActionArea = /*#__PURE__*/ React.forwardRef(function CardActionArea(inProps, ref) {
  ...
  const { children, className, focusVisibleClassName } = props,
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        children: [
          children,
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(CardActionAreaFocusHighlight, {
