...
var _ToggleButtonGroupContext = _interopRequireDefault(
  require('../ToggleButtonGroup/ToggleButtonGroupContext'),
);
var _ToggleButtonGroupButtonContext = _interopRequireDefault(
  require('../ToggleButtonGroup/ToggleButtonGroupButtonContext'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _toggleButtonClasses.getToggleButtonUtilityClass,
    classes,
  );
};
    ...
    },
    {
      ...
      '&:hover': {
        ...
        backgroundColor: theme.vars
          ...
          : (0, _styles.alpha)(theme.palette.text.primary, theme.palette.action.hoverOpacity),
        '@media (hover: none)': {
      ...
      [`&.${_toggleButtonClasses.default.selected}`]: {
        ...
        backgroundColor: theme.vars
          ...
          : (0, _styles.alpha)(selectedColor, theme.palette.action.selectedOpacity),
        '&:hover': {
          backgroundColor: theme.vars
...
const ToggleButton = /*#__PURE__*/ React.forwardRef(function ToggleButton(inProps, ref) {
  ...
  const _React$useContext = React.useContext(_ToggleButtonGroupContext.default),
    { value: contextValue } = _React$useContext,
  ...
  const toggleButtonGroupButtonContextPositionClassName = React.useContext(
    _ToggleButtonGroupButtonContext.default,
  );
  const resolvedProps = (0, _resolveProps.default)(
    (0, _extends2.default)({}, contextProps, {
