...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    staticTooltip: [
      'staticTooltip',
      `tooltipPlacement${(0, _capitalize.default)(tooltipPlacement)}`,
  ...
  return (0, _composeClasses.default)(
    slots,
    _speedDialActionClasses.getSpeedDialActionUtilityClass,
    classes,
  );
};
  ...
  (0, _extends2.default)(
    {
      ...
      '&:hover': {
        backgroundColor: theme.vars
          ...
          : (0, _colorManipulator.emphasize)(theme.palette.background.paper, 0.15),
      },
...
const SpeedDialActionStaticTooltip = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[`tooltipPlacement${(0, _capitalize.default)(ownerState.tooltipPlacement)}`],
    ];
  },
})(({ theme, ownerState }) => ({
  position: 'relative',
...
const SpeedDialAction = /*#__PURE__*/ React.forwardRef(function SpeedDialAction(inProps, ref) {
  ...
  const fab = /*#__PURE__*/ (0, _jsxRuntime.jsx)(
    SpeedDialActionFab,
    (0, _extends2.default)(
      {
        size: 'small',
  ...
  if (tooltipOpenProp) {
    return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
      ...
      (0, _extends2.default)(
        ...
        {
          children: [
            /*#__PURE__*/ (0, _jsxRuntime.jsx)(SpeedDialActionStaticTooltipLabel, {
...
process.env.NODE_ENV !== 'production'
  ? (SpeedDialAction.propTypes /* remove-proptypes */ = {
       ...
       * @default 'left'
       */
      tooltipPlacement: _propTypes.default.oneOf([
        'bottom-end',
        'bottom-start',
        'bottom',
        'left-end',
