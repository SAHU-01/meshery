...
var _ButtonGroupButtonContext = _interopRequireDefault(
  require('../ButtonGroup/ButtonGroupButtonContext'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      `${variant}Size${(0, _capitalize.default)(size)}`,
  ...
  const composedClasses = (0, _composeClasses.default)(
    slots,
    _buttonClasses.getButtonUtilityClass,
    classes,
  );
...
const ButtonRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[`${ownerState.variant}${(0, _capitalize.default)(ownerState.color)}`],
      styles[`size${(0, _capitalize.default)(ownerState.size)}`],
      styles[`${ownerState.variant}Size${(0, _capitalize.default)(ownerState.size)}`],
  ...
  ({ theme, ownerState }) => {
    ...
    return (0, _extends2.default)(
      ...
      theme.typography.button,
      {
        ...
        [`&.${_buttonClasses.default.focusVisible}`]: (0, _extends2.default)(
          {},
          ownerState.variant === 'contained' && {
      ...
      ownerState.variant === 'outlined' &&
        ownerState.color !== 'inherit' && {
          ...
          border: theme.vars
            ...
            : `1px solid ${(0, _colorManipulator.alpha)(theme.palette[ownerState.color].main, 0.5)}`,
        },
      ownerState.variant === 'contained' && {
        color: theme.vars
...
const Button = /*#__PURE__*/ React.forwardRef(function Button(inProps, ref) {
  ...
  const buttonGroupButtonContextPositionClassName = React.useContext(
    _ButtonGroupButtonContext.default,
  );
  ...
  const startIcon =
    startIconProp &&
    /*#__PURE__*/ (0, _jsxRuntime.jsx)(ButtonStartIcon, {
  ...
  const endIcon =
    endIconProp &&
    /*#__PURE__*/ (0, _jsxRuntime.jsx)(ButtonEndIcon, {
...
process.env.NODE_ENV !== 'production'
  ? (Button.propTypes /* remove-proptypes */ = {
      ...
      size: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['small', 'medium', 'large']),
          _propTypes.default.string,
        ]),
      /**
      ...
      type: _propTypes.default.oneOfType([
        _propTypes.default.oneOf(['button', 'reset', 'submit']),
        _propTypes.default.string,
      ]),
      /**
       * The variant to use.
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['contained', 'outlined', 'text']),
          _propTypes.default.string,
        ]),
    })
  : void 0;
