...
const IconButtonRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  ({ theme, ownerState }) => {
    var _palette;
    const palette =
      (_palette = (theme.vars || theme).palette) == null ? void 0 : _palette[ownerState.color];
            ...
            '&:hover': (0, _extends2.default)(
              ...
              palette && {
                backgroundColor: theme.vars
                  ...
                  : (0, _colorManipulator.alpha)(palette.main, theme.palette.action.hoverOpacity),
              },
              {
                // Reset on touch devices, it doesn't add specificity
                '@media (hover: none)': {
  ...
  ? (IconButton.propTypes /* remove-proptypes */ = {
      ...
      children: (0, _chainPropTypes.default)(_propTypes.default.node, (props) => {
        const found = React.Children.toArray(props.children).some(
          (child) => /*#__PURE__*/ React.isValidElement(child) && child.props.onClick,
        );
        if (found) {
          return new Error(
            [
