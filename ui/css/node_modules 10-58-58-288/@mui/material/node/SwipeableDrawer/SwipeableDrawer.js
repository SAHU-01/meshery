...
const SwipeableDrawer = /*#__PURE__*/ React.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  const handleBodyTouchEnd = (0, _useEventCallback.default)((nativeEvent) => {
    ...
    if (horizontal) {
      current = calculateCurrentX(
        ...
        (0, _ownerDocument.default)(nativeEvent.currentTarget),
      );
    } else {
      current = calculateCurrentY(
        anchorRtl,
        nativeEvent.changedTouches,
        (0, _ownerWindow.default)(nativeEvent.currentTarget),
      );
    }
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [
      ...
      !disableSwipeToOpen &&
        variant === 'temporary' &&
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(_base.NoSsr, {
...
process.env.NODE_ENV !== 'production'
  ? (SwipeableDrawer.propTypes /* remove-proptypes */ = {
       ...
       * @default false
       */
      allowSwipeInChildren: _propTypes.default.oneOfType([
       ...
       * @ignore
       */
      ModalProps: _propTypes.default /* @typescript-to-proptypes-ignore */
        .shape({
