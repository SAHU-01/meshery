...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    paper: [
      'paper',
      `paperScroll${(0, _capitalize.default)(scroll)}`,
      `paperWidth${(0, _capitalize.default)(String(maxWidth))}`,
...
const DialogPaper = (0, _styled.default)(_Paper.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.paper,
      styles[`scrollPaper${(0, _capitalize.default)(ownerState.scroll)}`],
      styles[`paperWidth${(0, _capitalize.default)(String(ownerState.maxWidth))}`],
                ...
                children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                  ...
                  (0, _extends2.default)(
                    ...
                    PaperProps,
                    {
                      ...
                      ownerState: ownerState,
                      children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                        _DialogContext.default.Provider,
                        {
...
process.env.NODE_ENV !== 'production'
  ? (Dialog.propTypes /* remove-proptypes */ = {
       ...
       * @default 'sm'
       */
      maxWidth: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl', false]),
