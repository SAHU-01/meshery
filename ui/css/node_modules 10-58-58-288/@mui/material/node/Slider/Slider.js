...
var _shouldSpreadAdditionalProps = _interopRequireDefault(
...
const SliderRoot = (exports.SliderRoot = (0, _zeroStyled.styled)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      ownerState.size !== 'medium' && styles[`size${(0, _capitalize.default)(ownerState.size)}`],
  ...
  return {
    ...
    variants: [
      ...Object.keys(((_theme$vars = theme.vars) != null ? _theme$vars : theme).palette)
        .filter((key) => {
          var _theme$vars2;
...
const SliderTrack = (exports.SliderTrack = (0, _zeroStyled.styled)('span', {
  ...
  return {
    ...
    variants: [
      ...
      ...Object.keys(((_theme$vars3 = theme.vars) != null ? _theme$vars3 : theme).palette)
        .filter((key) => {
          var _theme$vars4;
...
const SliderThumb = (exports.SliderThumb = (0, _zeroStyled.styled)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.thumb,
      styles[`thumbColor${(0, _capitalize.default)(ownerState.color)}`],
      ownerState.size !== 'medium' &&
        styles[`thumbSize${(0, _capitalize.default)(ownerState.size)}`],
    ];
  },
})(({ theme }) => {
  var _theme$vars5;
  return {
    ...
    variants: [
      ...
      ...Object.keys(((_theme$vars5 = theme.vars) != null ? _theme$vars5 : theme).palette)
        .filter((key) => {
          var _theme$vars6;
        ...
        .map((color) => ({
          ...
          style: {
            [`&:hover, &.${_sliderClasses.default.focusVisible}`]: (0, _extends2.default)(
              {},
              theme.vars
                ? {
            ...
            [`&.${_sliderClasses.default.active}`]: (0, _extends2.default)(
              {},
              theme.vars
                ? {
...
const SliderValueLabel = (exports.SliderValueLabel = (0, _zeroStyled.styled)(
  _SliderValueLabel.default,
  {
    name: 'MuiSlider',
    slot: 'ValueLabel',
...
const SliderMarkLabel = (exports.SliderMarkLabel = (0, _zeroStyled.styled)('span', {
  ...
  shouldForwardProp: (prop) =>
    (0, _slotShouldForwardProp.default)(prop) && prop !== 'markLabelActive',
...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      color && `color${(0, _capitalize.default)(color)}`,
      size && `size${(0, _capitalize.default)(size)}`,
    ],
    rail: ['rail'],
    track: ['track'],
    mark: ['mark'],
    ...
    thumb: [
      'thumb',
      disabled && 'disabled',
      size && `thumbSize${(0, _capitalize.default)(size)}`,
      color && `thumbColor${(0, _capitalize.default)(color)}`,
    ],
    active: ['active'],
    disabled: ['disabled'],
...
const Slider = /*#__PURE__*/ React.forwardRef(function Slider(inputProps, ref) {
  ...
  const {
    ...
    (0, _extends2.default)({}, ownerState, {
      rootRef: ref,
    }),
  );
  ...
  const RailSlot =
    (_ref2 =
      (_slots$rail = slots == null ? void 0 : slots.rail) != null
        ? _slots$rail
        : components.Rail) != null
      ? _ref2
      : SliderRail;
  const TrackSlot =
    (_ref3 =
      (_slots$track = slots == null ? void 0 : slots.track) != null
        ? _slots$track
  ...
  const ThumbSlot =
    (_ref4 =
      (_slots$thumb = slots == null ? void 0 : slots.thumb) != null
        ? _slots$thumb
  ...
  const ValueLabelSlot =
    (_ref5 =
      (_slots$valueLabel = slots == null ? void 0 : slots.valueLabel) != null
        ? _slots$valueLabel
        : components.ValueLabel) != null
      ? _ref5
      : SliderValueLabel;
  const MarkSlot =
    (_ref6 =
      (_slots$mark = slots == null ? void 0 : slots.mark) != null
        ? _slots$mark
        : components.Mark) != null
      ? _ref6
      : SliderMark;
  const MarkLabelSlot =
    (_ref7 =
      (_slots$markLabel = slots == null ? void 0 : slots.markLabel) != null
        ? _slots$markLabel
        : components.MarkLabel) != null
      ? _ref7
      : SliderMarkLabel;
  const InputSlot =
    (_ref8 =
      (_slots$input = slots == null ? void 0 : slots.input) != null
        ? _slots$input
  ...
  const railSlotProps =
    (_slotProps$rail = slotProps == null ? void 0 : slotProps.rail) != null
      ? _slotProps$rail
      : componentsProps.rail;
  const trackSlotProps =
    (_slotProps$track = slotProps == null ? void 0 : slotProps.track) != null
      ? _slotProps$track
      : componentsProps.track;
  const thumbSlotProps =
    (_slotProps$thumb = slotProps == null ? void 0 : slotProps.thumb) != null
      ? _slotProps$thumb
      : componentsProps.thumb;
  const valueLabelSlotProps =
    (_slotProps$valueLabel = slotProps == null ? void 0 : slotProps.valueLabel) != null
      ? _slotProps$valueLabel
      : componentsProps.valueLabel;
  const markSlotProps =
    (_slotProps$mark = slotProps == null ? void 0 : slotProps.mark) != null
      ? _slotProps$mark
      : componentsProps.mark;
  const markLabelSlotProps =
    (_slotProps$markLabel = slotProps == null ? void 0 : slotProps.markLabel) != null
      ? _slotProps$markLabel
      : componentsProps.markLabel;
  const inputSlotProps =
    (_slotProps$input = slotProps == null ? void 0 : slotProps.input) != null
      ? _slotProps$input
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    RootSlot,
    (0, _extends2.default)({}, rootProps, {
      children: [
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(RailSlot, (0, _extends2.default)({}, railProps)),
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(TrackSlot, (0, _extends2.default)({}, trackProps)),
        marks
                    ...
                    (0, _extends2.default)(
                      ...
                      thumbProps,
                      {
                        className: (0, _clsx.default)(
                          ...
                          focusedThumbIndex === index && classes.focusVisible,
                        ),
                        style: (0, _extends2.default)(
                          {},
                          style,
...
process.env.NODE_ENV !== 'production'
  ? (Slider.propTypes /* remove-proptypes */ = {
      ...
      color: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['primary', 'secondary', 'error', 'info', 'success', 'warning']),
      ...
      componentsProps: _propTypes.default.shape({
        ...
        markLabel: _propTypes.default.oneOfType([
        ...
        valueLabel: _propTypes.default.oneOfType([
          _propTypes.default.func,
       ...
       * @default false
       */
      marks: _propTypes.default.oneOfType([
       ...
       * @default 'medium'
       */
      size: _propTypes.default /* @typescript-to-proptypes-ignore */
       ...
       * }
       */
      valueLabelFormat: _propTypes.default.oneOfType([
        _propTypes.default.func,
        _propTypes.default.string,
      ]),
    })
