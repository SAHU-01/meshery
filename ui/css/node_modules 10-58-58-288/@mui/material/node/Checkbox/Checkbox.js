...
var _CheckBoxOutlineBlank = _interopRequireDefault(
  require('../internal/svg-icons/CheckBoxOutlineBlank'),
);
var _CheckBox = _interopRequireDefault(require('../internal/svg-icons/CheckBox'));
var _IndeterminateCheckBox = _interopRequireDefault(
  require('../internal/svg-icons/IndeterminateCheckBox'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  const composedClasses = (0, _composeClasses.default)(
    slots,
    _checkboxClasses.getCheckboxUtilityClass,
    classes,
  );
    ...
    !ownerState.disableRipple && {
      '&:hover': {
        backgroundColor: theme.vars
          ? `rgba(${ownerState.color === 'default' ? theme.vars.palette.action.activeChannel : theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.hoverOpacity})`
...
const defaultIndeterminateIcon = /*#__PURE__*/ (0, _jsxRuntime.jsx)(
  _IndeterminateCheckBox.default,
  {},
);
    ...
    (0, _extends2.default)(
      {
        ...
        icon: /*#__PURE__*/ React.cloneElement(icon, {
          fontSize:
            (_icon$props$fontSize = icon.props.fontSize) != null ? _icon$props$fontSize : size,
        }),
        checkedIcon: /*#__PURE__*/ React.cloneElement(indeterminateIcon, {
          fontSize:
            (_indeterminateIcon$pr = indeterminateIcon.props.fontSize) != null
