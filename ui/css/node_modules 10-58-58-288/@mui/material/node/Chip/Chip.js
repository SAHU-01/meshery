...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      variant,
      disabled && 'disabled',
      `size${(0, _capitalize.default)(size)}`,
      `color${(0, _capitalize.default)(color)}`,
      clickable && 'clickable',
      clickable && `clickableColor${(0, _capitalize.default)(color)}`,
      onDelete && 'deletable',
      onDelete && `deletableColor${(0, _capitalize.default)(color)}`,
      `${variant}${(0, _capitalize.default)(color)}`,
    ],
    label: ['label', `label${(0, _capitalize.default)(size)}`],
    avatar: [
      'avatar',
      `avatar${(0, _capitalize.default)(size)}`,
      `avatarColor${(0, _capitalize.default)(color)}`,
    ],
    icon: [
      'icon',
      `icon${(0, _capitalize.default)(size)}`,
      `iconColor${(0, _capitalize.default)(iconColor)}`,
    ],
    deleteIcon: [
      'deleteIcon',
      `deleteIcon${(0, _capitalize.default)(size)}`,
      `deleteIconColor${(0, _capitalize.default)(color)}`,
      `deleteIcon${(0, _capitalize.default)(variant)}Color${(0, _capitalize.default)(color)}`,
    ],
  };
    ...
    return [
      ...
      },
      {
        [`& .${_chipClasses.default.avatar}`]:
          styles[`avatarColor${(0, _capitalize.default)(color)}`],
      },
      {
      ...
      },
      {
        [`& .${_chipClasses.default.icon}`]:
          styles[`iconColor${(0, _capitalize.default)(iconColor)}`],
      },
      {
      ...
      },
      {
        [`& .${_chipClasses.default.deleteIcon}`]:
          styles[`deleteIcon${(0, _capitalize.default)(size)}`],
      },
      {
        [`& .${_chipClasses.default.deleteIcon}`]:
          styles[`deleteIconColor${(0, _capitalize.default)(color)}`],
      },
      {
        [`& .${_chipClasses.default.deleteIcon}`]:
          styles[
      ...
      styles.root,
      styles[`size${(0, _capitalize.default)(size)}`],
      styles[`color${(0, _capitalize.default)(color)}`],
      clickable && styles.clickable,
      clickable &&
        color !== 'default' &&
        styles[`clickableColor${(0, _capitalize.default)(color)})`],
      onDelete && styles.deletable,
      onDelete && color !== 'default' && styles[`deletableColor${(0, _capitalize.default)(color)}`],
      styles[variant],
      styles[`${variant}${(0, _capitalize.default)(color)}`],
    ];
  },
})(
  ({ theme, ownerState }) => {
        ...
        [`& .${_chipClasses.default.deleteIcon}`]: (0, _extends2.default)(
          {
            ...
            color: theme.vars
              ...
              : (0, _colorManipulator.alpha)(theme.palette.text.primary, 0.26),
            fontSize: 22,
            cursor: 'pointer',
            margin: '0 5px 0 -6px',
            '&:hover': {
              color: theme.vars
                ...
                : (0, _colorManipulator.alpha)(theme.palette.text.primary, 0.4),
            },
          },
          ownerState.size === 'small' && {
            fontSize: 16,
          ...
          ownerState.color !== 'default' && {
            color: theme.vars
              ...
              : (0, _colorManipulator.alpha)(theme.palette[ownerState.color].contrastText, 0.7),
            '&:hover, &:active': {
    ...
    (0, _extends2.default)(
      ...
      ownerState.variant === 'outlined' && {
        ...
        border: theme.vars
          ...
          : `1px solid ${theme.palette.mode === 'light' ? theme.palette.grey[400] : theme.palette.grey[700]}`,
        ...
        ownerState.color !== 'default' && {
          ...
          [`& .${_chipClasses.default.deleteIcon}`]: {
            color: theme.vars
              ...
              : (0, _colorManipulator.alpha)(theme.palette[ownerState.color].main, 0.7),
            '&:hover, &:active': {
              color: (theme.vars || theme).palette[ownerState.color].main,
            },
          },
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        children: [
          avatar || icon,
          /*#__PURE__*/ (0, _jsxRuntime.jsx)(ChipLabel, {
...
process.env.NODE_ENV !== 'production'
  ? (Chip.propTypes /* remove-proptypes */ = {
       ...
       * @default 'filled'
       */
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
