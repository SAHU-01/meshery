...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      `textColor${(0, _capitalize.default)(textColor)}`,
      fullWidth && 'fullWidth',
      wrapped && 'wrapped',
      selected && 'selected',
      disabled && 'disabled',
...
const TabRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[`textColor${(0, _capitalize.default)(ownerState.textColor)}`],
  ...
  (0, _extends2.default)(
    ...
    ownerState.icon &&
      ownerState.label && {
        ...
        paddingTop: 9,
        paddingBottom: 9,
        [`& > .${_tabClasses.default.iconWrapper}`]: (0, _extends2.default)(
          {},
...
const Tab = /*#__PURE__*/ React.forwardRef(function Tab(inProps, ref) {
  ...
  const icon =
    iconProp && label && /*#__PURE__*/ React.isValidElement(iconProp)
      ? /*#__PURE__*/ React.cloneElement(iconProp, {
