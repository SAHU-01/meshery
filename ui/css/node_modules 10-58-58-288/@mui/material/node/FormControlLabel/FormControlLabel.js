...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      'root',
      disabled && 'disabled',
      `labelPlacement${(0, _capitalize.default)(labelPlacement)}`,
      error && 'error',
      required && 'required',
    ],
  ...
  return (0, _composeClasses.default)(
    slots,
    _formControlLabelClasses.getFormControlLabelUtilityClasses,
    classes,
  );
};
const FormControlLabelRoot = (exports.FormControlLabelRoot = (0, _styled.default)('label', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles.root,
      styles[`labelPlacement${(0, _capitalize.default)(ownerState.labelPlacement)}`],
    ];
  },
})(({ theme, ownerState }) =>
  (0, _extends2.default)(
...
const FormControlLabel = /*#__PURE__*/ React.forwardRef(function FormControlLabel(inProps, ref) {
  ...
  const disabled =
    (_ref = disabledProp != null ? disabledProp : control.props.disabled) != null
      ? _ref
      : muiFormControl == null
        ? void 0
