...
exports.rootOverridesResolver =
  exports.inputOverridesResolver =
  exports.default =
  exports.InputBaseRoot =
...
const rootOverridesResolver = (props, styles) => {
  ...
  return [
    ...
    ownerState.color && styles[`color${(0, _capitalize.default)(ownerState.color)}`],
...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      size && size !== 'medium' && `size${(0, _capitalize.default)(size)}`,
      multiline && 'multiline',
...
const InputBase = /*#__PURE__*/ React.forwardRef(function InputBase(inProps, ref) {
  ...
  const handleInputRef = (0, _useForkRef.default)(
    inputRef,
    inputRefProp,
    inputPropsProp.ref,
      ...
      if (element == null) {
        throw new Error(
          process.env.NODE_ENV !== 'production'
            ...
            : (0, _formatMuiErrorMessage2.default)(1),
        );
      }
      checkDirty({
        value: element.value,
      ...
      /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
        ...
        (0, _extends2.default)(
          ...
          other,
          {
            ...
            children: [
              startAdornment,
              /*#__PURE__*/ (0, _jsxRuntime.jsx)(_FormControlContext.default.Provider, {
                value: null,
                children: /*#__PURE__*/ (0, _jsxRuntime.jsx)(
                  ...
                  (0, _extends2.default)(
                    ...
                    inputProps,
                    !(0, _utils.isHostComponent)(Input) && {
                      as: InputComponent,
