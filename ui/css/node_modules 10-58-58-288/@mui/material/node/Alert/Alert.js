...
var _ReportProblemOutlined = _interopRequireDefault(
  require('../internal/svg-icons/ReportProblemOutlined'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      'root',
      `color${(0, _capitalize.default)(color || severity)}`,
      `${variant}${(0, _capitalize.default)(color || severity)}`,
      `${variant}`,
    ],
    icon: ['icon'],
    message: ['message'],
...
const AlertRoot = (0, _zeroStyled.styled)(_Paper.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `${ownerState.variant}${(0, _capitalize.default)(ownerState.color || ownerState.severity)}`
      ],
    ];
  },
})(({ theme }) => {
  const getColor =
    theme.palette.mode === 'light' ? _colorManipulator.darken : _colorManipulator.lighten;
  const getBackgroundColor =
    theme.palette.mode === 'light' ? _colorManipulator.lighten : _colorManipulator.darken;
  ...
  return /*#__PURE__*/ (0, _jsxRuntime.jsxs)(
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        children: [
          icon !== false
            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(AlertIcon, {
                ownerState: ownerState,
          ...
          action != null
            ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(AlertAction, {
                ownerState: ownerState,
...
process.env.NODE_ENV !== 'production'
  ? (Alert.propTypes /* remove-proptypes */ = {
      ...
      color: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['error', 'info', 'success', 'warning']),
       ...
       * @default 'success'
       */
      severity: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['error', 'info', 'success', 'warning']),
          _propTypes.default.string,
        ]),
      ...
      slotProps: _propTypes.default.shape({
        closeButton: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
        closeIcon: _propTypes.default.oneOfType([
          _propTypes.default.func,
          _propTypes.default.object,
        ]),
      }),
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['filled', 'outlined', 'standard']),
          _propTypes.default.string,
        ]),
    })
  : void 0;
