...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      size !== 'medium' && `size${(0, _capitalize.default)(size)}`,
    ],
  };
...
const Radio = /*#__PURE__*/ React.forwardRef(function Radio(inProps, ref) {
  ...
  const onChange = (0, _createChainedFunction.default)(
    onChangeProp,
    ...
    (0, _extends2.default)(
      {
        ...
        icon: /*#__PURE__*/ React.cloneElement(icon, {
          fontSize:
            (_defaultIcon$props$fo = defaultIcon.props.fontSize) != null
              ? _defaultIcon$props$fo
              : size,
        }),
        checkedIcon: /*#__PURE__*/ React.cloneElement(checkedIcon, {
          fontSize:
            (_defaultCheckedIcon$p = defaultCheckedIcon.props.fontSize) != null
