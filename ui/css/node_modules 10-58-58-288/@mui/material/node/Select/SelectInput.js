...
const SelectIcon = (0, _styled.default)('svg', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      styles.icon,
      ownerState.variant && styles[`icon${(0, _capitalize.default)(ownerState.variant)}`],
...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    icon: [
      'icon',
      `icon${(0, _capitalize.default)(variant)}`,
      open && 'iconOpen',
      disabled && 'disabled',
    ],
...
const SelectInput = /*#__PURE__*/ React.forwardRef(function SelectInput(props, ref) {
      ...
      if (!Array.isArray(value)) {
        throw new Error(
          process.env.NODE_ENV !== 'production'
            ...
            : (0, _formatMuiErrorMessage2.default)(2),
        );
      }
  ...
  const paperProps = (0, _extends2.default)(
    {},
