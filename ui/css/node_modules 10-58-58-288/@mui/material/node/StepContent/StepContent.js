...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _composeClasses.default)(
    slots,
    _stepContentClasses.getStepContentUtilityClass,
    classes,
  );
};
  ...
  (0, _extends2.default)(
    {
      ...
      borderLeft: theme.vars
        ...
        : `1px solid ${theme.palette.mode === 'light' ? theme.palette.grey[400] : theme.palette.grey[600]}`,
    },
    ownerState.last && {
      borderLeft: 'none',
    },
...
const StepContent = /*#__PURE__*/ React.forwardRef(function StepContent(inProps, ref) {
  ...
  const { orientation } = React.useContext(_StepperContext.default);
  const { active, last, expanded } = React.useContext(_StepContext.default);
