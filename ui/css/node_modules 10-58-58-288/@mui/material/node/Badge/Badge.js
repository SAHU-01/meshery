...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    badge: [
      ...
      `anchorOrigin${(0, _capitalize.default)(anchorOrigin.vertical)}${(0, _capitalize.default)(anchorOrigin.horizontal)}${(0, _capitalize.default)(overlap)}`,
      `overlap${(0, _capitalize.default)(overlap)}`,
      color !== 'default' && `color${(0, _capitalize.default)(color)}`,
    ],
  };
...
const BadgeBadge = (0, _zeroStyled.styled)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `anchorOrigin${(0, _capitalize.default)(ownerState.anchorOrigin.vertical)}${(0, _capitalize.default)(ownerState.anchorOrigin.horizontal)}${(0, _capitalize.default)(ownerState.overlap)}`
      ],
    ...
    variants: [
      ...Object.keys(((_theme$vars = theme.vars) != null ? _theme$vars : theme).palette)
        .filter((key) => {
          ...
          return (
            ((_theme$vars2 = theme.vars) != null ? _theme$vars2 : theme).palette[key].main &&
            ((_theme$vars3 = theme.vars) != null ? _theme$vars3 : theme).palette[key].contrastText
          );
        })
        .map((color) => ({
          props: {
...
const Badge = /*#__PURE__*/ React.forwardRef(function Badge(inProps, ref) {
  ...
  const BadgeSlot =
    (_ref2 =
      (_slots$badge = slots == null ? void 0 : slots.badge) != null
        ? _slots$badge
  ...
  const badgeSlotProps =
    (_slotProps$badge = slotProps == null ? void 0 : slotProps.badge) != null
      ? _slotProps$badge
  ...
  const badgeProps = (0, _utils.useSlotProps)({
    ...
    className: (0, _clsx.default)(
      classes.badge,
      badgeSlotProps == null ? void 0 : badgeSlotProps.className,
    ),
  });
    ...
    (0, _extends2.default)({}, rootProps, {
      children: [
        ...
        /*#__PURE__*/ (0, _jsxRuntime.jsx)(
          BadgeSlot,
          (0, _extends2.default)({}, badgeProps, {
