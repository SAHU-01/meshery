...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      align !== 'inherit' && `align${(0, _capitalize.default)(align)}`,
      padding !== 'normal' && `padding${(0, _capitalize.default)(padding)}`,
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      ownerState.padding !== 'normal' &&
        styles[`padding${(0, _capitalize.default)(ownerState.padding)}`],
...
process.env.NODE_ENV !== 'production'
  ? (TableCell.propTypes /* remove-proptypes */ = {
      ...
      variant: _propTypes.default /* @typescript-to-proptypes-ignore */
        .oneOfType([
          _propTypes.default.oneOf(['body', 'footer', 'head']),
