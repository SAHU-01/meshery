...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    tooltip: [
      ...
      arrow && 'tooltipArrow',
      touch && 'touch',
      'tooltipPlacement'.concat(capitalize(placement.split('-')[0])),
    ],
    arrow: ['arrow'],
  };
...
var TooltipTooltip = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles['tooltipPlacement'.concat(capitalize(ownerState.placement.split('-')[0]))],
    ];
  },
})(function (_ref3) {
...
var Tooltip = /*#__PURE__*/ React.forwardRef(function Tooltip(inProps, ref) {
  ...
  var children = /*#__PURE__*/ React.isValidElement(childrenProp)
    ? childrenProp
    : /*#__PURE__*/ _jsx('span', {
  ...
  var PopperComponent =
    (_ref5 = (_slots$popper = slots.popper) != null ? _slots$popper : components.Popper) != null
      ? _ref5
      : TooltipPopper;
  ...
  var TooltipComponent =
    (_ref8 = (_slots$tooltip = slots.tooltip) != null ? _slots$tooltip : components.Tooltip) != null
      ? _ref8
      : TooltipTooltip;
  var ArrowComponent =
    (_ref9 = (_slots$arrow = slots.arrow) != null ? _slots$arrow : components.Arrow) != null
      ? _ref9
      : TooltipArrow;
  var popperProps = appendOwnerState(
    PopperComponent,
    _extends(
      {},
      PopperProps,
  ...
  var transitionProps = appendOwnerState(
    TransitionComponent,
    _extends(
      {},
      TransitionProps,
  ...
  var tooltipProps = appendOwnerState(
    TooltipComponent,
    _extends(
      {},
  ...
  var tooltipArrowProps = appendOwnerState(
    ArrowComponent,
    _extends(
      {},
