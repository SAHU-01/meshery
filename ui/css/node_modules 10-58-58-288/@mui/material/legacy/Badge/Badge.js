...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    badge: [
      ...
      'overlap'.concat(capitalize(overlap)),
      color !== 'default' && 'color'.concat(capitalize(color)),
    ],
  };
...
var BadgeBadge = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles[
        'anchorOrigin'
          .concat(capitalize(ownerState.anchorOrigin.vertical))
          .concat(capitalize(ownerState.anchorOrigin.horizontal))
          .concat(capitalize(ownerState.overlap))
      ],
