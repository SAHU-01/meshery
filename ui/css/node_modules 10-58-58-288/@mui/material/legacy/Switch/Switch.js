...
var SwitchRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.root,
      ownerState.edge && styles['edge'.concat(capitalize(ownerState.edge))],
...
var SwitchSwitchBase = styled(SwitchBase, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.switchBase,
      _defineProperty({}, '& .'.concat(switchClasses.input), styles.input),
      ...
      _defineProperty(
        ...
        '&.'.concat(switchClasses.disabled, ' + .').concat(switchClasses.track),
        {
          opacity: theme.vars
            ...
            : ''.concat(theme.palette.mode === 'light' ? 0.12 : 0.2),
        },
      ),
    ...
    return {
      '&:hover': {
        backgroundColor: theme.vars
          ? 'rgba('
              .concat(theme.vars.palette.action.activeChannel, ' / ')
                  ...
                  _defineProperty(
                    {
                      ...
                      '&:hover': {
                        backgroundColor: theme.vars
                          ? 'rgba('
                              .concat(theme.vars.palette[color].mainChannel, ' / ')
                              .concat(theme.vars.palette.action.hoverOpacity, ')')
                    ...
                    {
                      color: theme.vars
                        ? theme.vars.palette.Switch[''.concat(color, 'DisabledColor')]
                        : ''.concat(
                            theme.palette.mode === 'light'
...
var SwitchTrack = styled('span', {
  ...
  return {
    ...
    opacity: theme.vars
      ...
      : ''.concat(theme.palette.mode === 'light' ? 0.38 : 0.3),
  };
});
