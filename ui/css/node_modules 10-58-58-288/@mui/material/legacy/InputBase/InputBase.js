...
export var rootOverridesResolver = function rootOverridesResolver(props, styles) {
  ...
  return [
    ...
    ownerState.color && styles['color'.concat(capitalize(ownerState.color))],
...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      size && size !== 'medium' && 'size'.concat(capitalize(size)),
      multiline && 'multiline',
      ...
      /*#__PURE__*/ _jsxs(
        ...
        _extends(
          ...
          other,
          {
            ...
            children: [
              startAdornment,
              /*#__PURE__*/ _jsx(FormControlContext.Provider, {
                value: null,
