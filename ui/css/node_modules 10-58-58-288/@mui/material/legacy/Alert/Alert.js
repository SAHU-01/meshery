...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      'root',
      'color'.concat(capitalize(color || severity)),
      ''.concat(variant).concat(capitalize(color || severity)),
      ''.concat(variant),
    ],
    icon: ['icon'],
    message: ['message'],
...
var AlertRoot = styled(Paper, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles[
        ''.concat(ownerState.variant).concat(capitalize(ownerState.color || ownerState.severity))
      ],
    ];
  },
})(function (_ref) {
          ...
          .map(function (_ref4) {
            ...
            return {
              ...
              style: _defineProperty(
                {
                  color: theme.vars
                    ? theme.vars.palette.Alert[''.concat(color, 'Color')]
                    : getColor(theme.palette[color].light, 0.6),
                  backgroundColor: theme.vars
                    ? theme.vars.palette.Alert[''.concat(color, 'StandardBg')]
