...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      'color'.concat(capitalize(color)),
      clickable && 'clickable',
      clickable && 'clickableColor'.concat(capitalize(color)),
      onDelete && 'deletable',
      onDelete && 'deletableColor'.concat(capitalize(color)),
      ''.concat(variant).concat(capitalize(color)),
    ],
    ...
    deleteIcon: [
      'deleteIcon',
      'deleteIcon'.concat(capitalize(size)),
      'deleteIconColor'.concat(capitalize(color)),
      'deleteIcon'.concat(capitalize(variant), 'Color').concat(capitalize(color)),
    ],
  };
...
var ChipRoot = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    var color = ownerState.color,
      ...
      variant = ownerState.variant;
    return [
      _defineProperty({}, '& .'.concat(chipClasses.avatar), styles.avatar),
      _defineProperty(
        {},
        '& .'.concat(chipClasses.avatar),
        styles['avatar'.concat(capitalize(size))],
      ),
      _defineProperty(
        {},
        '& .'.concat(chipClasses.avatar),
        styles['avatarColor'.concat(capitalize(color))],
      ),
      _defineProperty({}, '& .'.concat(chipClasses.icon), styles.icon),
      _defineProperty({}, '& .'.concat(chipClasses.icon), styles['icon'.concat(capitalize(size))]),
      _defineProperty(
        {},
        '& .'.concat(chipClasses.icon),
        styles['iconColor'.concat(capitalize(iconColor))],
      ),
      _defineProperty({}, '& .'.concat(chipClasses.deleteIcon), styles.deleteIcon),
      _defineProperty(
        {},
        '& .'.concat(chipClasses.deleteIcon),
        styles['deleteIcon'.concat(capitalize(size))],
      ),
      _defineProperty(
        {},
        '& .'.concat(chipClasses.deleteIcon),
        styles['deleteIconColor'.concat(capitalize(color))],
      ),
      _defineProperty(
        {},
        '& .'.concat(chipClasses.deleteIcon),
        styles['deleteIcon'.concat(capitalize(variant), 'Color').concat(capitalize(color))],
      ),
      styles.root,
      styles['size'.concat(capitalize(size))],
      styles['color'.concat(capitalize(color))],
      clickable && styles.clickable,
      clickable && color !== 'default' && styles['clickableColor'.concat(capitalize(color), ')')],
      onDelete && styles.deletable,
      onDelete && color !== 'default' && styles['deletableColor'.concat(capitalize(color))],
      styles[variant],
      styles[''.concat(variant).concat(capitalize(color))],
    ];
  },
})(
  function (_ref11) {
    ...
    return _extends(
        ...
        _extends(
          {
            ...
            color: theme.vars
              ? 'rgba('.concat(theme.vars.palette.text.primaryChannel, ' / 0.26)')
            ...
            '&:hover': {
              color: theme.vars
                ? 'rgba('.concat(theme.vars.palette.text.primaryChannel, ' / 0.4)')
          ...
          ownerState.color !== 'default' && {
            color: theme.vars
              ? 'rgba('.concat(theme.vars.palette[ownerState.color].contrastTextChannel, ' / 0.7)')
      ...
      ownerState.onDelete &&
        _defineProperty({}, '&.'.concat(chipClasses.focusVisible), {
          backgroundColor: theme.vars
            ? 'rgba('
                .concat(theme.vars.palette.action.selectedChannel, ' / calc(')
                .concat(theme.vars.palette.action.selectedOpacity, ' + ')
                .concat(theme.vars.palette.action.focusOpacity, '))')
            : alpha(
  ...
  function (_ref14) {
    ...
    return _extends(
      ...
      ownerState.clickable &&
        ownerState.color !== 'default' &&
        _defineProperty({}, '&:hover, &.'.concat(chipClasses.focusVisible), {
          backgroundColor: (theme.vars || theme).palette[ownerState.color].dark,
        }),
    );
  },
                      ...
                      _defineProperty(
                        {
                          ...
                          border: theme.vars
                            ? '1px solid '.concat(theme.vars.palette.Chip.defaultBorder)
                            : '1px solid '.concat(
            ...
            _defineProperty(
              {
                ...
                border: '1px solid '.concat(
                  theme.vars
                    ? 'rgba('.concat(theme.vars.palette[ownerState.color].mainChannel, ' / 0.7)')
              ...
              '&.'.concat(chipClasses.clickable, ':hover'),
              {
                backgroundColor: theme.vars
                  ? 'rgba('
                      .concat(theme.vars.palette[ownerState.color].mainChannel, ' / ')
                      .concat(theme.vars.palette.action.hoverOpacity, ')')
