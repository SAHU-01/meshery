...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    paper: [
      'paper',
      'paperScroll'.concat(capitalize(scroll)),
      'paperWidth'.concat(capitalize(String(maxWidth))),
...
var DialogPaper = styled(Paper, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.paper,
      styles['scrollPaper'.concat(capitalize(ownerState.scroll))],
      styles['paperWidth'.concat(capitalize(String(ownerState.maxWidth)))],
      ...
      _defineProperty(
        {
          maxWidth:
            theme.breakpoints.unit === 'px'
              ...
              : 'max('
                  .concat(theme.breakpoints.values.xs)
                  .concat(theme.breakpoints.unit, ', 444px)'),
        },
