      ...
      _toConsumableArray(
        breakpoints.map(function (_ref) {
          var breakpoint = _ref.breakpoint,
            dir = _ref.dir;
          return dir === 'only'
            ? ''.concat(dir).concat(capitalize(breakpoint))
            : ''.concat(breakpoint).concat(capitalize(dir));
        }),
      ),
    ),
  };
  ...
  return _extends(
    ...
    ownerState.breakpoints
      .map(function (_ref3) {
        ...
        return dir === 'up'
          ? _defineProperty({}, theme.breakpoints.up(breakpoint), hidden)
          : _defineProperty({}, theme.breakpoints.down(breakpoint), hidden);
      })
      .reduce(function (r, o) {
...
function HiddenCss(props) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    if (unknownProps.length > 0) {
      console.error(
        'MUI: Unsupported props received by `<Hidden implementation="css" />`: '.concat(
          unknownProps.join(', '),
