...
var ToggleButtonRoot = styled(ButtonBase, {
  ...
  return _extends(
    ...
    _defineProperty(
      _defineProperty(
        _defineProperty({}, '&.'.concat(toggleButtonClasses.disabled), {
...
var ToggleButton = /*#__PURE__*/ React.forwardRef(function ToggleButton(inProps, ref) {
  ...
  var toggleButtonGroupButtonContextPositionClassName = React.useContext(
    ToggleButtonGroupButtonContext,
  );
  var resolvedProps = resolveProps(
    _extends({}, contextProps, {
