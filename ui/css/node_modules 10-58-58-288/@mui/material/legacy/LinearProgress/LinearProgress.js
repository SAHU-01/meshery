...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    bar1: [
      'bar',
      'barColor'.concat(capitalize(color)),
    ...
    bar2: [
      'bar',
      variant !== 'buffer' && 'barColor'.concat(capitalize(color)),
      variant === 'buffer' && 'color'.concat(capitalize(color)),
    ...
    return _extends(
      ...
      },
      {
        backgroundImage: 'radial-gradient('
          .concat(backgroundColor, ' 0%, ')
          .concat(backgroundColor, ' 16%, transparent 42%)'),
...
var LinearProgressBar1 = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.bar,
      styles['barColor'.concat(capitalize(ownerState.color))],
  ...
  return /*#__PURE__*/ _jsxs(
    ...
    _extends(
      ...
      other,
      {
        children: [
          variant === 'buffer'
            ? /*#__PURE__*/ _jsx(LinearProgressDashed, {
                className: classes.dashed,
                ownerState: ownerState,
              })
            : null,
          /*#__PURE__*/ _jsx(LinearProgressBar1, {
          ...
          variant === 'determinate'
            ? null
            : /*#__PURE__*/ _jsx(LinearProgressBar2, {
