...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return [
    styles.root,
    styles['position'.concat(capitalize(ownerState.position))],
...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      position && 'position'.concat(capitalize(position)),
      variant,
  ...
  return _extends(
    ...
    ownerState.variant === 'filled' &&
      _defineProperty(
        {},
        '&.'
          .concat(inputAdornmentClasses.positionStart, '&:not(.')
          .concat(inputAdornmentClasses.hiddenLabel, ')'),
        {
          marginTop: 16,
        },
      ),
          ...
          children:
            typeof children === 'string' && !disableTypography
              ...
              : /*#__PURE__*/ _jsxs(React.Fragment, {
                  children: [
                    position === 'start'
                      ? /* notranslate needed while Google Translate will not fix zero-width space issue */ _span ||
