...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      'root',
      color !== 'inherit' && 'color'.concat(capitalize(color)),
      'fontSize'.concat(capitalize(fontSize)),
    ],
  };
...
var SvgIconRoot = styled('svg', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.root,
      ownerState.color !== 'inherit' && styles['color'.concat(capitalize(ownerState.color))],
      styles['fontSize'.concat(capitalize(ownerState.fontSize))],
    ];
  },
})(function (_ref) {
  ...
  return {
    ...
    transition:
      ...
      (_theme$transitions$cr = _theme$transitions.create) == null
        ...
        : _theme$transitions$cr.call(_theme$transitions, 'fill', {
            duration:
              (_theme$transitions2 = theme.transitions) == null ||
              (_theme$transitions2 = _theme$transitions2.duration) == null
                ? void 0
    ...
    fontSize: {
      ...
      small:
        ...
        (_theme$typography$pxT = _theme$typography.pxToRem) == null
          ? void 0
    ...
    color:
      (_palette$ownerState$c =
        (_palette = (theme.vars || theme).palette) == null ||
        (_palette = _palette[ownerState.color]) == null
          ? void 0
          : _palette.main) != null
        ? _palette$ownerState$c
        : {
            action:
              (_palette2 = (theme.vars || theme).palette) == null ||
              (_palette2 = _palette2.action) == null
                ? void 0
                : _palette2.active,
            disabled:
              (_palette3 = (theme.vars || theme).palette) == null ||
              (_palette3 = _palette3.action) == null
                ? void 0
                : _palette3.disabled,
            inherit: undefined,
          }[ownerState.color],
