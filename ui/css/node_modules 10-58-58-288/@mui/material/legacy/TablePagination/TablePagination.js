...
var TablePaginationToolbar = styled(Toolbar, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    return _extends(
      _defineProperty({}, '& .'.concat(tablePaginationClasses.actions), styles.actions),
      styles.toolbar,
    );
  },
})(function (_ref2) {
...
var TablePaginationSelect = styled(Select, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    return _extends(
      _defineProperty(
        _defineProperty({}, '& .'.concat(tablePaginationClasses.selectIcon), styles.selectIcon),
...
function defaultLabelDisplayedRows(_ref6) {
  ...
  return ''
    .concat(from, '\u2013')
    .concat(to, ' of ')
    .concat(count !== -1 ? count : 'more than '.concat(to));
}
...
var TablePagination = /*#__PURE__*/ React.forwardRef(function TablePagination(inProps, ref) {
  ...
  var _props$ActionsCompone = props.ActionsComponent,
    ActionsComponent =
      _props$ActionsCompone === void 0 ? TablePaginationActions : _props$ActionsCompone,
    ...
    labelDisplayedRows =
      _props$labelDisplayed === void 0 ? defaultLabelDisplayedRows : _props$labelDisplayed,
    ...
    rowsPerPageOptions =
      _props$rowsPerPageOpt === void 0 ? [10, 25, 50, 100] : _props$rowsPerPageOpt,
  ...
  var selectProps =
    (_slotProps$select = slotProps == null ? void 0 : slotProps.select) != null
      ? _slotProps$select
      : SelectProps;
    ...
    _extends(
      ...
      other,
      {
        children: /*#__PURE__*/ _jsxs(TablePaginationToolbar, {
          ...
          children: [
            /*#__PURE__*/ _jsx(TablePaginationSpacer, {
              className: classes.spacer,
            }),
            rowsPerPageOptions.length > 1 &&
              /*#__PURE__*/ _jsx(TablePaginationSelectLabel, {
        ...
        if (page < 0 || page > newLastPage) {
          return new Error(
            'MUI: The page prop of a TablePagination is out of range ' +
              '(0 to '.concat(newLastPage, ', but page is ').concat(page, ').'),
          );
        }
        return null;
      }),
