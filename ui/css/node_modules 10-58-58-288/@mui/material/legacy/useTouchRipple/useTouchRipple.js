...
var useTouchRipple = function useTouchRipple(props) {
  ...
  function useRippleHandler(rippleAction) {
    var skipRippleAction =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : disableTouchRipple;
  ...
  var handleKeyDown = useEventCallback(function (event) {
    if (
      ...
      rippleRef.current.stop(event, function () {
        ...
        rippleRef == null ||
          (_rippleRef$current2 = rippleRef.current) == null ||
          _rippleRef$current2.start(event);
      });
    }
  });
  var handleKeyUp = useEventCallback(function (event) {
    ...
    if (
      ...
      rippleRef.current.stop(event, function () {
        ...
        rippleRef == null ||
          (_rippleRef$current3 = rippleRef.current) == null ||
          _rippleRef$current3.pulsate(event);
      });
    }
  });
  ...
  var getRippleHandlers = React.useMemo(
    function () {
      var rippleHandlers = {
        onBlur: handleBlur,
          ...
          return {
            ...
            handler: function handler(ev) {
              ...
              (_otherEvents$eventNam = otherEvents[eventName]) == null ||
                _otherEvents$eventNam.call(otherEvents, ev);
