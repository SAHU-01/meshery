...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      align !== 'inherit' && 'align'.concat(capitalize(align)),
      padding !== 'normal' && 'padding'.concat(capitalize(padding)),
...
var TableCellRoot = styled('td', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      ownerState.padding !== 'normal' && styles['padding'.concat(capitalize(ownerState.padding))],
      ownerState.align !== 'inherit' && styles['align'.concat(capitalize(ownerState.align))],
  ...
  return _extends(
    ...
    theme.typography.body2,
    {
      ...
      borderBottom: theme.vars
        ? '1px solid '.concat(theme.vars.palette.TableCell.border)
        : '1px solid\n    '.concat(
