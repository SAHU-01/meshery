...
var SpeedDialIconRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      _defineProperty({}, '& .'.concat(speedDialIconClasses.icon), styles.icon),
      _defineProperty(
        {},
      ...
      _defineProperty({}, '& .'.concat(speedDialIconClasses.openIcon), styles.openIcon),
      _defineProperty(
        {},
        '& .'.concat(speedDialIconClasses.openIcon),
        ownerState.open && styles.openIconOpen,
      ),
      styles.root,
    ];
  },
