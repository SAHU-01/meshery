...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    staticTooltip: [
      'staticTooltip',
      'tooltipPlacement'.concat(capitalize(tooltipPlacement)),
...
var SpeedDialActionStaticTooltip = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles['tooltipPlacement'.concat(capitalize(ownerState.tooltipPlacement))],
    ];
  },
})(function (_ref2) {
  ...
  if (tooltipOpenProp) {
    return /*#__PURE__*/ _jsxs(
      ...
      _extends(
        ...
        {
          children: [
            /*#__PURE__*/ _jsx(SpeedDialActionStaticTooltipLabel, {
