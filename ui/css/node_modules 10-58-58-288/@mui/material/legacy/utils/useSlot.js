...
export default function useSlot(
  ...
  var className = parameters.className,
    ...
    useSlotPropsParams = _objectWithoutProperties(parameters, [
      'className',
      'elementType',
      'ownerState',
  ...
  var _mergeSlotProps = mergeSlotProps(
      _extends(
        {
          className: className,
        },
