...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return [
    ...
    styles['size'.concat(capitalize(ownerState.size))],
    ownerState.variant === 'text' && styles['text'.concat(capitalize(ownerState.color))],
    ownerState.variant === 'outlined' && styles['outlined'.concat(capitalize(ownerState.color))],
...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      variant,
      shape,
      color !== 'standard' && 'color'.concat(capitalize(color)),
      color !== 'standard' && ''.concat(variant).concat(capitalize(color)),
      disabled && 'disabled',
      selected && 'selected',
      {
        page: 'page',
    ...
    return _extends(
      ...
      ownerState.variant === 'outlined' &&
        _defineProperty(
          {
            border: theme.vars
              ? '1px solid rgba('.concat(theme.vars.palette.common.onBackgroundChannel, ' / 0.23)')
              : '1px solid '.concat(
              ...
              _defineProperty(
                {
                  ...
                  backgroundColor: theme.vars
                    ? 'rgba('
                        ...
                        .concat(theme.vars.palette.action.activatedOpacity, ')')
                    : alpha(
                  ...
                  '&:hover': {
                    backgroundColor: theme.vars
                      ? 'rgba('
                          .concat(theme.vars.palette[ownerState.color].mainChannel, ' / calc(')
                          .concat(theme.vars.palette.action.activatedOpacity, ' + ')
                          .concat(theme.vars.palette.action.focusOpacity, '))')
                      : alpha(
                          theme.palette[ownerState.color].main,
...
var PaginationItem = /*#__PURE__*/ React.forwardRef(function PaginationItem(inProps, ref) {
  ...
  return type === 'start-ellipsis' || type === 'end-ellipsis'
    ? /*#__PURE__*/ _jsx(PaginationItemEllipsis, {
        ref: ref,
        ...
        _extends(
          ...
          other,
          {
            children: [
              type === 'page' && page,
              Icon
                ? /*#__PURE__*/ _jsx(PaginationItemPageIcon, {
                    as: Icon,
                    ownerState: ownerState,
