...
var SelectSelect = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      _defineProperty({}, '&.'.concat(selectClasses.select), styles.select),
      _defineProperty({}, '&.'.concat(selectClasses.select), styles[ownerState.variant]),
      _defineProperty({}, '&.'.concat(selectClasses.error), styles.error),
      _defineProperty({}, '&.'.concat(selectClasses.multiple), styles.multiple),
    ];
  },
})(
  nativeSelectSelectStyles,
  _defineProperty({}, '&.'.concat(selectClasses.select), {
    height: 'auto',
...
var SelectIcon = styled('svg', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.icon,
      ownerState.variant && styles['icon'.concat(capitalize(ownerState.variant))],
          ...
          console.warn(
            [
              'MUI: You have provided an out-of-range value `'
                .concat(value, '` for the select ')
                .concat(name ? '(name="'.concat(name, '") ') : '', 'component.'),
              "Consider providing a value that matches one of the available options or ''.",
              'The available values are '.concat(
                values
                  .filter(function (x) {
                    return x != null;
                  })
