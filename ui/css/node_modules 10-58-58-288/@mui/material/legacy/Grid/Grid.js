...
export function generateGrid(_ref) {
  ...
  return theme.breakpoints.keys.reduce(function (globalStyles, breakpoint) {
    ...
    if (size === true) {
      ...
      var columnValue =
        _typeof(columnsBreakpointValues) === 'object'
...
var GridRoot = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      _toConsumableArray(spacingStyles),
      [
...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: ['root', container && 'container', item && 'item', zeroMinWidth && 'zeroMinWidth'].concat(
      _toConsumableArray(spacingClasses),
      [
