...
var AutocompleteRoot = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    var fullWidth = ownerState.fullWidth,
      ...
      size = ownerState.size;
    return [
      _defineProperty({}, '& .'.concat(autocompleteClasses.tag), styles.tag),
      _defineProperty(
        {},
        '& .'.concat(autocompleteClasses.tag),
        styles['tagSize'.concat(capitalize(size))],
      ),
      _defineProperty({}, '& .'.concat(autocompleteClasses.inputRoot), styles.inputRoot),
      _defineProperty({}, '& .'.concat(autocompleteClasses.input), styles.input),
      _defineProperty(
        {},
      ...
      _defineProperty(
        _defineProperty(
          _defineProperty(
            _defineProperty(
              _defineProperty(
                _defineProperty(
                    ...
                    _defineProperty(
                      _defineProperty(
                        _defineProperty(
                          {},
                          '.'
                            .concat(autocompleteClasses.hasPopupIcon, '&, .')
                            .concat(autocompleteClasses.hasClearIcon, '&'),
                          {
                            paddingRight: 26 + 4,
                          },
                        ),
                  ...
                  _defineProperty(
                    _defineProperty({}, '& .'.concat(autocompleteClasses.clearIndicator), {
                      visibility: 'visible',
                    }),
                    '& .'.concat(autocompleteClasses.input),
                    {
                ...
                '@media (pointer: fine)',
                _defineProperty(
                  _defineProperty({}, '&:hover .'.concat(autocompleteClasses.clearIndicator), {
                    visibility: 'visible',
                  }),
            ...
            _defineProperty({}, '& .'.concat(inputClasses.input), {
    ...
    _defineProperty(
      _defineProperty(
        ...
        '& .'
          ...
          .concat(inputBaseClasses.sizeSmall),
        _defineProperty({}, '& .'.concat(autocompleteClasses.input), {
          paddingTop: 8,
          paddingBottom: 9,
        }),
      ),
...
var AutocompletePopper = styled(Popper, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var ownerState = props.ownerState;
    return [
      _defineProperty({}, '& .'.concat(autocompleteClasses.option), styles.option),
      styles.popper,
        ...
        _defineProperty(
          {
            backgroundColor: theme.vars
              ? 'rgba('
                  .concat(theme.vars.palette.primary.mainChannel, ' / ')
          ...
          '&.'.concat(autocompleteClasses.focused),
          {
            backgroundColor: theme.vars
              ? 'rgba('
                  .concat(theme.vars.palette.primary.mainChannel, ' / calc(')
                  .concat(theme.vars.palette.action.selectedOpacity, ' + ')
...
var Autocomplete = /*#__PURE__*/ React.forwardRef(function Autocomplete(inProps, ref) {
  ...
  var _props$autoComplete = props.autoComplete,
    ...
    clearIcon =
      _props$clearIcon === void 0
        ? _ClearIcon ||
          (_ClearIcon = /*#__PURE__*/ _jsx(ClearIcon, {
            fontSize: 'small',
          }))
        : _props$clearIcon,
    ...
    popupIcon =
      _props$popupIcon === void 0
        ? _ArrowDropDownIcon || (_ArrowDropDownIcon = /*#__PURE__*/ _jsx(ArrowDropDownIcon, {}))
        : _props$popupIcon,
  ...
  var defaultRenderGroup = function defaultRenderGroup(params) {
    return /*#__PURE__*/ _jsxs(
      ...
      {
        children: [
          /*#__PURE__*/ _jsx(AutocompleteGroupLabel, {
  ...
  var clearIndicatorSlotProps =
    (_slotProps$clearIndic = slotProps.clearIndicator) != null
      ? _slotProps$clearIndic
      : componentsProps.clearIndicator;
  var paperSlotProps =
    (_slotProps$paper = slotProps.paper) != null ? _slotProps$paper : componentsProps.paper;
  var popperSlotProps =
    (_slotProps$popper = slotProps.popper) != null ? _slotProps$popper : componentsProps.popper;
  var popupIndicatorSlotProps =
    (_slotProps$popupIndic = slotProps.popupIndicator) != null
    ...
    return /*#__PURE__*/ _jsx(
      ...
      _extends(
        ...
        popperSlotProps,
        {
          className: clsx(
            classes.popper,
            popperSlotProps == null ? void 0 : popperSlotProps.className,
          ),
          children: /*#__PURE__*/ _jsx(
            ...
            _extends(
              ...
              paperSlotProps,
              {
                className: clsx(
                  classes.paper,
                  paperSlotProps == null ? void 0 : paperSlotProps.className,
                ),
                children: children,
              },
            ),
  ...
  if (groupedOptions.length > 0) {
    ...
    autocompletePopper = renderAutocompletePopperChildren(
      /*#__PURE__*/ _jsx(AutocompleteLoading, {
    ...
    autocompletePopper = renderAutocompletePopperChildren(
      /*#__PURE__*/ _jsx(AutocompleteNoOptions, {
        ...
        if (
          ...
          return new Error(
            [
              ...
              'However, '.concat(props.defaultValue, ' was provided.'),
            ].join('\n'),
          );
        }
        return null;
        ...
        if (props.multiple && props.value !== undefined && !Array.isArray(props.value)) {
          return new Error(
            [
              ...
              'However, '.concat(props.value, ' was provided.'),
            ].join('\n'),
          );
        }
        return null;
