...
var RatingRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      _defineProperty({}, '& .'.concat(ratingClasses.visuallyHidden), styles.visuallyHidden),
      styles.root,
  ...
  return _extends(
    _defineProperty(
      ...
      '& .'.concat(ratingClasses.visuallyHidden),
      visuallyHidden,
    ),
...
var Rating = /*#__PURE__*/ React.forwardRef(function Rating(inProps, ref) {
  ...
  var className = props.className,
    ...
    IconContainerComponent =
      _props$IconContainerC === void 0 ? IconContainer : _props$IconContainerC,
  ...
  var handleMouseMove = function handleMouseMove(event) {
    ...
    setState(function (prev) {
      return prev.hover === newHover && prev.focus === newHover
        ? prev
        : {
            hover: newHover,
            focus: newHover,
  ...
  return /*#__PURE__*/ _jsxs(
    ...
    _extends(
      ...
      {
        children: [
          Array.from(new Array(max)).map(function (_, index) {
              ...
              return /*#__PURE__*/ _jsx(
                RatingDecimal,
                {
                  ...
                  children: items.map(function ($, indexDecimal) {
                    var itemDecimalValue = roundValueToPrecision(
                      itemValue - 1 + (indexDecimal + 1) * precision,
                      precision,
                    );
                    return /*#__PURE__*/ _jsx(
                      RatingItem,
                      _extends({}, ratingItemProps, {
                              ...
                              : {
                                  width:
                                    itemDecimalValue === value
                                      ? ''.concat((indexDecimal + 1) * precision * 100, '%')
                                      : '0%',
                                  overflow: 'hidden',
                                  position: 'absolute',
                                },
