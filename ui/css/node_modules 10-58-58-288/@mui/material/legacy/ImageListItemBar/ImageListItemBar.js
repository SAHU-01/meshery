...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    titleWrap: [
      'titleWrap',
      'titleWrap'.concat(capitalize(position)),
      actionIcon && 'titleWrapActionPos'.concat(capitalize(actionPosition)),
    ],
    title: ['title'],
    subtitle: ['subtitle'],
...
var ImageListItemBarTitleWrap = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.titleWrap,
      styles['titleWrap'.concat(capitalize(ownerState.position))],
      ownerState.actionIcon &&
        styles['titleWrapActionPos'.concat(capitalize(ownerState.actionPosition))],
    ];
  },
})(function (_ref2) {
...
var ImageListItemBarActionIcon = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.actionIcon,
      styles['actionIconActionPos'.concat(capitalize(ownerState.actionPosition))],
    ];
  },
})(function (_ref5) {
...
var ImageListItemBar = /*#__PURE__*/ React.forwardRef(function ImageListItemBar(inProps, ref) {
  ...
  return /*#__PURE__*/ _jsxs(
    ...
    _extends(
      ...
      {
        children: [
          /*#__PURE__*/ _jsxs(ImageListItemBarTitleWrap, {
            ownerState: ownerState,
            className: classes.titleWrap,
            children: [
              /*#__PURE__*/ _jsx(ImageListItemBarTitle, {
                className: classes.title,
                children: title,
              }),
              subtitle
                ? /*#__PURE__*/ _jsx(ImageListItemBarSubtitle, {
          ...
          actionIcon
            ? /*#__PURE__*/ _jsx(ImageListItemBarActionIcon, {
                ownerState: ownerState,
