...
var TabsRoot = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      _defineProperty({}, '& .'.concat(tabsClasses.scrollButtons), styles.scrollButtons),
      _defineProperty(
        {},
  ...
  return _extends(
    ...
    ownerState.scrollButtonsHideMobile &&
      _defineProperty(
        {},
        '& .'.concat(tabsClasses.scrollButtons),
        _defineProperty({}, theme.breakpoints.down('sm'), {
          display: 'none',
        }),
      ),
  );
...
var Tabs = /*#__PURE__*/ React.forwardRef(function Tabs(inProps, ref) {
  ...
  var ariaLabel = props['aria-label'],
    ...
    ScrollButtonComponent =
      _props$ScrollButtonCo === void 0 ? TabScrollButton : _props$ScrollButtonCo,
          ...
          if (!tab) {
            console.error(
              [
                ...
                valueToIndex.keys
                  ? 'You can provide one of the following values: '.concat(
                      Array.from(valueToIndex.keys()).join(', '),
                      '.',
                    )
                  : null,
              ].join('\n'),
        ...
        if (process.env.NODE_ENV !== 'production') {
          if (
            ...
            console.error(
              [
                'MUI: The `value` provided to the Tabs component is invalid.',
                'The Tab with this `value` ("'.concat(
                  value,
                  '") is not part of the document layout.',
                ),
  ...
  var updateIndicatorState = useEventCallback(function () {
    ...
    var newIndicatorStyle = _defineProperty(
      _defineProperty({}, startIndicator, startValue),
      size,
      tabMeta ? tabMeta[size] : 0,
    );
        ...
        children: [
          ...
          /*#__PURE__*/ _jsxs(TabsScroller, {
            ...
            style: _defineProperty(
              ...
              vertical ? 'margin'.concat(isRtl ? 'Left' : 'Right') : 'marginBottom',
