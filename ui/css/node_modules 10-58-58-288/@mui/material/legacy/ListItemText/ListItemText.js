...
var ListItemTextRoot = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      _defineProperty({}, '& .'.concat(listItemTextClasses.primary), styles.primary),
      _defineProperty({}, '& .'.concat(listItemTextClasses.secondary), styles.secondary),
      styles.root,
      ...
      _extends(
        {
          ...
          component:
            primaryTypographyProps != null && primaryTypographyProps.variant ? undefined : 'span',
          display: 'block',
        },
        primaryTypographyProps,
        {
