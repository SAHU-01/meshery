...
var ToggleButtonGroupRoot = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      _defineProperty({}, '& .'.concat(toggleButtonGroupClasses.grouped), styles.grouped),
      _defineProperty(
        {},
        '& .'.concat(toggleButtonGroupClasses.grouped),
        styles['grouped'.concat(capitalize(ownerState.orientation))],
      ),
      _defineProperty({}, '& .'.concat(toggleButtonGroupClasses.firstButton), styles.firstButton),
      _defineProperty({}, '& .'.concat(toggleButtonGroupClasses.lastButton), styles.lastButton),
      _defineProperty({}, '& .'.concat(toggleButtonGroupClasses.middleButton), styles.middleButton),
      styles.root,
      ...
      _extends(
        ...
        ownerState.orientation === 'horizontal'
          ? _defineProperty(
              {},
              '&.'
                .concat(toggleButtonGroupClasses.selected, ' + .')
                .concat(toggleButtonGroupClasses.grouped, '.')
                .concat(toggleButtonGroupClasses.selected),
              {
                borderLeft: 0,
    ...
    ownerState.orientation === 'horizontal'
      ? _defineProperty(
          _defineProperty(
            {},
            '& .'
              .concat(toggleButtonGroupClasses.firstButton, ',& .')
              .concat(toggleButtonGroupClasses.middleButton),
            {
          ...
          '& .'
            .concat(toggleButtonGroupClasses.lastButton, ',& .')
            .concat(toggleButtonGroupClasses.middleButton),
          {
            marginLeft: -1,
...
var ToggleButtonGroup = /*#__PURE__*/ React.forwardRef(function ToggleButtonGroup(inProps, ref) {
  ...
  var handleExclusiveChange = React.useCallback(
    function (event, buttonValue) {
      if (!onChange) {
        return;
      }
