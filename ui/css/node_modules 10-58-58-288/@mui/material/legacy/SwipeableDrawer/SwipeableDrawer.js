...
var SwipeableDrawer = /*#__PURE__*/ React.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  var _props$anchor = props.anchor,
    ...
    transitionDuration =
      _props$transitionDura === void 0 ? transitionDurationDefault : _props$transitionDura,
  ...
  var setPosition = React.useCallback(
    function (translate) {
      ...
      var transform = horizontalSwipe
        ? 'translate('.concat(rtlTranslateMultiplier * translate, 'px, 0)')
        : 'translate(0, '.concat(rtlTranslateMultiplier * translate, 'px)');
  ...
  var handleBodyTouchMove = useEventCallback(function (nativeEvent) {
    ...
    var anchorRtl = getAnchor(theme, anchor);
    var horizontalSwipe = isHorizontal(anchor);
    var currentX = calculateCurrentX(
      anchorRtl,
      nativeEvent.touches,
      ownerDocument(nativeEvent.currentTarget),
    );
    var currentY = calculateCurrentY(
      anchorRtl,
      nativeEvent.touches,
      ownerWindow(nativeEvent.currentTarget),
    );
    ...
    if (swipeInstance.current.isSwiping == null) {
      ...
      var definitelySwiping = horizontalSwipe
    ...
    var startLocation = horizontalSwipe
    ...
    if (!open) {
      ...
      if (
        ...
        !(
          ...
          ((_paperRef$current = paperRef.current) != null &&
            _paperRef$current.contains(nativeEvent.target) &&
