...
var FilledInputRoot = styled(InputBaseRoot, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [].concat(_toConsumableArray(inputBaseRootOverridesResolver(props, styles)), [
    ...
    !ownerState.disableUnderline &&
      _defineProperty(
        _defineProperty(
          _defineProperty(
              ...
              _defineProperty(
                {
                  '&::after': {
                    borderBottom: '2px solid '.concat(
                      (_palette = (theme.vars || theme).palette[ownerState.color || 'primary']) ==
                        null
                        ? void 0
                        : _palette.main,
                    ),
            ...
            '&::before',
            {
              borderBottom: '1px solid '.concat(
                theme.vars
                  ? 'rgba('
                      .concat(theme.vars.palette.common.onBackgroundChannel, ' / ')
                      .concat(theme.vars.opacity.inputUnderline, ')')
                  : bottomLineColor,
              ),
              left: 0,
              bottom: 0,
          ...
          '&:hover:not(.'
            .concat(filledInputClasses.disabled, ', .')
            .concat(filledInputClasses.error, '):before'),
          {
...
var FilledInput = /*#__PURE__*/ React.forwardRef(function FilledInput(inProps, ref) {
  ...
  var componentsProps = (slotProps != null ? slotProps : componentsPropsProp)
    ? deepmerge(filledInputComponentsProps, slotProps != null ? slotProps : componentsPropsProp)
    : filledInputComponentsProps;
  var RootSlot =
    (_ref5 = (_slots$root = slots.root) != null ? _slots$root : components.Root) != null
      ? _ref5
      : FilledInputRoot;
  var InputSlot =
    (_ref6 = (_slots$input = slots.input) != null ? _slots$input : components.Input) != null
      ? _ref6
      : FilledInputInput;
