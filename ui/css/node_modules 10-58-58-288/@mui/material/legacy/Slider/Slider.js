...
export var SliderRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      ownerState.size !== 'medium' && styles['size'.concat(capitalize(ownerState.size))],
  ...
  return _defineProperty(
    _defineProperty(
      ...
      _defineProperty({}, '& .'.concat(sliderClasses.thumb, ', & .').concat(sliderClasses.track), {
        transition: 'none',
      }),
    ),
    'variants',
...
export var SliderThumb = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      styles.thumb,
      styles['thumbColor'.concat(capitalize(ownerState.color))],
      ownerState.size !== 'medium' && styles['thumbSize'.concat(capitalize(ownerState.size))],
    ];
  },
})(function (_ref4) {
  var _theme$vars5;
...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      color && 'color'.concat(capitalize(color)),
      size && 'size'.concat(capitalize(size)),
    ],
    rail: ['rail'],
    track: ['track'],
    mark: ['mark'],
    ...
    thumb: [
      'thumb',
      disabled && 'disabled',
      size && 'thumbSize'.concat(capitalize(size)),
      color && 'thumbColor'.concat(capitalize(color)),
    ],
    active: ['active'],
    disabled: ['disabled'],
...
var Slider = /*#__PURE__*/ React.forwardRef(function Slider(inputProps, ref) {
  ...
  return /*#__PURE__*/ _jsxs(
    ...
    _extends({}, rootProps, {
      children: [
        /*#__PURE__*/ _jsx(RailSlot, _extends({}, railProps)),
        /*#__PURE__*/ _jsx(TrackSlot, _extends({}, trackProps)),
        marks
