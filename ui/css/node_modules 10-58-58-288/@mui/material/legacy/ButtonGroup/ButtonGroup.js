...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return [
    _defineProperty({}, '& .'.concat(buttonGroupClasses.grouped), styles.grouped),
    _defineProperty(
      {},
      '& .'.concat(buttonGroupClasses.grouped),
      styles['grouped'.concat(capitalize(ownerState.orientation))],
    ),
    _defineProperty(
      {},
      '& .'.concat(buttonGroupClasses.grouped),
      styles['grouped'.concat(capitalize(ownerState.variant))],
    ),
    _defineProperty(
      {},
      '& .'.concat(buttonGroupClasses.grouped),
      styles[
        'grouped'.concat(capitalize(ownerState.variant)).concat(capitalize(ownerState.orientation))
      ],
    ),
    _defineProperty(
      {},
      '& .'.concat(buttonGroupClasses.grouped),
      styles['grouped'.concat(capitalize(ownerState.variant)).concat(capitalize(ownerState.color))],
    ),
    _defineProperty({}, '& .'.concat(buttonGroupClasses.firstButton), styles.firstButton),
    _defineProperty({}, '& .'.concat(buttonGroupClasses.lastButton), styles.lastButton),
    _defineProperty({}, '& .'.concat(buttonGroupClasses.middleButton), styles.middleButton),
    styles.root,
...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    grouped: [
      'grouped',
      'grouped'.concat(capitalize(orientation)),
      'grouped'.concat(capitalize(variant)),
      'grouped'.concat(capitalize(variant)).concat(capitalize(orientation)),
      'grouped'.concat(capitalize(variant)).concat(capitalize(color)),
      disabled && 'disabled',
    ],
  ...
  return _extends(
    ...
    _defineProperty(
      _defineProperty(
        ...
        '& .'
          .concat(buttonGroupClasses.firstButton, ',& .')
          .concat(buttonGroupClasses.middleButton),
        _extends(
          {},
          ...
          ownerState.variant === 'text' &&
            ownerState.color !== 'inherit' && {
              borderColor: theme.vars
                ? 'rgba('.concat(theme.vars.palette[ownerState.color].mainChannel, ' / 0.5)')
