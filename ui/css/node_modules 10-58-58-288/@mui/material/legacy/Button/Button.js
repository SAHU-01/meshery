...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    root: [
      ...
      ''.concat(variant, 'Size').concat(capitalize(size)),
...
var ButtonRoot = styled(ButtonBase, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles[''.concat(ownerState.variant).concat(capitalize(ownerState.color))],
      styles['size'.concat(capitalize(ownerState.size))],
      styles[''.concat(ownerState.variant, 'Size').concat(capitalize(ownerState.size))],
  ...
  function (_ref) {
    ...
    var inheritContainedBackgroundColor =
      theme.palette.mode === 'light' ? theme.palette.grey[300] : theme.palette.grey[800];
    var inheritContainedHoverBackgroundColor =
    ...
    return _extends(
            ...
            '&:hover': _extends(
              {
                ...
                backgroundColor: theme.vars
                  ? 'rgba('
                      .concat(theme.vars.palette.text.primaryChannel, ' / ')
      ...
      ownerState.variant === 'outlined' &&
        ownerState.color !== 'inherit' && {
          color: (theme.vars || theme).palette[ownerState.color].main,
          border: theme.vars
            ? '1px solid rgba('.concat(theme.vars.palette[ownerState.color].mainChannel, ' / 0.5)')
            : '1px solid '.concat(alpha(theme.palette[ownerState.color].main, 0.5)),
        },
      ownerState.variant === 'contained' && {
        color: theme.vars
