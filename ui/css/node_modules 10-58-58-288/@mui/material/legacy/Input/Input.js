    ...
    !ownerState.disableUnderline &&
      _defineProperty(
        _defineProperty(
          ...
          '&:hover:not(.'
            .concat(inputClasses.disabled, ', .')
            .concat(inputClasses.error, '):before'),
          {
...
var Input = /*#__PURE__*/ React.forwardRef(function Input(inProps, ref) {
  ...
  var componentsProps = (slotProps != null ? slotProps : componentsPropsProp)
    ? deepmerge(slotProps != null ? slotProps : componentsPropsProp, inputComponentsProps)
    : inputComponentsProps;
  var RootSlot =
    (_ref3 = (_slots$root = slots.root) != null ? _slots$root : components.Root) != null
      ? _ref3
      : InputRoot;
  var InputSlot =
    (_ref4 = (_slots$input = slots.input) != null ? _slots$input : components.Input) != null
      ? _ref4
      : InputInput;
