...
const useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    ...
    loadingIndicator: [
      'loadingIndicator',
      loading && `loadingIndicator${(0, _utils2.capitalize)(loadingPosition)}`,
    ],
  };
  const composedClasses = (0, _base.unstable_composeClasses)(
    slots,
    _loadingButtonClasses.getLoadingButtonUtilityClass,
    classes,
  );
...
const LoadingButtonLoadingIndicator = (0, _styles.styled)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[`loadingIndicator${(0, _utils2.capitalize)(ownerState.loadingPosition)}`],
    ];
  },
})(({ theme, ownerState }) =>
  (0, _extends2.default)(
...
const LoadingButton = /*#__PURE__*/ React.forwardRef(function LoadingButton(inProps, ref) {
  ...
  const loadingButtonLoadingIndicator = loading
    ? /*#__PURE__*/ (0, _jsxRuntime.jsx)(LoadingButtonLoadingIndicator, {
...
process.env.NODE_ENV !== 'production'
  ? (LoadingButton.propTypes /* remove-proptypes */ = {
       ...
       * @default 'center'
       */
      loadingPosition: (0, _utils.chainPropTypes)(
        _propTypes.default.oneOf(['start', 'end', 'center']),
        (props) => {
