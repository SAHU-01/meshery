...
var _generateUtilityClasses = _interopRequireDefault(
  require('@mui/material/generateUtilityClasses'),
);
function getTimelineConnectorUtilityClass(slot) {
  return (0, _generateUtilityClass.default)('MuiTimelineConnector', slot);
}
const timelineConnectorClasses = (0, _generateUtilityClasses.default)('MuiTimelineConnector', [
  'root',
]);
