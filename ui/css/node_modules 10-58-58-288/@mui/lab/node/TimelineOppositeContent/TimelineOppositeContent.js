...
var _convertTimelinePositionToClass = _interopRequireDefault(
  require('../internal/convertTimelinePositionToClass'),
);
...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _base.unstable_composeClasses)(
    slots,
    _timelineOppositeContentClasses.getTimelineOppositeContentUtilityClass,
    classes,
  );
};
...
const TimelineOppositeContent = /*#__PURE__*/ React.forwardRef(
  function TimelineOppositeContent(inProps, ref) {
    ...
    const { position: positionContext } = React.useContext(_TimelineContext.default);
