...
const useUtilityClasses = (ownerState) => {
  ...
  return (0, _base.unstable_composeClasses)(
    slots,
    _treeItemClasses.getTreeItemUtilityClass,
    classes,
  );
};
...
const TreeItem = /*#__PURE__*/ React.forwardRef(function TreeItem(inProps, ref) {
  ...
  const { index, parentId } = (0, _descendants.useDescendant)(descendant);
    ...
    (0, _extends2.default)(
      ...
      other,
      {
        ...
        children: [
          ...
          children &&
            /*#__PURE__*/ (0, _jsxRuntime.jsx)(_descendants.DescendantProvider, {
              id: nodeId,
