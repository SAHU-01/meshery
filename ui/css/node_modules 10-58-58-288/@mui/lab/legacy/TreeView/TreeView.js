...
var TreeView = /*#__PURE__*/ React.forwardRef(function TreeView(inProps, ref) {
  ...
  var children = props.children,
    ...
    defaultExpanded =
      _props$defaultExpande === void 0 ? defaultDefaultExpanded : _props$defaultExpande,
    defaultExpandIcon = props.defaultExpandIcon,
    defaultParentIcon = props.defaultParentIcon,
    _props$defaultSelecte = props.defaultSelected,
    defaultSelected =
      _props$defaultSelecte === void 0 ? defaultDefaultSelected : _props$defaultSelecte,
  ...
  var getChildrenIds = function getChildrenIds(id) {
    return Object.keys(nodeMap.current)
      .map(function (key) {
  ...
  var activeDescendant = nodeMap.current[focusedNodeId]
