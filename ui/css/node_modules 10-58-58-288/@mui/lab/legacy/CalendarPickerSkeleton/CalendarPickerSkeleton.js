 ...
 */
var CalendarPickerSkeleton = /*#__PURE__*/ React.forwardRef(
  function DeprecatedCalendarPickerSkeleton() {
    warn();
    return null;
  },
);
...
export var getCalendarPickerSkeletonUtilityClass = function getCalendarPickerSkeletonUtilityClass(
  slot,
) {
  warn();
  return '';
