...
export var getStyle = function getStyle(_ref) {
  ...
  if (ownerState.isSSR) {
    ...
    for (var i = 1; i <= ownerState.defaultColumns; i += 1) {
      orderStyleSSR[
        '&:nth-of-type('
          .concat(ownerState.defaultColumns, 'n+')
          .concat(i % ownerState.defaultColumns, ')')
      ] = {
        order: i,
      };
    }
    ...
    stylesSSR['& > *'] = _extends({}, styles['& > *'], orderStyleSSR, {
      ...
      width: 'calc('
        .concat((100 / ownerState.defaultColumns).toFixed(2), '% - ')
        .concat(defaultSpacing, 'px)'),
    });
      ...
      ownerState.maxColumnHeight && {
        height:
          typeof spacing === 'number'
            ...
            : 'calc('.concat(ownerState.maxColumnHeight, 'px + ').concat(spacing, ')'),
      },
    );
  };
  styles = deepmerge(
...
var Masonry = /*#__PURE__*/ React.forwardRef(function Masonry(inProps, ref) {
  ...
  var handleResize = function handleResize(masonryChildren) {
    ...
    var currentNumberOfColumns = Math.round(
    ...
    masonry.childNodes.forEach(function (child) {
      ...
      var childHeight = parseToNumber(childComputedStyle.height)
      ...
      if (!skip) {
        ...
        var currentMinColumnIndex = columnHeights.indexOf(
          Math.min.apply(Math, _toConsumableArray(columnHeights)),
        );
