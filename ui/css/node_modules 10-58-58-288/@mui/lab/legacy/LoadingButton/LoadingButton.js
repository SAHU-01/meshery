...
var useUtilityClasses = function useUtilityClasses(ownerState) {
  ...
  var slots = {
    ...
    loadingIndicator: [
      'loadingIndicator',
      loading && 'loadingIndicator'.concat(capitalize(loadingPosition)),
    ],
  };
  ...
  overridesResolver: function overridesResolver(props, styles) {
    return [
      ...
      styles.startIconLoadingStart &&
        _defineProperty(
          {},
          '& .'.concat(loadingButtonClasses.startIconLoadingStart),
          styles.startIconLoadingStart,
        ),
      styles.endIconLoadingEnd &&
        _defineProperty(
          {},
          '& .'.concat(loadingButtonClasses.endIconLoadingEnd),
          styles.endIconLoadingEnd,
        ),
    ];
  },
...
var LoadingButtonLoadingIndicator = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return [
      ...
      styles['loadingIndicator'.concat(capitalize(ownerState.loadingPosition))],
    ];
  },
})(function (_ref7) {
...
var LoadingButton = /*#__PURE__*/ React.forwardRef(function LoadingButton(inProps, ref) {
  ...
  var loadingButtonLoadingIndicator = loading
    ? /*#__PURE__*/ _jsx(LoadingButtonLoadingIndicator, {
