...
export declare function createUseInstanceEventHandler(registryContainer: RegistryContainer): <
  Instance extends UseTreeViewInstanceEventsInstance & {
    $$signature: TreeViewAnyPluginSignature;
  },
  E extends
    | keyof Instance['$$signature']['events']
    | keyof import('../models').MergePluginsProperty<
        [
          import('../corePlugins').TreeViewCorePluginsSignature,
          ...Instance['$$signature']['dependantPlugins'],
        ],
        'events'
      >,
>(
...
export declare const useInstanceEventHandler: <
  Instance extends UseTreeViewInstanceEventsInstance & {
    $$signature: TreeViewAnyPluginSignature;
  },
  E extends
