...
export declare const DEFAULT_TREE_VIEW_PLUGINS: readonly [
  import('../models').TreeViewPlugin<import('./useTreeViewNodes').UseTreeViewNodesSignature>,
  import('../models').TreeViewPlugin<
    import('./useTreeViewExpansion').UseTreeViewExpansionSignature
  >,
  import('../models').TreeViewPlugin<
    import('./useTreeViewSelection').UseTreeViewSelectionSignature<any>
  >,
  import('../models').TreeViewPlugin<import('./useTreeViewFocus').UseTreeViewFocusSignature>,
  import('../models').TreeViewPlugin<
    import('./useTreeViewKeyboardNavigation').UseTreeViewKeyboardNavigationSignature
  >,
  import('../models').TreeViewPlugin<
    import('./useTreeViewContextValueBuilder').UseTreeViewContextValueBuilderSignature
  >,
];
