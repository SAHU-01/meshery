...
export const useTreeViewFocus = ({ instance, params, state, setState, models, rootRef }) => {
...
useTreeViewFocus.getDefaultizedParams = (params) => {
  ...
  return _extends({}, params, {
    disabledItemsFocusable:
      (_params$disabledItems = params.disabledItemsFocusable) != null
        ? _params$disabledItems
        : false,
  });
};
