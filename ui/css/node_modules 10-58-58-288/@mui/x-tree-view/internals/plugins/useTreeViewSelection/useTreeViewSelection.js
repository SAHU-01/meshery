...
export const useTreeViewSelection = ({ instance, params, models }) => {
...
useTreeViewSelection.getDefaultizedParams = (params) => {
  ...
  return _extends({}, params, {
    disableSelection:
      (_params$disableSelect = params.disableSelection) != null ? _params$disableSelect : false,
    multiSelect: (_params$multiSelect = params.multiSelect) != null ? _params$multiSelect : false,
    defaultSelected:
      (_params$defaultSelect = params.defaultSelected) != null
