...
const useTreeViewFocus = ({ instance, params, state, setState, models, rootRef }) => {
  ...
  (0, _useInstanceEventHandler.useInstanceEventHandler)(instance, 'removeNode', ({ id }) => {
    setFocusedNodeId((oldFocusedNodeId) => {
      if (
        oldFocusedNodeId === id &&
        rootRef.current === (0, _ownerDocument.default)(rootRef.current).activeElement
      ) {
