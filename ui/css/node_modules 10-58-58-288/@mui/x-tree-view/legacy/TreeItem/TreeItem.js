  ...
  overridesResolver: function overridesResolver(props, styles) {
    return [
      ...
      styles.iconContainer &&
        _defineProperty({}, '& .'.concat(treeItemClasses.iconContainer), styles.iconContainer),
      styles.label && _defineProperty({}, '& .'.concat(treeItemClasses.label), styles.label),
    ];
  },
})(function (_ref3) {
  var _ref4;
    ...
    function () {
      if (instance && label) {
        ...
        return instance.mapFirstChar(
          nodeId,
          ((_contentRef$current$t =
            (_contentRef$current = contentRef.current) == null
              ? void 0
              : _contentRef$current.textContent) != null
            ? _contentRef$current$t
            : ''
          )
            .substring(0, 1)
