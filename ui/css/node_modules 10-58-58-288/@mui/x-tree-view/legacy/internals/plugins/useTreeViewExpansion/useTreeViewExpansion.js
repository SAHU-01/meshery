...
export var useTreeViewExpansion = function useTreeViewExpansion(_ref) {
  var instance = _ref.instance,
    params = _ref.params,
    models = _ref.models;
  var isNodeExpanded = React.useCallback(
    function (nodeId) {
  ...
  var isNodeExpandable = React.useCallback(
    function (nodeId) {
      var _instance$getNode;
      return !!(
        (_instance$getNode = instance.getNode(nodeId)) != null && _instance$getNode.expandable
      );
    },
    [instance],
  );
...
useTreeViewExpansion.getDefaultizedParams = function (params) {
  ...
  return _extends({}, params, {
    defaultExpanded:
      (_params$defaultExpand = params.defaultExpanded) != null
        ? _params$defaultExpand
        : DEFAULT_EXPANDED,
  });
};
