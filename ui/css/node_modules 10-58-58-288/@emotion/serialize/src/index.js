// @flow
import type { Interpolation, SerializedStyles, RegisteredCache } from '@emotion/utils';
...
let processStyleValue = (key: string, value: string | number): string | number => {
  switch (key) {
    case 'animation':
    case 'animationName': {
...
function handleInterpolation(
  ...
  switch (typeof interpolation) {
    ...
    case 'string':
      if (process.env.NODE_ENV !== 'production') {
        const matched = [];
        const replaced = interpolation.replace(animationRegex, (match, p1, p2) => {
