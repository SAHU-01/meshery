  ...
  return useMemo(() => {
    ...
    function timerExpired() {
      ...
      const timeSinceLastCall =
        time - ((_lastCallTimeRef$curr = lastCallTimeRef.current) != null ? _lastCallTimeRef$curr : 0)
    ...
    function shouldInvoke(time) {
      ...
      const timeSinceLastCall =
        time - ((_lastCallTimeRef$curr2 = lastCallTimeRef.current) != null ? _lastCallTimeRef$curr2 : 0)
      const timeSinceLastInvoke = time - lastInvokeTimeRef.current
