...
import { getDefaultMiddleware, MiddlewareArray, configureStore } from '@reduxjs/toolkit';
...
describe('getDefaultMiddleware', () => {
  ...
  it('allows passing options to thunk', () => {
    ...
    const testThunk: ThunkAction<void, {}, number, AnyAction> = (dispatch, getState, extraArg) => {
    ...
    expectType<ThunkDispatch<any, 42, AnyAction> & Dispatch<AnyAction>>(store.dispatch);
