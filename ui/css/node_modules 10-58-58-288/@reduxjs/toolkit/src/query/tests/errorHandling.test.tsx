...
describe('query error handling', () => {
  test('success', async () => {
    server.use(
      rest.get('https://example.com/query', (_, res, ctx) => res(ctx.json({ value: 'success' }))),
    );
...
describe('error handling in a component', () => {
  ...
  test('a mutation is unwrappable and has the correct types', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId('data').textContent).toEqual(JSON.stringify(mockSuccessResponse)),
    );
  });
