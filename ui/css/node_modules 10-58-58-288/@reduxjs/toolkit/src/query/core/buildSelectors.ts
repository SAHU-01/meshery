  ...
  function buildQuerySelector(
    ...
    return ((queryArgs: any) => {
      ...
      const selectQuerySubstate = (state: RootState) =>
        selectInternalState(state)?.queries?.[serializedArgs] ?? defaultQuerySubState;
  ...
  function buildMutationSelector() {
    return ((id) => {
      ...
      const selectMutationSubstate = (state: RootState) =>
        selectInternalState(state)?.mutations?.[mutationId as string] ?? defaultMutationSubState;
      const finalSelectMutationSubstate =
        mutationId === skipToken ? selectSkippedMutation : selectMutationSubstate;
