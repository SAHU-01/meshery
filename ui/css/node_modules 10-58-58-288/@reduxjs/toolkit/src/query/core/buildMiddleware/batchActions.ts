...
import type { SubscriptionState, QuerySubstateIdentifier, Subscribers } from '../apiState';
  ...
  return (action, mwApi) => {
    ...
    if (didMutate) {
      ...
      const isAdditionalSubscriptionAction =
        queryThunk.rejected.match(action) && action.meta.condition && !!action.meta.arg.subscribe;
