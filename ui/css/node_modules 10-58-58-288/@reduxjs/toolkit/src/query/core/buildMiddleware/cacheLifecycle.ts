...
declare module '../../endpointDefinitions' {
  ...
  > extends LifecycleApi<ReducerPath> {
    ...
    getCacheEntry(): QueryResultSelectorResult<
      { type: DefinitionType.query } & BaseEndpointDefinition<QueryArg, BaseQuery, ResultType>
    >;
    /**
  ...
  > extends LifecycleApi<ReducerPath> {
    ...
    getCacheEntry(): MutationResultSelectorResult<
      { type: DefinitionType.mutation } & BaseEndpointDefinition<QueryArg, BaseQuery, ResultType>
    >;
  }
...
export const buildCacheLifecycleHandler: InternalHandlerBuilder = ({
  ...
  function handleNewKey(
    ...
    const selector = (api.endpoints[endpointName] as any).select(
      endpointDefinition.type === DefinitionType.query ? originalArgs : queryCacheKey,
    );
    ...
    const lifecycleApi = {
      ...
      updateCachedData: (endpointDefinition.type === DefinitionType.query
        ? (updateRecipe: Recipe<any>) =>
            mwApi.dispatch(
              api.util.updateQueryData(endpointName as never, originalArgs, updateRecipe),
            )
        : undefined) as any,
