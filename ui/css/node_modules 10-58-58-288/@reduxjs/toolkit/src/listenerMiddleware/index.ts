...
const createTakePattern = <S>(
  startListening: AddListenerOverloads<UnsubscribeListener, S, Dispatch<AnyAction>>,
  signal: AbortSignal,
): TakePattern<S> => {
  /**
  ...
  const take = async <P extends AnyListenerPredicate<S>>(
    ...
    const promises: (Promise<null> | Promise<[AnyAction, S, S]>)[] = [tuplePromise];
...
const cancelActiveListeners = (entry: ListenerEntry<unknown, Dispatch<AnyAction>>) => {
