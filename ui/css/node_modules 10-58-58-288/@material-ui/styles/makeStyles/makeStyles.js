...
function makeStyles(stylesOrCreator) {
  ...
  var name = options.name,
    ...
    stylesOptions2 = (0, _objectWithoutProperties2.default)(options, [
      'name',
      'classNamePrefix',
      'Component',
      'defaultTheme',
  ...
  var useStyles = function useStyles() {
    ...
    var stylesOptions = (0, _extends2.default)(
      {},
      _react.default.useContext(_StylesProvider.StylesContext),
      stylesOptions2,
    );
