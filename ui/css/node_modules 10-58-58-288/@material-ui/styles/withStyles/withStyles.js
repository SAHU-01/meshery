...
var withStyles = function withStyles(stylesOrCreator) {
  ...
  return function (Component) {
    var defaultTheme = options.defaultTheme,
      ...
      name = options.name,
      stylesOptions = (0, _objectWithoutProperties2.default)(options, [
        'defaultTheme',
        'withTheme',
        'name',
      ]);
    ...
    process.env.NODE_ENV !== 'production'
      ? (WithStyles.propTypes = {
           ...
           * @deprecated
           */
          innerRef: (0, _utils.chainPropTypes)(
            _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.object]),
            function (props) {
