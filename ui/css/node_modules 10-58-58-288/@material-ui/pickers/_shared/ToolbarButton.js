...
var ToolbarButton = function (_a) {
  ...
  return React.createElement(
    Button_1.default,
    __assign({ variant: 'text', className: clsx_1.default(classes.toolbarBtn, className) }, other),
...
exports.default = styles_1.withStyles(exports.styles, { name: 'MuiPickersToolbarButton' })(
  ToolbarButton,
);
