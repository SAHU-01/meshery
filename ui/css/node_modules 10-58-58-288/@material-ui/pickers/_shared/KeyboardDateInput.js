  ...
  return React.createElement(
    ...
    function (_a) {
      ...
      return React.createElement(
        TextFieldComponent,
        __assign(
          { disabled: disabled, error: Boolean(validationError), helperText: validationError },
          other,
          {
            value: value,
            onChange: onChange,
            ...
            InputProps: __assign(
              __assign({}, InputProps),
              ((_b = {}),
              (_b[position + 'Adornment'] = React.createElement(
                InputAdornment_1.default,
                __assign({ position: position }, InputAdornmentProps),
                React.createElement(
                  IconButton_1.default,
                  __assign({ disabled: disabled }, KeyboardButtonProps, { onClick: onOpen }),
                  keyboardIcon,
                ),
              )),
              _b),
