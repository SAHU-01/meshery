...
function usePickerState(props, options) {
  ...
  var utils = useUtils_1.useUtils();
  var _a = useOpenState_1.useOpenState(props),
    isOpen = _a.isOpen,
    setIsOpen = _a.setIsOpen;
  var _b = useDateValues(props, options),
    date = _b.date,
    format = _b.format;
  var _c = react_1.useState(date),
    pickerDate = _c[0],
    setPickerDate = _c[1];
  react_1.useEffect(
    function () {
  ...
  var acceptDate = react_1.useCallback(
  ...
  var wrapperProps = react_1.useMemo(
    function () {
      return {
        format: format,
        open: isOpen,
  ...
  var pickerProps = react_1.useMemo(
    function () {
      return {
        date: pickerDate,
  ...
  var inputProps = react_1.useMemo(
    function () {
      return {
