...
function useKeyboardPickerState(props, options) {
  ...
  var handleKeyboardChange = react_1.useCallback(
    function (date) {
      onChange(date, date === null ? null : utils.format(date, format));
    },
    [format, onChange, utils],
  );
  var _c = usePickerState_1.usePickerState(
      __assign(__assign({}, props), { value: dateValue, onChange: handleKeyboardChange }),
      options,
    ),
