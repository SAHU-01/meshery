  ...
  return React.createElement(
    ...
    __assign(
      {
        ...
        classes: {
          paper: clsx_1.default(
            classes.dialogRoot,
            ((_b = {}), (_b[classes.dialogRootWider] = wider), _b),
          ),
        },
      },
      other,
    ...
    React.createElement(
      DialogActions_1.default,
      {
        classes: {
          root: clsx_1.default(
            ((_c = {}), (_c[classes.withAdditionalAction] = clearable || showTodayButton), _c),
          ),
        },
      },
      clearable &&
        React.createElement(Button_1.default, { color: 'primary', onClick: onClear }, clearLabel),
      showTodayButton &&
        React.createElement(
          Button_1.default,
          { color: 'primary', onClick: onSetToday },
          todayLabel,
        ),
      cancelLabel &&
        React.createElement(
...
exports.default = styles_1.withStyles(exports.styles, { name: 'MuiPickersModal' })(
  exports.ModalDialog,
);
