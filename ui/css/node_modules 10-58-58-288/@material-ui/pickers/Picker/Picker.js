  ...
  return React.createElement(
    'div',
    {
      className: clsx_1.default(
        classes.container,
        ((_b = {}), (_b[classes.containerLandscape] = isLandscape), _b),
      ),
    },
    !disableToolbar &&
      React.createElement(
    ...
    React.createElement(
      'div',
      {
        className: clsx_1.default(
          classes.pickerView,
          ((_c = {}), (_c[classes.pickerViewLandscape] = isLandscape), _c),
        ),
      },
      openView === 'year' &&
        React.createElement(
          YearView_1.YearSelection,
          __assign({}, rest, {
            date: date,
