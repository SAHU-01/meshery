...
declare type OmitInnerWrapperProps<T extends WrapperProps<any>> = Omit<
  T,
...
export declare function getWrapperFromVariant<T>(
  variant?: WrapperVariant,
...
export declare const Wrapper: <T extends KeyboardDateInputProps | PureDateInputProps>(
  p: Props<T>,
