...
function useMeridiemMode(date, ampm, onChange) {
  ...
  var handleMeridiemChange = React.useCallback(
    function (mode) {
...
exports.TimePickerToolbar = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      utils_1.arrayIncludes(views, 'hours') &&
      ...
      utils_1.arrayIncludes(views, ['hours', 'minutes']) &&
      ...
      utils_1.arrayIncludes(views, 'minutes') &&
        React.createElement(ToolbarButton_1.default, {
          variant: clockTypographyVariant,
          onClick: function () {
      ...
      utils_1.arrayIncludes(views, ['minutes', 'seconds']) &&
        React.createElement(ToolbarText_1.default, {
          variant: 'h2',
          label: ':',
          selected: false,
      ...
      utils_1.arrayIncludes(views, 'seconds') &&
        React.createElement(ToolbarButton_1.default, {
          variant: 'h2',
          onClick: function () {
