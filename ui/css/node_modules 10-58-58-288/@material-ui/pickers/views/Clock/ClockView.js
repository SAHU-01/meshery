...
exports.ClockView = function (_a) {
        ...
        case ClockType_1.default.HOURS:
          return {
            ...
            onChange: function (value, isFinish) {
              ...
              var updatedTimeWithMeridiem = time_utils_1.convertToMeridiem(
  ...
  return React.createElement(
    Clock_1.default,
    __assign({ type: type, ampm: ampm, minutesStep: minutesStep }, viewProps),
  );
};
...
exports.ClockView.propTypes = {
  ...
  type: PropTypes.oneOf(
    Object.keys(ClockType_1.default).map(function (key) {
