...
export declare const styles: (
  ...
  | import('@material-ui/core/styles/withStyles').CreateCSSProperties<{}>
  | ((props: {}) => import('@material-ui/core/styles/withStyles').CreateCSSProperties<{}>)
>;
declare const _default: React.ComponentType<
  | (Pick<ClockProps, 'children' | 'value' | 'onChange' | 'type' | 'ampm' | 'minutesStep'> &
      import('@material-ui/core/styles').StyledComponentProps<
        'container' | 'clock' | 'squareMask' | 'pin'
      >)
  | (Pick<
      React.PropsWithChildren<ClockProps>,
      'children' | 'value' | 'onChange' | 'type' | 'ampm' | 'minutesStep'
    > &
      import('@material-ui/core/styles').StyledComponentProps<
        'container' | 'clock' | 'squareMask' | 'pin'
      >)
