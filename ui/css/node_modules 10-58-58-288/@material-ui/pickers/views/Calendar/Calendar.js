    ...
    _this.renderWeeks = function () {
      ...
      return weeks.map(function (week) {
        return React.createElement(
          'div',
          { key: 'week-' + week[0].toString(), className: classes.week },
  ...
  Calendar.prototype.render = function () {
    ...
    return React.createElement(
      ...
      allowKeyboardControl &&
        this.context !== 'static' &&
        React.createElement(KeyDownListener, { onKeyDown: this.handleKeyDown }),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          (this.state.loadingQueue > 0 &&
            React.createElement('div', { className: classes.progressContainer }, loadingElement)) ||
