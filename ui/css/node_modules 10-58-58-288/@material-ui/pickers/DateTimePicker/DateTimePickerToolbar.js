...
exports.DateTimePickerToolbar = function (_a) {
  ...
  return React.createElement(
    ...
    null,
    React.createElement(
      PickerToolbar_1.default,
      { isLandscape: false, className: classes.toolbar },
      React.createElement(
        Grid_1.default,
        { container: true, justify: 'center', wrap: 'nowrap' },
        React.createElement(
          Grid_1.default,
          { item: true, container: true, xs: 5, justify: 'flex-start', direction: 'column' },
          React.createElement(
            'div',
            null,
        ...
        ampm &&
          React.createElement(
            Grid_1.default,
            { item: true, container: true, xs: 1, direction: 'column', justify: 'flex-end' },
            React.createElement(ToolbarButton_1.default, {
              variant: 'subtitle1',
    ...
    showTabs &&
      React.createElement(DateTimePickerTabs_1.default, {
