...
import {
  b as ClockType,
  g as getMeridiem,
  c as convertToMeridiem,
  a as Clock,
} from './Clock-48fde975.js';
    ...
    return {
      clockNumber: {
        ...
        left: 'calc((100% - '.concat(
          typeof size === 'number' ? ''.concat(size, 'px') : size,
          ') / 2)',
        ),
        display: 'inline-flex',
        ...
        case ClockType.HOURS:
          return {
            ...
            onChange: function onChange(value, isFinish) {
              ...
              var updatedTimeWithMeridiem = convertToMeridiem(
...
process.env.NODE_ENV !== 'production'
  ? (ClockView.propTypes = {
      ...
      minutesStep: number,
      type: oneOf(
        Object.keys(ClockType).map(function (key) {
