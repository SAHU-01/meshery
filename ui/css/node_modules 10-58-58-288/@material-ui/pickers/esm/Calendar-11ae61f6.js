...
var CalendarHeader = function CalendarHeader(_ref) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        IconButton,
        _extends({}, rightArrowButtonProps, {
  ...
  (function (_React$Component) {
    ...
    function Calendar() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Calendar)).call.apply(
          _getPrototypeOf2,
          [this].concat(args),
        ),
      );
      ...
      _this.shouldDisableDate = function (day) {
        ...
        return (
          _this.validateMinMaxDate(day) || Boolean(shouldDisableDate && shouldDisableDate(day))
        );
      };
      ...
      _this.renderDays = function (week) {
        ...
        return week.map(function (day) {
          ...
          var dayComponent = createElement(
            Day,
            {
              disabled: disabled,
      ...
      [
        ...
        },
        {
          ...
          value: function render() {
            ...
            var loadingElement = loadingIndicator
              ? loadingIndicator
...
export {
  Calendar as C,
  Calendar$1 as a,
  isYearAndMonthViews as b,
  getFormatByViews as g,
  isYearOnlyView as i,
  styles as s,
};
