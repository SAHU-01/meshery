  ...
  (function (_React$Component) {
    ...
    function ClockPointer() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(ClockPointer)).call.apply(
          _getPrototypeOf2,
          [this].concat(args),
        ),
      );
        ...
        value: function render() {
          ...
          return createElement(
            'div',
            {
              ...
              className: clsx(
                classes.pointer,
                this.state.toAnimateTransform && classes.animateTransform,
              ),
            },
            createElement('div', {
...
var Clock =
  ...
  (function (_React$Component) {
    ...
    function Clock() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(Clock)).call.apply(
          _getPrototypeOf2,
          [this].concat(args),
        ),
      );
    ...
    _createClass(Clock, [
      {
        ...
        value: function setTime(e) {
          ...
          var value =
            this.props.type === ClockType$1.SECONDS || this.props.type === ClockType$1.MINUTES
...
process.env.NODE_ENV !== 'production'
  ? (Clock.propTypes = {
      type: oneOf(
        Object.keys(ClockType$1).map(function (key) {
