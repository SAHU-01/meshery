...
var Collapse = /*#__PURE__*/ React.forwardRef(function Collapse(props, ref) {
  var children = props.children,
    ...
    TransitionComponent =
      _props$TransitionComp === void 0 ? _reactTransitionGroup.Transition : _props$TransitionComp,
  ...
  var collapsedSize =
    typeof (collapsedHeight || collapsedSizeProp) === 'number'
      ? ''.concat(collapsedHeight || collapsedSizeProp, 'px')
...
process.env.NODE_ENV !== 'production'
  ? (Collapse.propTypes = {
       ...
       */
      collapsedHeight: (0, _deprecatedPropType.default)(
       ...
       * The height of the container when collapsed.
       */
      collapsedSize: _propTypes.default.oneOfType([
