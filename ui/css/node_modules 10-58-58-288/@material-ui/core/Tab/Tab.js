...
var styles = function styles(theme) {
  ...
  return {
    ...
    root: (0, _extends3.default)(
      ...
      (0, _defineProperty2.default)(_extends2, 'overflow', 'hidden'),
      (0, _defineProperty2.default)(_extends2, 'whiteSpace', 'normal'),
      (0, _defineProperty2.default)(_extends2, 'textAlign', 'center'),
      (0, _defineProperty2.default)(_extends2, theme.breakpoints.up('sm'), {
        minWidth: 160,
      }),
      _extends2),
    ...
    (0, _extends3.default)(
      {
        ...
        className: (0, _clsx.default)(
          classes.root,
          classes['textColor'.concat((0, _capitalize.default)(textColor))],
          className,
