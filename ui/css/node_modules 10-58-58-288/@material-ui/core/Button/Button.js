    ...
    /*#__PURE__*/ React.createElement(
      'span',
      {
        className: (0, _clsx.default)(
          classes.startIcon,
          classes['iconSize'.concat((0, _capitalize.default)(size))],
        ),
      },
      startIconProp,
    );
    ...
    (0, _extends2.default)(
      {
        className: (0, _clsx.default)(
          ...
          color === 'inherit'
            ...
            : color !== 'default' &&
                classes[''.concat(variant).concat((0, _capitalize.default)(color))],
          size !== 'medium' && [
            classes[''.concat(variant, 'Size').concat((0, _capitalize.default)(size))],
            classes['size'.concat((0, _capitalize.default)(size))],
          ],
