      ...
      borderBottom: '1px solid\n    '.concat(
        theme.palette.type === 'light'
          ? (0, _colorManipulator.lighten)(
              (0, _colorManipulator.alpha)(theme.palette.divider, 1),
              0.88,
            )
    ...
    (0, _extends2.default)(
      {
        ...
        className: (0, _clsx.default)(
          ...
          classes[variant],
          className,
          align !== 'inherit' && classes['align'.concat((0, _capitalize.default)(align))],
          padding !== 'normal' && classes['padding'.concat((0, _capitalize.default)(padding))],
          size !== 'medium' && classes['size'.concat((0, _capitalize.default)(size))],
...
process.env.NODE_ENV !== 'production'
  ? (TableCell.propTypes = {
       ...
       */
      padding: (0, _utils.chainPropTypes)(
        _propTypes.default.oneOf(['normal', 'checkbox', 'none', 'default']),
        function (props) {
