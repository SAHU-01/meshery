...
var Popover = /*#__PURE__*/ React.forwardRef(function Popover(props, ref) {
    ...
    function (contentAnchorOffset) {
      ...
      var anchorElement =
        resolvedAnchorEl && resolvedAnchorEl.nodeType === 1
          ? resolvedAnchorEl
          : (0, _ownerDocument.default)(paperRef.current).body;
  ...
  var getContentAnchorOffset = React.useCallback(
    function (element) {
  ...
  var getTransformOrigin = React.useCallback(
    function (elemRect) {
  ...
  var getPositioningStyle = React.useCallback(
    function (element) {
        ...
        if (elemRect.height > heightThreshold && elemRect.height && heightThreshold) {
          console.error(
            [
              ...
              'Some part of it can not be seen on the screen ('.concat(
  ...
  var container =
    containerProp ||
    (anchorEl ? (0, _ownerDocument.default)(getAnchorEl(anchorEl)).body : undefined);
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      (0, _extends2.default)(
        ...
        TransitionProps,
        {
          onEntering: (0, _createChainedFunction.default)(
            handleEntering,
...
process.env.NODE_ENV !== 'production'
  ? (Popover.propTypes = {
       ...
       */
      anchorEl: (0, _utils.chainPropTypes)(
        _propTypes.default.oneOfType([_utils.HTMLElementType, _propTypes.default.func]),
        function (props) {
          if (props.open && (!props.anchorReference || props.anchorReference === 'anchorEl')) {
            ...
            if (resolvedAnchorEl && resolvedAnchorEl.nodeType === 1) {
              ...
              return new Error(
                [
                  'Material-UI: The `anchorEl` prop provided to the component is invalid.',
                  "It should be an Element instance but it's `".concat(
                    resolvedAnchorEl,
                    '` instead.',
                  ),
                ].join('\n'),
      ...
      anchorOrigin: _propTypes.default.shape({
        horizontal: _propTypes.default.oneOfType([
          _propTypes.default.oneOf(['center', 'left', 'right']),
          _propTypes.default.number,
        ]).isRequired,
        vertical: _propTypes.default.oneOfType([
          _propTypes.default.oneOf(['bottom', 'center', 'top']),
          _propTypes.default.number,
        ]).isRequired,
      }),
      ...
      container: _propTypes.default
        ...
        .oneOfType([
          ...
          _propTypes.default.instanceOf(React.Component),
       ...
       */
      onEnter: (0, _deprecatedPropType.default)(
        _propTypes.default.func,
        'Use the `TransitionProps` prop instead.',
      ),
       ...
       * @deprecated Use the `TransitionProps` prop instead.
       */
      onEntered: (0, _deprecatedPropType.default)(
        _propTypes.default.func,
        'Use the `TransitionProps` prop instead.',
      ),
       ...
       * @deprecated Use the `TransitionProps` prop instead.
       */
      onEntering: (0, _deprecatedPropType.default)(
        _propTypes.default.func,
        'Use the `TransitionProps` prop instead.',
      ),
       ...
       * @deprecated Use the `TransitionProps` prop instead.
       */
      onExit: (0, _deprecatedPropType.default)(
        _propTypes.default.func,
        'Use the `TransitionProps` prop instead.',
      ),
       ...
       * @deprecated Use the `TransitionProps` prop instead.
       */
      onExited: (0, _deprecatedPropType.default)(
        _propTypes.default.func,
        'Use the `TransitionProps` prop instead.',
      ),
       ...
       * @deprecated Use the `TransitionProps` prop instead.
       */
      onExiting: (0, _deprecatedPropType.default)(
        _propTypes.default.func,
        'Use the `TransitionProps` prop instead.',
      ),
