...
var ButtonGroup = /*#__PURE__*/ React.forwardRef(function ButtonGroup(props, ref) {
  ...
  var buttonClassName = clsx(
    classes.grouped,
    classes['grouped'.concat(capitalize(orientation))],
    classes['grouped'.concat(capitalize(variant))],
    classes['grouped'.concat(capitalize(variant)).concat(capitalize(orientation))],
    classes[
      'grouped'.concat(capitalize(variant)).concat(color !== 'default' ? capitalize(color) : '')
    ],
