...
var Grid = /*#__PURE__*/ React.forwardRef(function Grid(props, ref) {
  ...
  var className = (0, _clsx.default)(
    ...
    direction !== 'row' && classes['direction-xs-'.concat(String(direction))],
    wrap !== 'wrap' && classes['wrap-xs-'.concat(String(wrap))],
    alignItems !== 'stretch' && classes['align-items-xs-'.concat(String(alignItems))],
    alignContent !== 'stretch' && classes['align-content-xs-'.concat(String(alignContent))],
    (justify || justifyContent) !== 'flex-start' &&
      classes['justify-content-xs-'.concat(String(justify || justifyContent))],
    xs !== false && classes['grid-xs-'.concat(String(xs))],
    sm !== false && classes['grid-sm-'.concat(String(sm))],
    md !== false && classes['grid-md-'.concat(String(md))],
    lg !== false && classes['grid-lg-'.concat(String(lg))],
    xl !== false && classes['grid-xl-'.concat(String(xl))],
  );
...
process.env.NODE_ENV !== 'production'
  ? (Grid.propTypes = {
       ...
       */
      justify: (0, _deprecatedPropType.default)(
