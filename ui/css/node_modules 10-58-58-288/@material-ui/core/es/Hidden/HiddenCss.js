...
function HiddenCss(props) {
  const { children, classes, className, only } = props,
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    if (unknownProps.length > 0) {
      console.error(
        `Material-UI: Unsupported props received by \`<Hidden implementation="css" />\`: ${unknownProps.join(', ')}. Did you forget to wrap this component in a ThemeProvider declaring these breakpoints?`,
      );
    }
  }
