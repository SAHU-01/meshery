...
class Mode extends React.Component {
  render() {
    ...
    const _this$props = this.props,
      { __element, __strict } = _this$props,
    ...
    return /*#__PURE__*/ React.createElement(
      Component,
      null,
      /*#__PURE__*/ React.cloneElement(__element, other),
    );
  }
}
...
export default function createMount(options = {}) {
  ...
  const mountWithContext = function mountWithContext(node, localOptions = {}) {
    const { disableUnnmount = false, strict = globalStrict } = localOptions,
      localEnzymeOptions = _objectWithoutPropertiesLoose(localOptions, [
        'disableUnnmount',
        'strict',
      ]);
    ...
    return mount(
      strict == null
        ? node
        : /*#__PURE__*/ React.createElement(Mode, {
            __element: node,
