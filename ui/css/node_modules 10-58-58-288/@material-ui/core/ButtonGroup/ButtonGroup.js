...
var ButtonGroup = /*#__PURE__*/ React.forwardRef(function ButtonGroup(props, ref) {
  ...
  var buttonClassName = (0, _clsx.default)(
    classes.grouped,
    classes['grouped'.concat((0, _capitalize.default)(orientation))],
    classes['grouped'.concat((0, _capitalize.default)(variant))],
    classes[
      'grouped'
        .concat((0, _capitalize.default)(variant))
        .concat((0, _capitalize.default)(orientation))
    ],
    classes[
      'grouped'
        .concat((0, _capitalize.default)(variant))
        .concat(color !== 'default' ? (0, _capitalize.default)(color) : '')
    ],
