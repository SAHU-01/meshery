      ...
      'span',
      {
        className: (0, _clsx.default)(
          ...
          classes[
            'anchorOrigin'
              .concat((0, _capitalize.default)(anchorOrigin.vertical))
              .concat((0, _capitalize.default)(anchorOrigin.horizontal))
              .concat((0, _capitalize.default)(overlap))
          ],
          color !== 'default' && classes['color'.concat((0, _capitalize.default)(color))],
  ...
  ? (Badge.propTypes = {
      ...
      classes: (0, _utils.chainPropTypes)(_propTypes.default.object, function (props) {
        ...
        [
          ...
          if (
            classes[deprecatedClassKey] != null && // 2 classnames? one from withStyles the other must be custom
            classes[deprecatedClassKey].split(' ').length > 1
          ) {
            throw new Error(
              'Material-UI: The `'
                .concat(deprecatedClassKey, '` class was deprecated. Use `')
                .concat(newClassKey, '` instead.'),
            );
          }
        });
        return null;
       ...
       */
      overlap: (0, _utils.chainPropTypes)(
        _propTypes.default.oneOf(['circle', 'rectangle', 'circular', 'rectangular']),
        function (props) {
