...
var styles = function styles(theme) {
  return {
      ...
      '& $track': {
        ...
        backgroundColor:
          theme.palette.type === 'light'
            ? (0, _colorManipulator.lighten)(theme.palette.primary.main, 0.62)
            : (0, _colorManipulator.darken)(theme.palette.primary.main, 0.5),
      },
      '& $rail': {
        opacity: 1,
      },
    ...
    thumb: {
      ...
      '&$focusVisible,&:hover': {
        boxShadow: '0px 0px 0px 8px '.concat(
          (0, _colorManipulator.alpha)(theme.palette.primary.main, 0.16),
        ),
        '@media (hover: none)': {
          boxShadow: 'none',
        },
    ...
    thumbColorSecondary: {
      '&$focusVisible,&:hover': {
        boxShadow: '0px 0px 0px 8px '.concat(
          (0, _colorManipulator.alpha)(theme.palette.secondary.main, 0.16),
        ),
      },
      '&$active': {
        boxShadow: '0px 0px 0px 14px '.concat(
...
var Slider = /*#__PURE__*/ React.forwardRef(function Slider(props, ref) {
  var ariaLabel = props['aria-label'],
    ...
    ValueLabelComponent =
      _props$ValueLabelComp === void 0 ? _ValueLabel.default : _props$ValueLabelComp,
  ...
  var marks =
    marksProp === true && step !== null
      ? (0, _toConsumableArray2.default)(Array(Math.floor((max - min) / step) + 1)).map(
          function (_, index) {
            return {
  ...
  var trackStyle = (0, _extends2.default)(
    {},
    ...
    (0, _extends2.default)(
      {
        ...
        className: (0, _clsx.default)(
          classes.root,
          classes['color'.concat((0, _capitalize.default)(color))],
          className,
    ...
    values.map(function (value, index) {
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(ThumbComponent, {
          className: (0, _clsx.default)(
            classes.thumb,
            classes['thumbColor'.concat((0, _capitalize.default)(color))],
