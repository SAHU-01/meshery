...
var Breadcrumbs = /*#__PURE__*/ React.forwardRef(function Breadcrumbs(props, ref) {
  ...
  var renderItemsBeforeAndAfter = function renderItemsBeforeAndAfter(allItems) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        console.error(
          [
            ...
            'itemsAfterCollapse={'
              .concat(itemsAfterCollapse, '} + itemsBeforeCollapse={')
              .concat(itemsBeforeCollapse, '} >= maxItems={')
              .concat(maxItems, '}'),
          ].join('\n'),
        );
      }
    ...
    return [].concat(
      (0, _toConsumableArray2.default)(allItems.slice(0, itemsBeforeCollapse)),
      [
        /*#__PURE__*/ React.createElement(_BreadcrumbCollapsed.default, {
  ...
  var allItems = React.Children.toArray(children)
