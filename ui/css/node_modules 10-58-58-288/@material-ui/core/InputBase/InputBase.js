...
var InputBase = /*#__PURE__*/ React.forwardRef(function InputBase(props, ref) {
  ...
  var checkDirty = React.useCallback(
    function (obj) {
      ...
      if (element == null) {
        throw new Error(
          process.env.NODE_ENV !== 'production'
            ? 'Material-UI: Expected valid input target. Did you use a custom `inputComponent` and forget to forward refs? See https://mui.com/r/input-component-ref-interface for more info.'
            : (0, _utils.formatMuiErrorMessage)(1),
        );
      }
    ...
    (0, _extends2.default)(
      {
        className: (0, _clsx.default)(
          classes.root,
          classes['color'.concat((0, _capitalize.default)(fcs.color || 'primary'))],
          className,
