...
var styles = function styles(theme) {
  var getColor = function getColor(color) {
    return theme.palette.type === 'light'
      ? (0, _colorManipulator.lighten)(color, 0.62)
      : (0, _colorManipulator.darken)(color, 0.5);
  };
  ...
  return {
    ...
    dashedColorPrimary: {
      backgroundImage: 'radial-gradient('
        .concat(backgroundPrimary, ' 0%, ')
        .concat(backgroundPrimary, ' 16%, transparent 42%)'),
    ...
    dashedColorSecondary: {
      backgroundImage: 'radial-gradient('
        .concat(backgroundSecondary, ' 0%, ')
        .concat(backgroundSecondary, ' 16%, transparent 42%)'),
      backgroundSize: '10px 10px',
      backgroundPosition: '0 -23px',
    },
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    variant === 'buffer'
      ? /*#__PURE__*/ React.createElement('div', {
          className: (0, _clsx.default)(
            classes.dashed,
            classes['dashedColor'.concat((0, _capitalize.default)(color))],
          ),
        })
      : null,
    /*#__PURE__*/ React.createElement('div', {
      className: (0, _clsx.default)(
        classes.bar,
        classes['barColor'.concat((0, _capitalize.default)(color))],
        (variant === 'indeterminate' || variant === 'query') && classes.bar1Indeterminate,
        {
    ...
    variant === 'determinate'
      ...
      : /*#__PURE__*/ React.createElement('div', {
          className: (0, _clsx.default)(
            ...
            variant === 'buffer'
              ? [classes['color'.concat((0, _capitalize.default)(color))], classes.bar2Buffer]
              : classes['barColor'.concat((0, _capitalize.default)(color))],
          ),
