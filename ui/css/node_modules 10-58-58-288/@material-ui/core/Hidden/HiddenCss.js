...
var styles = function styles(theme) {
  ...
  return theme.breakpoints.keys.reduce(function (acc, key) {
    acc['only'.concat((0, _capitalize.default)(key))] = (0, _defineProperty2.default)(
      {},
      theme.breakpoints.only(key),
      hidden,
    );
    acc[''.concat(key, 'Up')] = (0, _defineProperty2.default)(
      {},
      theme.breakpoints.up(key),
      hidden,
    );
    acc[''.concat(key, 'Down')] = (0, _defineProperty2.default)(
      {},
  ...
  if (process.env.NODE_ENV !== 'production') {
    var unknownProps = Object.keys(other).filter(function (propName) {
      var isUndeclaredBreakpoint = !theme.breakpoints.keys.some(function (breakpoint) {
        return (
          ''.concat(breakpoint, 'Up') === propName || ''.concat(breakpoint, 'Down') === propName
        );
      });
    ...
    if (unknownProps.length > 0) {
      console.error(
        'Material-UI: Unsupported props received by `<Hidden implementation="css" />`: '.concat(
          unknownProps.join(', '),
...
process.env.NODE_ENV !== 'production'
  ? (HiddenCss.propTypes = {
       ...
       */
      only: _propTypes.default.oneOfType([
        _propTypes.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl']),
        _propTypes.default.arrayOf(_propTypes.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl'])),
      ]),
