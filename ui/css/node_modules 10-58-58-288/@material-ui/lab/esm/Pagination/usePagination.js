...
export default function usePagination() {
  ...
  var itemList = [].concat(
    _toConsumableArray(showFirstButton ? ['first'] : []),
    _toConsumableArray(hidePrevButton ? [] : ['previous']),
    _toConsumableArray(startPages),
    _toConsumableArray(
    ...
    _toConsumableArray(range(siblingsStart, siblingsEnd)),
    _toConsumableArray(
    ...
    _toConsumableArray(endPages),
    _toConsumableArray(hideNextButton ? [] : ['next']),
    _toConsumableArray(showLastButton ? ['last'] : []),
