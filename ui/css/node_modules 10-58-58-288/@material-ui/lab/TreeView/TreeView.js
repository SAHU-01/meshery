...
var TreeView = /*#__PURE__*/ React.forwardRef(function TreeView(props, ref) {
  var children = props.children,
    ...
    defaultExpanded =
      _props$defaultExpande === void 0 ? defaultExpandedDefault : _props$defaultExpande,
    defaultExpandIcon = props.defaultExpandIcon,
    defaultParentIcon = props.defaultParentIcon,
    _props$defaultSelecte = props.defaultSelected,
    defaultSelected =
      _props$defaultSelecte === void 0 ? defaultSelectedDefault : _props$defaultSelecte,
  ...
  var isExpanded = React.useCallback(
    function (id) {
  ...
  var removeNodeFromNodeMap = React.useCallback(
    function (id) {
  ...
  return /*#__PURE__*/ React.createElement(
    _TreeViewContext.default.Provider,
    {
      value: {
        icons: {
...
process.env.NODE_ENV !== 'production'
  ? (TreeView.propTypes = {
       ...
       */
      defaultSelected: _propTypes.default.oneOfType([
       ...
       * When `multiSelect` is true this takes an array of strings; when false (default) a string.
       */
      selected: _propTypes.default.oneOfType([
        _propTypes.default.arrayOf(_propTypes.default.string),
        _propTypes.default.string,
      ]),
    })
