...
function useAutocomplete(props) {
      ...
      if (typeof optionLabel !== 'string') {
        var erroneousReturn =
          optionLabel === undefined
            ? 'undefined'
            : ''.concat((0, _typeof2.default)(optionLabel), ' (').concat(optionLabel, ')');
        console.error(
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (value !== null && !freeSolo && options.length > 0) {
      ...
      if (missingValue.length > 0) {
        console.warn(
          [
            'Material-UI: The value provided to '.concat(componentName, ' is invalid.'),
  ...
  var selectNewValue = function selectNewValue(event, option) {
    var reasonProp =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'select-option';
    ...
    if (multiple) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        if (matches.length > 1) {
          console.error(
            [
              'Material-UI: The `getOptionSelected` method of '.concat(
                componentName,
      ...
      if (acc.length > 0 && acc[acc.length - 1].group === group) {
        ...
        if (process.env.NODE_ENV !== 'production') {
          if (indexBy.get(group) && !warn) {
            console.warn(
              'Material-UI: The options provided combined with the `groupBy` method of '.concat(
                componentName,
