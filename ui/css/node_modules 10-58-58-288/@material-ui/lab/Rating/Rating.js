    ...
    var container = /*#__PURE__*/ React.createElement(
      IconContainerComponent,
      {
        ...
        className: (0, _clsx.default)(
          classes.icon,
          state.filled ? classes.iconFilled : classes.iconEmpty,
          state.hover && classes.iconHover,
          state.focus && classes.iconFocus,
          state.active && classes.iconActive,
        ),
      },
    ...
    (0, _extends2.default)(
      {
        ...
        className: (0, _clsx.default)(
          classes.root,
          className,
          size !== 'medium' && classes['size'.concat((0, _utils2.capitalize)(size))],
