...
export declare namespace Value {
  ...
  function Cast<T extends Types.TSchema, R extends Types.TSchema[]>(
    schema: T,
    references: [...R],
    value: unknown,
  ): Types.Static<T>;
  ...
  function Create<T extends Types.TSchema, R extends Types.TSchema[]>(
    schema: T,
    references: [...R],
  ): Types.Static<T>;
  /** Creates a value from the given type */
  ...
  function Check<T extends Types.TSchema, R extends Types.TSchema[]>(
    schema: T,
    references: [...R],
    value: unknown,
  ...
  function Convert<T extends Types.TSchema, R extends Types.TSchema[]>(
    schema: T,
    references: [...R],
    value: unknown,
  ): unknown;
  ...
  function Errors<T extends Types.TSchema, R extends Types.TSchema[]>(
    schema: T,
    references: [...R],
    value: unknown,
  ): ValueErrorIterator;
