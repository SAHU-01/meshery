  ...
  return {
    env: {
      ...
      opa_builtin0: function (builtinId, _ctx) {
        return _builtinCall(env.instance, memory, env.builtins, customBuiltins, builtinId);
      },
      opa_builtin1: function (builtinId, _ctx, arg1) {
        return _builtinCall(env.instance, memory, env.builtins, customBuiltins, builtinId, arg1);
      },
...
function _preparePolicy(env, wasm, memory) {
  ...
  if (abiVersionGlobal !== undefined) {
    const abiVersion =
      typeof abiVersionGlobal === 'number' ? abiVersionGlobal : abiVersionGlobal.value;
    if (abiVersion !== 1) {
  ...
  if (abiMinorVersionGlobal !== undefined) {
    abiMinorVersion =
      typeof abiMinorVersionGlobal === 'number'
  ...
  const builtins = _dumpJSON(env.instance, memory, env.instance.exports.builtins());
...
module.exports = {
  ...
  async loadPolicy(regoWasm, memoryDescriptor = {}, customBuiltins = {}) {
    ...
    const { policy, minorVersion } = await _loadPolicy(regoWasm, memory, customBuiltins);
  ...
  loadPolicySync(regoWasm, memoryDescriptor = {}, customBuiltins = {}) {
    ...
    const memory = new WebAssembly.Memory(memoryDescriptor);
    const { policy, minorVersion } = _loadPolicySync(regoWasm, memory, customBuiltins);
    return new LoadedPolicy(policy, memory, minorVersion);
  },
  LoadedPolicy,
};
