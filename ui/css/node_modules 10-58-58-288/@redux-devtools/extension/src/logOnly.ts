...
import { Action, compose, Dispatch, PreloadedState, Reducer, StoreEnhancer } from 'redux';
...
export function composeWithDevTools(config: Config): (...funcs: StoreEnhancer[]) => StoreEnhancer;
