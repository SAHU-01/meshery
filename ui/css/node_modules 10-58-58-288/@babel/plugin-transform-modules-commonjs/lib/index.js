...
var _default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  const constantReexports =
    (_api$assumption = api.assumption('constantReexports')) != null ? _api$assumption : loose;
      ...
      Program: {
        exit(path, state) {
          ...
          _helperModuleTransforms.rewriteModuleStatementsAndPrepareHeader)(path, {
            ...
            lazy,
            esNamespaceOnly:
              typeof state.filename === 'string' && /\.mjs$/.test(state.filename)
                ? mjsStrictNamespace
                : strictNamespace,
          ...
          for (const [source, metadata] of meta.source) {
            ...
            if ((0, _helperModuleTransforms.isSideEffectImport)(metadata)) {
              ...
              const init =
                (0, _helperModuleTransforms.wrapInterop)(path, loadExpr, metadata.interop) ||
                loadExpr;
              if (metadata.lazy) {
