  ...
  return {
    ...
    setMetadata: function setMetadata(key, value) {
      ...
      if ((void 0 === metadataForKey && (metadataForKey = metadataMap[key] = {}), 1 === kind)) {
        ...
        void 0 === priv && (priv = metadataForKey['private'] = new _Map()),
  ...
  if (0 !== metadataKeys.length) {
    for (var i = 0; i < metadataKeys.length; i++) {
      ...
      if (priv) {
        ...
        parentPriv && (privArr = _concatInstanceProperty(privArr).call(privArr, parentPriv)),
          (metaForKey['private'] = privArr);
      }
      parentMetaForKey && _Object$setPrototypeOf(metaForKey, parentMetaForKey);
    }
    parentMetadataMap && _Object$setPrototypeOf(metadataMap, parentMetadataMap),
      (obj[_Symbol.metadata || _Symbol$for('Symbol.metadata')] = metadataMap);
  }
}
...
function old_assertValidReturnValue(kind, value) {
  ...
  if (1 === kind) {
    ...
    void 0 !== value.get && old_assertCallable(value.get, 'accessor.get'),
      ...
      void 0 !== value.initializer && old_assertCallable(value.initializer, 'accessor.initializer');
...
function old_applyMemberDec(
  ...
  if (
    (isPrivate
      ...
      : 0 !== kind && (desc = _Object$getOwnPropertyDescriptor(base, name)),
    1 === kind
      ? (value = {
          get: desc.get,
          set: desc.set,
...
function old_applyMemberDecs(ret, Class, protoMetadataMap, staticMetadataMap, decInfos) {
  for (
    var protoInitializers,
      staticInitializers,
      existingProtoNonFields = new _Map(),
      existingStaticNonFields = new _Map(),
      i = 0;
    i < decInfos.length;
    i++
  ) {
      ...
      if (
        (isStatic
          ? ((base = Class),
            ...
            0 !== (kind -= 5) && (initializers = staticInitializers = staticInitializers || []))
          : ((base = Class.prototype),
            (metadataMap = protoMetadataMap),
            0 !== kind && (initializers = protoInitializers = protoInitializers || [])),
        0 !== kind && !isPrivate)
      ) {
