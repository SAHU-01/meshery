...
function applyMemberDec(ret, base, decInfo, name, kind, isStatic, isPrivate, initializers) {
  ...
  if (
    ...
    for (var i = decs.length - 1; i >= 0; i--) {
      ...
      if (
        void 0 !==
        (newValue = memberDec(decs[i], name, desc, initializers, kind, isStatic, isPrivate, value))
      )
        assertValidReturnValue(kind, newValue),
          0 === kind
            ? (newInit = newValue)
...
function applyDecs2203(targetClass, memberDecs, classDecs) {
  var ret = [];
  return (
    applyMemberDecs(ret, targetClass, memberDecs), applyClassDecs(ret, targetClass, classDecs), ret
  );
}
