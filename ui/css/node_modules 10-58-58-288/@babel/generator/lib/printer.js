...
class Printer {
  ...
  printJoin(nodes, parent, opts = {}) {
    ...
    for (let i = 0; i < len; i++) {
      ...
      if (opts.statement) {
        ...
        if (
          !((_node$trailingComment = node.trailingComments) != null && _node$trailingComment.length)
        ) {
          this._lastCommentLine = 0;
        }
        if (i + 1 === len) {
  ...
  _printComment(comment, skipNewLines) {
    ...
    if (isBlockComment) {
      ...
      if (
        (_parenPushNewlineState == null ? void 0 : _parenPushNewlineState.printed) === false &&
        ...
        if (type === 0) {
          ...
          if (i === 0) {
            if (
              ...
              (comment.type === 'CommentLine' || commentStartLine != commentEndLine)
            ) {
