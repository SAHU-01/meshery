...
function getPrototypeOfExpression(objectRef, isStatic, file, isPrivateMethod) {
  ...
  const targetRef =
    isStatic || isPrivateMethod ? objectRef : memberExpression(objectRef, identifier('prototype'));
  ...
  get(superMember) {
    ...
    if (isStatic) {
      ...
      object = memberExpression(
        (_getSuperRef2 = getSuperRef()) != null ? _getSuperRef2 : identifier('Object'),
...
class ReplaceSupers {
  constructor(opts) {
    ...
    this.file = opts.file;
    this.constantSuper =
      (_opts$constantSuper = opts.constantSuper) != null ? _opts$constantSuper : opts.isLoose;
    this.opts = opts;
  }
  getObjectRef() {
