...
var _default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  const setClassMethods =
    (_api$assumption = api.assumption('setClassMethods')) != null ? _api$assumption : loose;
  const constantSuper =
    (_api$assumption2 = api.assumption('constantSuper')) != null ? _api$assumption2 : loose;
  const superIsCallableConstructor =
    (_api$assumption3 = api.assumption('superIsCallableConstructor')) != null
      ? _api$assumption3
      : loose;
  const noClassCalls =
    (_api$assumption4 = api.assumption('noClassCalls')) != null ? _api$assumption4 : loose;
