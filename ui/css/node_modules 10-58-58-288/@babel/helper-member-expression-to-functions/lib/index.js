    ...
    if (member.isOptionalMemberExpression()) {
      ...
      if (willEndPathCastToBoolean) {
        ...
        if (noDocumentAll) {
          ...
          nonNullishCheck = logicalExpression(
            ...
            binaryExpression('!==', cloneNode(baseRef), scope.buildUndefinedNode()),
          );
        }
        ...
        replacementPath.replaceWith(
          conditionalExpression(
            nullishCheck,
            isDeleteOperation ? booleanLiteral(true) : scope.buildUndefinedNode(),
            regular,
          ),
        );
      }
      if (context) {
        ...
        endParentPath.replaceWith(
          optionalCallExpression(
            optionalMemberExpression(endParent.callee, identifier('call'), false, true),
      ...
      if (operator === '=') {
        ...
        if (LOGICAL_OPERATORS.includes(operatorTrunc)) {
          ...
          parentPath.replaceWith(
            logicalExpression(operatorTrunc, this.get(member), this.set(member, value)),
          );
        } else {
          this.memoise(member, 2);
          parentPath.replaceWith(
            this.set(member, binaryExpression(operatorTrunc, this.get(member), value)),
          );
        }
      }
      return;
