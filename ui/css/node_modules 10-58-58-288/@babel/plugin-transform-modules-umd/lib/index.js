...
var _default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  api.assertVersion(7);
  const { globals, exactGlobals, allowTopLevelThis, strict, strictMode, noInterop, importInterop } =
    options;
    ...
    if (exactGlobals) {
      ...
      if (globalRef) {
        memberExpression = globalRef
          .split('.')
          .reduce(
            (accum, curr) => _core.types.memberExpression(accum, _core.types.identifier(curr)),
            _core.types.identifier('global'),
          );
      } else {
