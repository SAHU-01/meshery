...
const { callExpression, cloneNode, isIdentifier, isThisExpression, yieldExpression } = _t;
...
const awaitVisitor = _core.traverse.visitors.merge([
  {
    ...
    AwaitExpression(path, { wrapAwait }) {
      ...
      path.replaceWith(
        yieldExpression(
          wrapAwait ? callExpression(cloneNode(wrapAwait), [argument.node]) : argument.node,
        ),
      );
    },
  },
