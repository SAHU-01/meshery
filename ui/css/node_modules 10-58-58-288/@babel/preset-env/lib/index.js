...
const pluginLists = {
  ...
  withoutProposals: {
    ...
    withBugfixes: filterStageFromList(
      Object.assign({}, _pluginsCompatData.plugins, _pluginsCompatData.pluginsBugfixes),
      _shippedProposals.proposalPlugins,
    ),
  },
};
...
`);
  ...
  const modulesPluginNames = getModulesPluginNames({
    ...
    shouldTransformESM:
      modules !== 'auto' || !(api.caller != null && api.caller(supportsStaticESM)),
    shouldTransformDynamicImport:
      modules !== 'auto' || !(api.caller != null && api.caller(supportsDynamicImport)),
  ...
  if (shippedProposals) {
    (0, _filterItems.addProposalSyntaxPlugins)(
      pluginNames,
      _shippedProposals.proposalSyntaxPlugins,
    );
  }
