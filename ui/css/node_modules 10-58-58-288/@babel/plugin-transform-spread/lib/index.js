  ...
  return {
    ...
    visitor: {
      ArrayExpression(path) {
        ...
        path.replaceWith(
          _core.types.callExpression(
            _core.types.memberExpression(first, _core.types.identifier('concat')),
            nodes,
          ),
        );
      },
      CallExpression(path) {
        ...
        const calleePath = (0,
        _helperSkipTransparentExpressionWrappers.skipTransparentExprWrappers)(path.get('callee'));
      ...
      NewExpression(path) {
        ...
        path.replaceWith(
          _core.types.callExpression(path.hub.addHelper('construct'), [node.callee, args]),
        );
      },
    },
  };
