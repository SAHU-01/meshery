...
class Client {
  ...
  getDefaultExtensions() {
    ...
    return (_classPrivateFieldGet2 = _classPrivateFieldGet(this, _eCache)) != null
      ? _classPrivateFieldGet2
      : _classPrivateFieldSet(
          this,
          _eCache,
          _classPrivateFieldGet(this, _send).call(this, ACTIONS.GET_DEFAULT_EXTENSIONS, undefined),
        );
  }
  setOptions(options) {
...
exports.WorkerClient =
  ((_worker = new WeakMap()),
  (_signal = new WeakMap()),
  ((_class = class WorkerClient extends Client {
    constructor() {
      super((action, payload) => {
        _classPrivateFieldGet(this, _signal)[0] = 0;
        const subChannel = new (_classStaticPrivateFieldSpecGet(
          WorkerClient,
          _class,
          _worker_threads,
        ).MessageChannel)();
        ...
        const { message } = _classStaticPrivateFieldSpecGet(
          WorkerClient,
          _class,
          _worker_threads,
        ).receiveMessageOnPort(subChannel.port2);
        if (message.error) throw Object.assign(message.error, message.errorData);
        else return message.result;
      });
      _classPrivateFieldInitSpec(this, _worker, {
        writable: true,
        value: new (_classStaticPrivateFieldSpecGet(WorkerClient, _class, _worker_threads).Worker)(
          path.resolve(__dirname, './worker/index.js'),
          {
            env: _classStaticPrivateFieldSpecGet(WorkerClient, _class, _markInRegisterWorker).call(
              WorkerClient,
              process.env,
            ),
          },
...
}
{
  ...
  exports.LocalClient =
    ((_class2 = class LocalClient extends Client {
      constructor() {
        var _classStaticPrivateFi;
        (_classStaticPrivateFi = _classStaticPrivateFieldSpecGet(
          LocalClient,
          _class2,
          _handleMessage,
        )) != null
          ? _classStaticPrivateFi
        ...
        super((action, payload) => {
          return _classStaticPrivateFieldSpecGet(LocalClient, _class2, _handleMessage).call(
            LocalClient,
