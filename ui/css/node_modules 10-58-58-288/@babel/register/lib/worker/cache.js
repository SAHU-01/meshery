...
function isCacheDisabled() {
  ...
  return (_process$env$BABEL_DI = process.env.BABEL_DISABLE_CACHE) != null
    ? _process$env$BABEL_DI
    : cacheDisabled;
}
exports.save = save;
function save() {
  ...
  try {
    (((v, w) => (
      (v = v.split('.')), (w = w.split('.')), +v[0] > +w[0] || (v[0] == w[0] && +v[1] >= +w[1])
    ))(process.versions.node, '10.12')
      ? fs.mkdirSync
      : require('make-dir').sync)(path.dirname(FILENAME), {
      recursive: true,
    });
