...
export function createTypeAnnotationBasedOnTypeof(
  type: 'string' | 'number' | 'undefined' | 'boolean' | 'function' | 'object' | 'symbol',
):
  | StringTypeAnnotation
  | VoidTypeAnnotation
  | NumberTypeAnnotation
...
export function ensureBlock<
  K extends keyof Extract<Node, { body: BlockStatement | Statement | Expression }> = 'body',
>(node: Extract<Node, Record<K, BlockStatement | Statement | Expression>>, key: K): BlockStatement;
...
export function toComputedKey<T extends Extract<Node, { computed: boolean | null }>>(
  node: T,
...
export function appendToMemberExpression<T extends Pick<MemberExpression, 'object' | 'property'>>(
  member: T,
...
export function prependToMemberExpression<T extends Pick<MemberExpression, 'object' | 'property'>>(
  member: T,
  prepend: MemberExpression['object'],
): T;
export function removeProperties(n: Node, opts?: { preserveComments: boolean } | null): void;
...
export function is<T extends Node['type'], P extends Extract<Node, { type: T }>>(
  type: T,
  n: Node | null | undefined,
  required: Partial<P>,
): n is P;
