...
declare function assertImportExpression(
  node: object | null | undefined,
  opts?: object | null,
): asserts node is ImportExpression;
...
declare function importExpression(
  source: Expression,
 ...
 */
declare function prependToMemberExpression<T extends Pick<MemberExpression, 'object' | 'property'>>(
  member: T,
...
declare function isImportExpression(
  node: Node | null | undefined,
  opts?: Opts<ImportExpression> | null,
