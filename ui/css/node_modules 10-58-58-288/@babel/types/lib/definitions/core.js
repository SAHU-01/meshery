  ...
  fields: {
    properties: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)(
          (0, _utils.assertNodeType)('ObjectMethod', 'ObjectProperty', 'SpreadElement'),
        ),
      ),
    },
  },
...
defineType('ArrayPattern', {
  ...
  fields: Object.assign({}, patternLikeCommon(), {
    elements: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)((0, _utils.assertNodeOrValueType)('null', 'PatternLike', 'LVal')),
      ),
    },
  }),
});
  ...
  fields: {
    ...
    implements: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)(
          (0, _utils.assertNodeType)('TSExpressionWithTypeArguments', 'ClassImplements'),
        ),
      ),
      optional: true,
    },
  ...
  Object.assign({}, functionCommon(), classMethodOrPropertyCommon(), {
    params: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)(
          (0, _utils.assertNodeType)('Identifier', 'Pattern', 'RestElement', 'TSParameterProperty'),
        ),
      ),
    },
    kind: {
...
defineType('ObjectPattern', {
  ...
  fields: Object.assign({}, patternLikeCommon(), {
    properties: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)((0, _utils.assertNodeType)('RestElement', 'ObjectProperty')),
      ),
    },
  }),
});
    ...
    value: {
      validate: (0, _utils.chain)(
        ...
        function templateElementCookedValidator(node) {
          ...
          const { str, firstInvalidLoc } = (0, _helperStringParser.readStringContents)(
            'template',
            raw,
            0,
            0,
...
defineType('TemplateLiteral', {
  ...
  fields: {
    ...
    expressions: {
      validate: (0, _utils.chain)(
        (0, _utils.assertValueType)('array'),
        (0, _utils.assertEach)((0, _utils.assertNodeType)('Expression', 'TSType')),
        function (node, key, val) {
