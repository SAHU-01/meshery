...
function arrowFunctionToExpression({
  ...
  noNewArrows = !((_arguments$) =>
    (_arguments$ = arguments[0]) == null ? void 0 : _arguments$.specCompliant)(),
} = {}) {
...
function hoistFunctionEnvironment(
  ...
  if (thisEnvFn.isClassProperty() || thisEnvFn.isClassPrivateProperty()) {
    if (arrowParent) {
      ...
      fnPath.replaceWith(
        callExpression(arrowFunctionExpression([], toExpression(fnPath.node)), []),
      );
    ...
    const argumentsBinding = getBinding(thisEnvFn, 'arguments', () => {
      ...
      if (thisEnvFn.scope.path.isProgram()) {
        return conditionalExpression(
          binaryExpression('===', unaryExpression('typeof', args()), stringLiteral('undefined')),
    ...
    flatSuperProps.forEach((superProp) => {
      ...
      if (isCall) {
        ...
        superProp.replaceWith(
          callExpression(memberExpression(call, identifier('bind'), false), [thisExpression()]),
        );
...
function standardizeSuperProperty(superProp) {
  if (superProp.parentPath.isAssignmentExpression() && superProp.parentPath.node.operator !== '=') {
    ...
    if (superProp.node.computed) {
      ...
      assignmentPath
        .get('left')
        .replaceWith(memberExpression(object, assignmentExpression('=', tmp, property), true));
      assignmentPath
        .get('right')
        .replaceWith(
          rightExpression(
    ...
    if (isLogicalAssignment) {
      assignmentPath.replaceWith(
        logicalExpression(op, assignmentPath.node.left, assignmentPath.node.right),
      );
    } else {
