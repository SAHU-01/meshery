...
function call(key) {
  ...
  if (this.node) {
    ...
    return this._call(
      (_opts$this$node$type = opts[this.node.type]) == null ? void 0 : _opts$this$node$type[key],
    );
  }
  return false;
}
...
function isDenylisted() {
  ...
  const denylist =
    (_this$opts$denylist = this.opts.denylist) != null ? _this$opts$denylist : this.opts.blacklist;
