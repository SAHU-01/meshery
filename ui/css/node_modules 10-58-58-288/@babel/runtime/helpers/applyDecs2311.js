  ...
  function applyDec(e, t, n, r, o, i, u, s, f, l, p) {
    ...
    if (!w) {
      ...
      if (
        ...
        if ((c = y[+s][r]) && 7 != (c ^ o))
          throw new Error(
            'Decorating two elements with the same name (' + P[F].name + ') is not supported yet',
          );
        y[+s][r] = o < 3 ? 1 : o;
      }
    }
    for (var N = e, O = h.length - 1; O >= 0; O -= n ? 2 : 1) {
      ...
      if (w) (c = z.call(H, N, R)), (K.v = 1), b(c, 'class decorators', 'return') && (N = c);
      else if (
        ((R['static'] = s),
        (R['private'] = f),
        (c = R.access =
        ...
        b(N, (l ? 'field' : 'method') + ' decorators', 'return') && (l ? k.unshift(N) : (P[F] = N));
    }
    return (
